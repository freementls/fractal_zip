...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="language.namespaces.faq.php" />
 <link rel="next" href="language.exceptions.extending.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/exceptions" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="alternate" href="/manual/en/feeds/language.exceptions.atom" type="application/atom+xml" />
 <link rel="canonical" href="http://php.net/manual/en/language.exceptions.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="http://www.php.net/manual/en/language.exceptions.php" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.exceptions.php">Exceptions</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.exceptions.extending.php">Extending Exceptions<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.namespaces.faq.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />FAQ: things you need to know about namespaces</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.exceptions.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
...
<h2>Table of Contents</h2><ul class="chunklist chunklist_chapter"><li><a href="language.exceptions.extending.php">Extending Exceptions</a></li></ul>
  ...
  <p class="para">
   ...
   block defined in sequence. Exceptions can be <em>throw</em>n (or
   re-thrown) within a <em>catch</em> block.
  </p>
  <p class="para">
...
Hello World
   ...
   <div class="example" id="example-263">
    <p><strong>Example #2 Nested Exception</strong></p>
    <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000">
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.exceptions&amp;redirect=http://www.php.net/manual/en/language.exceptions.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.exceptions&amp;redirect=http://www.php.net/manual/en/language.exceptions.php">add a note</a></small></span>
...
&nbsp;&nbsp; &nbsp; &nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">"$name contains character other than a-z A-Z"</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp; }&nbsp;&nbsp; <br />
...
&nbsp;&nbsp; &nbsp; &nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">"$name contains the word name"</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp; }<br />
...
&nbsp;&nbsp;&nbsp; </span><span class="default">goto a</span><span class="keyword">;<br />
}<br />
...
</span><span class="default">goto $b</span><span class="keyword">; </span><span class="comment">//Parse error: syntax error, unexpected T_VARIABLE, expecting T_STRING<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
  </div>
...
namespace </span><span class="keyword">Global;<br />
...
Foo.php<br />
<span class="default">&lt;?php<br />
namespace Foo</span><span class="keyword">;<br />
...
<br />
<span class="default">&lt;?php<br />
&nbsp;namespace SomeNamespace</span><span class="keyword">;<br />
<br />
...
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">get_class</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">) . </span><span class="string">" '{$this-&gt;message}' in {$this-&gt;file}({$this-&gt;line})\n"<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">. </span><span class="string">"{$this-&gt;getTraceAsString()}"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"Caught TestException ('{$e-&gt;getMessage()}')\n{$e}\n"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; catch (</span><span class="default">Exception $e</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"Caught Exception ('{$e-&gt;getMessage()}')\n{$e}\n"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
...
<br />
<a href="http://en.wikipedia.org/wiki/Resource_Acquisition_Is_Initialization" rel="nofollow" target="_blank">http://en.wikipedia.org/wiki/Resource_Acquisition_Is_Initialization</a> and my own <a href="http://www.hackcraft.net/RAII/" rel="nofollow" target="_blank">http://www.hackcraft.net/RAII/</a> describe this.</span>
</code></div>
  </div>
 </div>
 <a name="69730"></a>
...
Further tests show that nested functions with exceptions, methods throwing exceptions, etc all work the same way. This is like declaring all classes (or methods) in Java as "class ClassName throws Exception". While I consider this a good thing, you should be aware that any thrown exception will propagate up your stack until it is either caught or runs out of stack.</span>
 ...
 <div class="foot"><a href="/manual/add-note.php?sect=language.exceptions&amp;redirect=http://www.php.net/manual/en/language.exceptions.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.exceptions&amp;redirect=http://www.php.net/manual/en/language.exceptions.php">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.exceptions.php">show source</a> |

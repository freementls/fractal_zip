...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="language.types.array.php" />
 <link rel="next" href="language.types.resource.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/types.object" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/language.types.object.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="http://www.php.net/manual/en/language.types.object.php" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.types.object.php">Objects</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.types.resource.php">Resources<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.types.array.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Arrays</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.types.object.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
...
<div id="language.types.object" class="sect1">
 ...
 <div class="sect2" id="language.types.object.init">
  ...
  <p class="para">
   To create a new <span class="type"><a href="language.types.object.php" class="type object">object</a></span>, use the <em>new</em> statement
...
<span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">class&nbsp;</span><span style="color: #0000BB">foo<br /></span><span style="color: #007700">{<br />&nbsp;&nbsp;&nbsp;&nbsp;function&nbsp;</span><span style="color: #0000BB">do_foo</span><span style="color: #007700">()<br />&nbsp;&nbsp;&nbsp;&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;echo&nbsp;</span><span style="color: #DD0000">"Doing&nbsp;foo."</span><span style="color: #007700">;&nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;}<br />}<br /><br /></span><span style="color: #0000BB">$bar&nbsp;</span><span style="color: #007700">=&nbsp;new&nbsp;</span><span style="color: #0000BB">foo</span><span style="color: #007700">;<br /></span><span style="color: #0000BB">$bar</span><span style="color: #007700">-&gt;</span><span style="color: #0000BB">do_foo</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">?&gt;</span>
 ...
 <div class="sect2" id="language.types.object.casting">
  ...
  <p class="para">
   ...
   <span class="type"><a href="language.types.object.php" class="type object">object</a></span>, a new instance of the <em>stdClass</em>
   built-in class is created. If the value was <strong><code>NULL</code></strong>, the new instance will be
   empty. <span class="type"><a href="language.types.array.php" class="type Array">Array</a></span>s convert to an <span class="type"><a href="language.types.object.php" class="type object">object</a></span> with properties
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.types.object&amp;redirect=http://www.php.net/manual/en/language.types.object.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.types.object&amp;redirect=http://www.php.net/manual/en/language.types.object.php">add a note</a></small></span>
 ...
 <div class="note">
  ...
  <a href="#107755" class="date">02-Mar-2012 12:41</a>
  <div class="text">
...
&nbsp;&nbsp; &nbsp; &nbsp; -&gt;</span><span class="default">getC</span><span class="keyword">(); </span><span class="comment">// I'm c!<br />
 ...
 <div class="note">
  ...
  <a href="#107071" class="date">04-Jan-2012 01:15</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
I had the most difficult time finding this, hopefully it will help someone else!</span>
 ...
 <div class="note">
  ...
  <a href="#106218" class="date">19-Oct-2011 07:46</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Hope this helps someone.</span>
 ...
 <div class="note">
  ...
  <a href="#104357" class="date">10-Jun-2011 06:25</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Casting scalars to objects can give unexpected results:<br />
<br />
<span class="default">&lt;?php<br />
&nbsp; $foo </span><span class="keyword">= </span><span class="string">"something"</span><span class="keyword">;<br />
&nbsp; </span><span class="default">$bar </span><span class="keyword">= (object)</span><span class="default">$foo</span><span class="keyword">;<br />
&nbsp; </span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$foo </span><span class="keyword">== </span><span class="default">$bar</span><span class="keyword">); </span><span class="comment">// Outputs "bool(false)"<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
  </div>
 ...
 <a name="102735"></a>
 <div class="note">
  <strong class='user'>contact at mullanaphy dot com</strong>
  <a href="#102735" class="date">02-Mar-2011 01:26</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Have an stdClass and want to convert it recursively to an array, or vice versa? Here's two very simple functions.<br />
<br />
<span class="default">&lt;?php<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment"># A static class of mine, has more conversions in it, yet these two are the relevent ones.<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">final class </span><span class="default">Convert </span><span class="keyword">{<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment"># Convert a stdClass to an Array.<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">static public function </span><span class="default">object_to_array</span><span class="keyword">(</span><span class="default">stdClass $Class</span><span class="keyword">){<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment"># Typecast to (array) automatically converts stdClass -&gt; array.<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$Class </span><span class="keyword">= (array)</span><span class="default">$Class</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment"># Iterate through the former properties looking for any stdClass properties.<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; # Recursively apply (array).<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">foreach(</span><span class="default">$Class </span><span class="keyword">as </span><span class="default">$key </span><span class="keyword">=&gt; </span><span class="default">$value</span><span class="keyword">){<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; if(</span><span class="default">is_object</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">)&amp;&amp;</span><span class="default">get_class</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">)===</span><span class="string">'stdClass'</span><span class="keyword">){<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$Class</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">] = </span><span class="default">self</span><span class="keyword">::</span><span class="default">object_to_array</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">$Class</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment"># Convert an Array to stdClass.<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">static public function </span><span class="default">array_to_object</span><span class="keyword">(array </span><span class="default">$array</span><span class="keyword">){<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment"># Iterate through our array looking for array values.<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; # If found recurvisely call itself.<br />
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$array</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">] = </span><span class="default">self</span><span class="keyword">::</span><span class="default">array_to_object</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment"># Typecast to (object) will automatically convert array -&gt; stdClass<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">return (object)</span><span class="default">$array</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; }<br />
</span><span class="default">?&gt;</span>
</span>
 ...
 <div class="note">
  ...
  <a href="#101288" class="date">07-Dec-2010 10:47</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#95489" class="date">05-Jan-2010 02:10</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp; {<br />
&nbsp;&nbsp;&nbsp; return </span><span class="string">"User [first='$this-&gt;first_name', last='$this-&gt;last_name']"</span><span class="keyword">;<br />
&nbsp; }<br />
}<br />
<br />
</span><span class="default">?&gt;<br />
...
The __construct() method is called automatically by PHP when it sees the 'new' operator. Our __construct() method above requires the first and last names to be passed in as arguments and uses them to INITIALIZE objects when INSTANTIATING new INSTANCES.</span>
 ...
 <div class="note">
  ...
  <a href="#95211" class="date">18-Dec-2009 09:56</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
print </span><span class="default">$literalObjectDeclared</span><span class="keyword">-&gt;</span><span class="default">foo</span><span class="keyword">-&gt;</span><span class="default">bar</span><span class="keyword">; </span><span class="comment">// outputs "baz"!<br />
 ...
 <div class="note">
  ...
  <a href="#92379" class="date">22-Jul-2009 01:58</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
If having<br />
<br />
...
Spent two hours looking for more elegant solution, that's my findings.</span>
 ...
 <div class="note">
  ...
  <a href="#90447" class="date">22-Apr-2009 06:21</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
CAUTION:<br />
...
Notice: Undefined property: stdClass::$0 in...</span>
 ...
 <div class="note">
  ...
  <a href="#89634" class="date">17-Mar-2009 07:04</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I saw there was some confusing about what the &amp; operator does in php in relation to objects. So I made an illustrative example: <br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">class </span><span class="default">Test </span><span class="keyword">{<br />
...
</span><span class="comment">/* A normal assignment makes test2 into a reference to the object<br />
<br />
result:<br />
---<br />
object(Test)#1 (0) {<br />
...
<br />
*/<br />
</span><span class="default">$test1 </span><span class="keyword">= new </span><span class="default">Test</span><span class="keyword">;<br />
</span><span class="default">$test2 </span><span class="keyword">= </span><span class="default">$test1</span><span class="keyword">;<br />
</span><span class="default">$test2 </span><span class="keyword">= new </span><span class="default">Test2</span><span class="keyword">;;<br />
print </span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$test1</span><span class="keyword">);<br />
print </span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$test2</span><span class="keyword">);<br />
</span><span class="comment">/* If we use &amp; we make test2 a reference to $test1<br />
<br />
result:<br />
---<br />
object(Test2)#2 (0) {<br />
...
print </span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$test2</span><span class="keyword">);<br />
<br />
</span><span class="comment">/* If we want to prevent, we ever overwrite what is in $test1, we can do the following:<br />
<br />
$test2 =&amp; new Test2;<br />
<br />
I don't understand what happens here exactly.<br />
result:<br />
---<br />
object(Test)#3 (0) {<br />
}<br />
...
print </span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$test2</span><span class="keyword">);<br />
 ...
 <div class="note">
  ...
  <a href="#86023" class="date">29-Sep-2008 03:40</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
ON-THE-FLY!!!<br />
<br />
...
<br />
&nbsp; public function </span><span class="default">__toString</span><span class="keyword">(){<br />
&nbsp;&nbsp;&nbsp; return </span><span class="string">"Test [person=$this-&gt;person, score=$this-&gt;score%]"</span><span class="keyword">;<br />
&nbsp; }<br />
}<br />
<br />
...
--&gt;</span>
 ...
 <div class="note">
  ...
  <a href="#85440" class="date">30-Aug-2008 05:31</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Note that *numeric* arrays will not be converted to objects using this method.</span>
 ...
 <div class="note">
  ...
  <a href="#85237" class="date">21-Aug-2008 06:54</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp; return (object) </span><span class="default">$array</span><span class="keyword">;<br />
 ...
 <div class="note">
  ...
  <a href="#82623" class="date">18-Apr-2008 10:35</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
$obj-&gt;data ="This is the solution";</span>
 ...
 <div class="note">
  ...
  <a href="#82431" class="date">10-Apr-2008 08:03</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
$obj-&gt;blah = 3;</span>
 ...
 <div class="note">
  ...
  <a href="#81711" class="date">10-Mar-2008 12:17</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Environment: PHP/5.2.5<br />
<br />
Note that multi-dimentional arrays are not converted to objects, only the first level is like this:<br />
<br />
Input:<br />
<span class="default">&lt;?php<br />
$arr </span><span class="keyword">= array(</span><span class="string">'nameOfAKey'</span><span class="keyword">=&gt;array(</span><span class="string">'subKeyName'</span><span class="keyword">=&gt;</span><span class="string">'itsValue'</span><span class="keyword">));<br />
</span><span class="default">$obj </span><span class="keyword">= (object)</span><span class="default">$arr</span><span class="keyword">;<br />
echo </span><span class="string">'01: '</span><span class="keyword">.</span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$obj</span><span class="keyword">-&gt;</span><span class="default">nameOfAKey</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">).</span><span class="string">'&lt;br /&gt;'</span><span class="keyword">;&nbsp; </span><span class="comment">//As expected<br />
</span><span class="keyword">echo </span><span class="string">'02: Test: ('</span><span class="keyword">.</span><span class="default">var_export</span><span class="keyword">(</span><span class="default">$obj</span><span class="keyword">-&gt;</span><span class="default">nameOfAKey</span><span class="keyword">-&gt;</span><span class="default">subKeyName</span><span class="keyword">,</span><span class="default">true</span><span class="keyword">).</span><span class="string">')'&nbsp; </span><span class="comment">//Not supported<br />
</span><span class="default">?&gt;<br />
</span><br />
Output:<br />
01: Array ( [subKeyName] =&gt; itsValue ) <br />
02: Test: (NULL)</span>
</code></div>
  </div>
 </div>
 ...
 <div class="note">
  ...
  <a href="#75278" class="date">21-May-2007 09:25</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
All classes and functions declarations within a scope exist even before the php execution reaches them. It does not matter if you have your classes defined on the first or last line, as long as they are in the same scope as where they are called and are not in a conditional statement that has not been evaluated yet.</span>
 ...
 <div class="note">
  ...
  <a href="#68998" class="date">18-Aug-2006 03:35</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
echo </span><span class="default">$obj</span><span class="keyword">-&gt;</span><span class="default">$var</span><span class="keyword">;<br />
 ...
 <div class="note">
  ...
  <a href="#59128" class="date">26-Nov-2005 09:33</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <a name="50815"></a>
 <div class="note">
  <strong class='user'>james dot jones at firstinvestors dot com</strong>
  <a href="#50815" class="date">10-Mar-2005 09:32</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
iblun:<br />
<br />
Highly recommended that you NOT try to write your own sort function. Try something like this instead:<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">function </span><span class="default">sort_by_field</span><span class="keyword">(</span><span class="default">$obj_array</span><span class="keyword">, </span><span class="default">$field</span><span class="keyword">)<br />
{<br />
&nbsp;&nbsp; return </span><span class="default">usort</span><span class="keyword">(</span><span class="default">$obj_array</span><span class="keyword">,<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; </span><span class="default">create_function</span><span class="keyword">(</span><span class="string">'$o1,$o2'</span><span class="keyword">,<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="string">"return (\$o1-&gt;$field &lt; \$o2-&gt;$field) ? -1 : 1"</span><span class="keyword">));<br />
}<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
(Warning: untested code...)</span>
</code></div>
  </div>
 </div>
 <a name="50770"></a>
 <div class="note">
  ...
  <a href="#50770" class="date">09-Mar-2005 05:08</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; return $objectarray;<br />
 ...
 <div class="note">
  ...
  <a href="#50041" class="date">16-Feb-2005 02:07</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; $a = array( &amp;new Store() );</span>
 ...
 <a name="47424"></a>
 <div class="note">
  <strong class='user'>sirbinam at nospam dot please dot hotmail dot com</strong>
  <a href="#47424" class="date">15-Nov-2004 06:46</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">class </span><span class="default">hack</span><span class="keyword">{}<br />
</span><span class="default">$hack </span><span class="keyword">=&amp; new </span><span class="default">hack</span><span class="keyword">;<br />
<br />
class </span><span class="default">profiler</span><span class="keyword">{<br />
&nbsp; function </span><span class="default">profiler</span><span class="keyword">(){<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">startime </span><span class="keyword">= </span><span class="default">microtime</span><span class="keyword">();<br />
&nbsp; }<br />
<br />
&nbsp; function </span><span class="default">dump</span><span class="keyword">(){<br />
&nbsp;&nbsp;&nbsp; global </span><span class="default">$hack</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">endtime </span><span class="keyword">= </span><span class="default">microtime</span><span class="keyword">();<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$duration </span><span class="keyword">= </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">endtime </span><span class="keyword">- </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">starttime</span><span class="keyword">; </span><span class="comment">/* this won't actually work, it just the concept */<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$stdout</span><span class="keyword">-&gt;</span><span class="default">write</span><span class="keyword">(</span><span class="default">$duration</span><span class="keyword">);<br />
&nbsp; }<br />
}<br />
<br />
...
</span><span class="default">$hack </span><span class="keyword">=&amp; </span><span class="default">$stdout</span><span class="keyword">;<br />
</span><span class="default">$profiler</span><span class="keyword">-&gt;</span><span class="default">dump</span><span class="keyword">();<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
/*<br />
&nbsp;&nbsp; &nbsp; *<br />
&nbsp;&nbsp; &nbsp; * In short this little hack allows us to call $stdout-&gt;write() from<br />
&nbsp;&nbsp; &nbsp; * $profiler-&gt;dump<br />
&nbsp;&nbsp; &nbsp; *<br />
&nbsp;&nbsp; &nbsp; * The problem is that $stdout doesn't exist yet and when the compiler<br />
&nbsp;&nbsp; &nbsp; * parses this class, it sends a fatal error and dies because you can't<br />
&nbsp;&nbsp; &nbsp; * refer to a method of an object that doesn't exist yet, even though<br />
&nbsp;&nbsp; &nbsp; * this method doesn't get called until the end of execution, when the<br />
&nbsp;&nbsp; &nbsp; * method does exist.<br />
&nbsp;&nbsp; &nbsp; * This is the same as not being able to use a function before it is<br />
&nbsp;&nbsp; &nbsp; * at least declared in say a header file. This is seen in C, Perl,<br />
&nbsp;&nbsp; &nbsp; * and pretty much every language known to man. (TTBOMK?)<br />
&nbsp;&nbsp; &nbsp; *<br />
&nbsp;&nbsp; &nbsp; * So what does this hack do?<br />
&nbsp;&nbsp; &nbsp; * The first thing that happens in the global scope is an empty class<br />
&nbsp;&nbsp; &nbsp; * definition, it then creates a object called $hack from this class.<br />
&nbsp;&nbsp; &nbsp; * All this does is allocate memory for an object, and places a pointer<br />
&nbsp;&nbsp; &nbsp; * at the begining of that memory segment.<br />
&nbsp;&nbsp; &nbsp; * When the compiler parses this class, it doesn't care that the $hack<br />
&nbsp;&nbsp; &nbsp; * object is empty, as long as it has somewhere to assign a function<br />
&nbsp;&nbsp; &nbsp; * pointer. Later in global scope the $stdout object is created.<br />
&nbsp;&nbsp; &nbsp; * After $stdout is created, we do $hack =&amp; $stdout. The =&amp;<br />
&nbsp;&nbsp; &nbsp; * (assign by reference) moves the pointer for $hack to the begining of<br />
&nbsp;&nbsp; &nbsp; * the memory segment for $stdout. So when we call $hack-&gt;write(), it<br />
&nbsp;&nbsp; &nbsp; * points to the exact same object-&gt;method() as $stdout-&gt;write(). So<br />
&nbsp;&nbsp; &nbsp; * this is actually very reliable, just don't tell a purist!<br />
&nbsp;&nbsp; &nbsp; */</span>
</code></div>
  </div>
 </div>
 <a name="47423"></a>
 <div class="note">
  <strong class='user'>jbinam at nospam dot please dot hotmail dot com</strong>
  <a href="#47423" class="date">15-Nov-2004 06:46</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
<span class="default">&lt;?php<br />
<br />
...
&nbsp;&nbsp; &nbsp; */</span>
 ...
 <div class="note">
  ...
  <a href="#44218" class="date">18-Jul-2004 12:43</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
?&gt;</span>
 ...
 <div class="note">
  ...
  <a href="#35258" class="date">25-Aug-2003 02:26</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Hope this helps.</span>
 ...
 <div class="note">
  ...
  <a href="#32286" class="date">22-May-2003 09:25</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Here's an example on operator precedence between -&gt;&nbsp; and []<br />
&amp; what happens with $object-&gt;$member[$array_element]<br />
<br />
&lt;?<br />
class c<br />
{<br />
...
?&gt;</span>
 ...
 <div class="foot"><a href="/manual/add-note.php?sect=language.types.object&amp;redirect=http://www.php.net/manual/en/language.types.object.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.types.object&amp;redirect=http://www.php.net/manual/en/language.types.object.php">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.types.object.php">show source</a> |

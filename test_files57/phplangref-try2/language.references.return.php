...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="language.references.pass.php" />
 <link rel="next" href="language.references.unset.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/references.return" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/language.references.return.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="@w{VT36ZMVB}" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.references.return.php">Returning References</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.references.unset.php">Unsetting References<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.references.pass.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Passing by Reference</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.references.return.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
 <div class="langchooser">
  <form action="/manual/change.php" method="get">
   <p>view this page in </p><fieldset><select name="page">
    ...
    <option value="pl/language.references.return.php">Polish</option>
    ...
    <option value="fa/language.references.return.php">Persian</option>
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.references.return&amp;redirect=@w{VT36ZMVB}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.references.return&amp;redirect=@w{VT36ZMVB}">add a note</a></small></span>
  <small>User Contributed Notes</small>
  <strong>Returning References</strong>
 </div><div id="allnotes">
 <a name="102593"></a>
 <div class="note">
...
$a: 1 $b: 1</span>
 ...
 <div class="note">
  <strong class='user'>sandaimespaceman at gmail dot com</strong>
  <a href="#85844" class="date">19-Sep-2008 11:09</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
References can produce a chain like what jQuery used:<br />
<span class="default">&lt;?php<br />
$a </span><span class="keyword">= new </span><span class="default">test</span><span class="keyword">();<br />
echo (</span><span class="default">$a </span><span class="keyword">-&gt; </span><span class="default">one</span><span class="keyword">() -&gt; </span><span class="default">two</span><span class="keyword">() -&gt; </span><span class="default">one</span><span class="keyword">() -&gt; </span><span class="default">two</span><span class="keyword">() -&gt; </span><span class="default">one</span><span class="keyword">() -&gt; </span><span class="default">two</span><span class="keyword">() -&gt; </span><span class="default">f</span><span class="keyword">);<br />
</span><span class="default">?&gt;<br />
</span>instead of<br />
<span class="default">&lt;?php<br />
$a </span><span class="keyword">= new </span><span class="default">test</span><span class="keyword">();<br />
</span><span class="default">$a </span><span class="keyword">-&gt; </span><span class="default">one</span><span class="keyword">();<br />
</span><span class="default">$a </span><span class="keyword">-&gt; </span><span class="default">two</span><span class="keyword">();<br />
</span><span class="default">$a&nbsp; </span><span class="keyword">-&gt; </span><span class="default">one</span><span class="keyword">();<br />
</span><span class="default">$a&nbsp; </span><span class="keyword">-&gt; </span><span class="default">two</span><span class="keyword">();<br />
</span><span class="default">$a&nbsp; </span><span class="keyword">-&gt; </span><span class="default">one</span><span class="keyword">();<br />
</span><span class="default">$a&nbsp; </span><span class="keyword">-&gt; </span><span class="default">two</span><span class="keyword">();<br />
echo </span><span class="default">$a </span><span class="keyword">-&gt; </span><span class="default">f</span><span class="keyword">;<br />
</span><span class="default">?&gt;<br />
</span>They both return 29.</span>
</code></div>
  </div>
 </div>
 <a name="84796"></a>
 <div class="note">
  <strong class='user'>interframe at 126 dot com</strong>
  <a href="#84796" class="date">30-Jul-2008 07:33</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
"Return by reference" cause private member can be accessed from outside of the class, as shown:<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">class </span><span class="default">foo </span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; private </span><span class="default">$value </span><span class="keyword">= </span><span class="default">42</span><span class="keyword">;<br />
<br />
...
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">echoValue</span><span class="keyword">(){<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"in class the private \$value = $this-&gt;value &lt;br /&gt;"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
...
</span><span class="default">$myValue </span><span class="keyword">= </span><span class="default">33</span><span class="keyword">;&nbsp; &nbsp; </span><span class="comment">//the private foo::$value been changed<br />
</span><span class="default">$obj</span><span class="keyword">-&gt;</span><span class="default">echoValue</span><span class="keyword">();&nbsp;&nbsp; <br />
<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
...
Notice how we called test() which was not on an object, but returned an instance of Foo, followed by a method on Foo, getBar() which returned an instance of Bar and finally called one of its methods helloWorld().&nbsp; Those familiar with other interpretive languages (Java to name one) will recognize this functionality.&nbsp; For whatever reason this change doesn't seem to be documented very well, so hopefully someone will find this helpful.</span>
 ...
 <div class="note">
  ...
  <a href="#73459" class="date">23-Feb-2007 12:27</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
The note by zayfod below is very misleading. The following is not true:<br />
<br />
"You do not have to use &amp; to indicate that reference binding should be done when you assign to a value passed by reference the result of a function which returns by reference."<br />
<br />
As proof, you can change zayfod's second example slightly to show that $var does not, as he claims, become a reference to $some_var.<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">class </span><span class="default">some_class<br />
</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; function&nbsp; &nbsp; &amp; </span><span class="default">func_b </span><span class="keyword">()<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">some_var </span><span class="keyword">= </span><span class="default">2</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">some_var</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
...
&nbsp;&nbsp; &nbsp; &nbsp; </span><span class="default">$param </span><span class="keyword">= </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">func_b</span><span class="keyword">();<br />
...
<br />
</span><span class="default">$object </span><span class="keyword">= new </span><span class="default">some_class</span><span class="keyword">();<br />
</span><span class="default">$object</span><span class="keyword">-&gt;</span><span class="default">func_a</span><span class="keyword">(</span><span class="default">$var</span><span class="keyword">);<br />
<br />
print </span><span class="default">$var</span><span class="keyword">; </span><span class="comment">// this prints two<br />
</span><span class="default">$var </span><span class="keyword">= </span><span class="default">5</span><span class="keyword">;<br />
print </span><span class="default">$object</span><span class="keyword">-&gt;</span><span class="default">some_var</span><span class="keyword">;<br />
</span><span class="comment">// $object-&gt;some_var&nbsp; is still 2, because $var is not bound to it<br />
// (as the original post by zayfod claims) and therefore has no<br />
// effect on it<br />
</span><span class="default">?&gt;<br />
</span><br />
...
1) $var is passed by reference into func_a, which binds $param to $var<br />
2) func_b is evaluated, returning a reference to $some_var<br />
3) $param is bounded to $some_var therefore losing it's binding to $var<br />
4) func_a returns, with $var unchanged<br />
<br />
In the second example step 1 and 2 are the same, but then this happens:<br />
3) the value 2 is copied into $param, which still references $var, and therefore $var now also evaluates to 2<br />
4) func_a returns, $var is 2, but is not bound to $some_var (and wouldn't be even in my example where some_var still exists afterward)<br />
<br />
The mistake seems to be based on misuse of references. When you return a reference, it means that you want a variable that is tied to another, so that when you change one, the other one changes. In zayfod's example, returning by reference is pointless, because $some_var ceases to exist after the function is completed, it won't stay tied to anything.<br />
<br />
There are two ways to change those functions so that in the end you have $var actually bound to $this-&gt;some_var:<br />
<br />
1) Pass $param into func_b by reference and reference $this-&gt;some_var to func_b's parameter like so:<br />
<br />
func_b (&amp;$b_param)<br />
{<br />
&nbsp;&nbsp; &nbsp;&nbsp; $this-&gt;some_var =&amp; $b_param; // be careful not to flip this<br />
&nbsp;&nbsp; &nbsp;&nbsp; $this-&gt;some_var = 2;<br />
}<br />
<br />
2) change func_a to return the result of func_b by reference, and reference that to $var<br />
<br />
And remember this simple rule: If a variable is already referenced to another variable and you reference it to a third (put it on the left side of =&amp;) it loses its original reference. This is what happens to $param in zayfod's example. (Also don't forget that passing by reference actually references the internal parameter variable to the the passed variable.)</span>
</code></div>
  </div>
 </div>
 <a name="72824"></a>
...
You can manipulate $partArray and the changes are also made with $GLOBALS.</span>
 ...
 <a name="68158"></a>
 <div class="note">
  <strong class='user'>neozenkai at yahoo dot com</strong>
  <a href="#68158" class="date">15-Jul-2006 01:38</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
While trying to create a function to return Database connection objects, it took me a while to get this right:<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">class </span><span class="default">TestClass<br />
</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; var </span><span class="default">$thisVar </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br />
<br />
&nbsp;&nbsp;&nbsp; function </span><span class="default">TestClass</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">)<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">thisVar </span><span class="keyword">= </span><span class="default">$value</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
<br />
&nbsp;&nbsp;&nbsp; function &amp;</span><span class="default">getTestClass</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">)<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; static </span><span class="default">$classes</span><span class="keyword">;<br />
<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; if (!isset(</span><span class="default">$classes</span><span class="keyword">[</span><span class="default">$value</span><span class="keyword">]))<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$classes</span><span class="keyword">[</span><span class="default">$value</span><span class="keyword">] = new </span><span class="default">TestClass</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">$classes</span><span class="keyword">[</span><span class="default">$value</span><span class="keyword">];<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
echo </span><span class="string">"&lt;pre&gt;"</span><span class="keyword">;<br />
<br />
echo </span><span class="string">"Getting class1 with a value of 432\n"</span><span class="keyword">;<br />
</span><span class="default">$class1 </span><span class="keyword">=&amp; </span><span class="default">TestClass</span><span class="keyword">::</span><span class="default">getTestClass</span><span class="keyword">(</span><span class="default">432</span><span class="keyword">);<br />
echo </span><span class="string">"Value is: " </span><span class="keyword">. </span><span class="default">$class1</span><span class="keyword">-&gt;</span><span class="default">thisVar </span><span class="keyword">. </span><span class="string">"\n"</span><span class="keyword">;<br />
<br />
echo </span><span class="string">"Getting class2 with a value of 342\n"</span><span class="keyword">;<br />
</span><span class="default">$class2 </span><span class="keyword">=&amp; </span><span class="default">TestClass</span><span class="keyword">::</span><span class="default">getTestClass</span><span class="keyword">(</span><span class="default">342</span><span class="keyword">);<br />
echo </span><span class="string">"Value is: " </span><span class="keyword">. </span><span class="default">$class2</span><span class="keyword">-&gt;</span><span class="default">thisVar </span><span class="keyword">. </span><span class="string">"\n"</span><span class="keyword">;<br />
<br />
echo </span><span class="string">"Getting class3 with the same value of 432\n"</span><span class="keyword">;<br />
</span><span class="default">$class3 </span><span class="keyword">=&amp; </span><span class="default">TestClass</span><span class="keyword">::</span><span class="default">getTestClass</span><span class="keyword">(</span><span class="default">432</span><span class="keyword">);<br />
echo </span><span class="string">"Value is: " </span><span class="keyword">. </span><span class="default">$class3</span><span class="keyword">-&gt;</span><span class="default">thisVar </span><span class="keyword">. </span><span class="string">"\n"</span><span class="keyword">;<br />
<br />
echo </span><span class="string">"Changing the value of class1 to 3425, which should also change class3\n"</span><span class="keyword">;<br />
</span><span class="default">$class1</span><span class="keyword">-&gt;</span><span class="default">thisVar </span><span class="keyword">= </span><span class="default">3425</span><span class="keyword">;<br />
<br />
echo </span><span class="string">"Now checking value of class3: " </span><span class="keyword">. </span><span class="default">$class3</span><span class="keyword">-&gt;</span><span class="default">thisVar </span><span class="keyword">. </span><span class="string">"\n"</span><span class="keyword">;<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
Which outputs:<br />
<br />
Getting class1 with a value of 432<br />
Value is: 432<br />
Getting class2 with a value of 342<br />
Value is: 342<br />
Getting class3 with the same value of 432<br />
Value is: 432<br />
Changing the value of class1 to 3425, which should also change class3<br />
Now checking value of class3: 3425<br />
<br />
Note that PHP syntax is different from C/C++ in that you must use the &amp; operator in BOTH places, as stated by the manual. It took me a while to figure this out.</span>
</code></div>
  </div>
 </div>
 <a name="62391"></a>
...
&nbsp; }<br />
 ...
 <div class="note">
  ...
  <a href="#59675" class="date">13-Dec-2005 12:04</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
firstly a note on the post below: technically correct that -&gt; "to get a reference to an exsisting class and it's properties" should be "...to an existing object..."<br />
<br />
in PHP5 it's senseless to return objects by reference.. let's say you have, as in the post below, a class which should return a reference to its own instance (maybe it's been created using the singleton pattern..), than it's no problem to simply return that variable holding the instance.<br />
In PHP5 variables holding objects are always references to a specific object, so when you return (=copy) a variable "having" an object you in fact return a reference to that object.<br />
<br />
Because of that behaviour, which is very common for many programming languages, especially those, which are to be compiled (due to memory problems and so on), you have to use the clone-function which was introduced in PHP5.<br />
<br />
Here an example to underline what i mean:<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">class </span><span class="default">sample_singleton<br />
</span><span class="keyword">{<br />
...
&nbsp; { </span><span class="default">self</span><span class="keyword">::</span><span class="default">$instance </span><span class="keyword">= new </span><span class="default">sample_singleton</span><span class="keyword">(); }<br />
<br />
...
<br />
&nbsp; public function </span><span class="default">yea</span><span class="keyword">()<br />
&nbsp; { echo </span><span class="string">"wuow"</span><span class="keyword">; }<br />
}<br />
<br />
</span><span class="default">sample_singleton</span><span class="keyword">::</span><span class="default">create</span><span class="keyword">();<br />
<br />
</span><span class="comment">// $singleton will be a reference to sample_singleton::$instance<br />
</span><span class="default">$singleton </span><span class="keyword">= </span><span class="default">sample_singleton</span><span class="keyword">::</span><span class="default">getInstance</span><span class="keyword">();<br />
<br />
</span><span class="default">$singleton</span><span class="keyword">-&gt;</span><span class="default">yea</span><span class="keyword">();<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
Note some more (maybe) strange behaviour: although $instance is private you can have a reference pointing on it. Maybe that does not seem strange to you in any way, but maybe you wondered as i did : )<br />
<br />
The code posted here was just a sample to illustrate my posting, for using the singleton pattern please look it up in the manual. I just used this cause it was the simplest example which went in my mind right know.</span>
</code></div>
  </div>
 </div>
 <a name="57632"></a>
...
(Experienced with PHP 4.3.0)</span>
 ...
 <div class="foot"><a href="/manual/add-note.php?sect=language.references.return&amp;redirect=@w{VT36ZMVB}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.references.return&amp;redirect=@w{VT36ZMVB}">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.references.return.php">show source</a> |

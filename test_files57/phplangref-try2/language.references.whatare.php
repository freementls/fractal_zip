...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="language.references.php" />
 <link rel="next" href="language.references.whatdo.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/references.whatare" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/language.references.whatare.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="http://www.php.net/manual/en/language.references.whatare.php" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.references.whatare.php">What References Are</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.references.whatdo.php">What References Do<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.references.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />References Explained</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.references.whatare.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
 <div class="langchooser">
  <form action="/manual/change.php" method="get">
   <p>view this page in </p><fieldset><select name="page">
    ...
    <option value="pl/language.references.whatare.php">Polish</option>
    <option value="ro/language.references.whatare.php">Romanian</option>
    <option value="ru/language.references.whatare.php">Russian</option>
    <option value="fa/language.references.whatare.php">Persian</option>
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.references.whatare&amp;redirect=http://www.php.net/manual/en/language.references.whatare.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.references.whatare&amp;redirect=http://www.php.net/manual/en/language.references.whatare.php">add a note</a></small></span>
  <small>User Contributed Notes</small>
  <strong>What References Are</strong>
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.references.whatare.php">show source</a> |

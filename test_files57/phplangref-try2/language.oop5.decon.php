...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="language.oop5.autoload.php" />
 <link rel="next" href="language.oop5.visibility.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/oop5.decon" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/language.oop5.decon.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="http://www.php.net/manual/en/language.oop5.decon.php" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.oop5.decon.php">Constructors and Destructors</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.oop5.visibility.php">Visibility<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.oop5.autoload.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Autoloading Classes</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.oop5.decon.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
...
<span style="color: #0000BB">&lt;?php<br /></span><span style="color: #007700">class&nbsp;</span><span style="color: #0000BB">BaseClass&nbsp;</span><span style="color: #007700">{<br />&nbsp;&nbsp;&nbsp;function&nbsp;</span><span style="color: #0000BB">__construct</span><span style="color: #007700">()&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;print&nbsp;</span><span style="color: #DD0000">"In&nbsp;BaseClass&nbsp;constructor\n"</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;}<br />}<br /><br />class&nbsp;</span><span style="color: #0000BB">SubClass&nbsp;</span><span style="color: #007700">extends&nbsp;</span><span style="color: #0000BB">BaseClass&nbsp;</span><span style="color: #007700">{<br />&nbsp;&nbsp;&nbsp;function&nbsp;</span><span style="color: #0000BB">__construct</span><span style="color: #007700">()&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #0000BB">parent</span><span style="color: #007700">::</span><span style="color: #0000BB">__construct</span><span style="color: #007700">();<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;print&nbsp;</span><span style="color: #DD0000">"In&nbsp;SubClass&nbsp;constructor\n"</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;}<br />}<br /><br /></span><span style="color: #0000BB">$obj&nbsp;</span><span style="color: #007700">=&nbsp;new&nbsp;</span><span style="color: #0000BB">BaseClass</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">$obj&nbsp;</span><span style="color: #007700">=&nbsp;new&nbsp;</span><span style="color: #0000BB">SubClass</span><span style="color: #007700">();<br /></span><span style="color: #0000BB">?&gt;</span>
   ...
   <p class="para">
    ...
    <a href="language.oop5.decon.php#object.construct" class="link">__construct()</a> function for a given class, it will
    ...
    <a href="language.oop5.decon.php#object.construct" class="link">__construct()</a> which was used for different semantics.
   </p>
   <p class="para">
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.oop5.decon&amp;redirect=http://www.php.net/manual/en/language.oop5.decon.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.oop5.decon&amp;redirect=http://www.php.net/manual/en/language.oop5.decon.php">add a note</a></small></span>
...
<br />
 ...
 <div class="note">
  ...
  <a href="#106968" class="date">21-Dec-2011 08:51</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
With the destructor if you're going to write to a file make sure you have the full file path and not just the filename, it seems PHP switches the working directory to the apache root directory when exiting the script.</span>
 ...
 <a name="106776"></a>
 <div class="note">
  <strong class='user'>kapsonfire at gmx dot de</strong>
  <a href="#106776" class="date">05-Dec-2011 01:50</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; unset(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">$key</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; }<br />
...
NOTE: calling gc_collect_cycles() does have a speed overhead, so only use it if you feel you need to.</span>
 ...
 <a name="104815"></a>
 <div class="note">
  <strong class='user'>misha at gmail dot com</strong>
  <a href="#104815" class="date">08-Jul-2011 12:30</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
This is kinda weird to me as it is not obvious behavior....<br />
Initiating constructor having no arguments, using call with parameters will not throw error/warning.<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">class </span><span class="default">A </span><span class="keyword">{<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment"># no arguments constructor<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">function&nbsp; </span><span class="default">__construct</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"WierdoO"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="default">$param </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">;<br />
<br />
</span><span class="default">$a </span><span class="keyword">= new </span><span class="default">A</span><span class="keyword">( </span><span class="default">$param </span><span class="keyword">);<br />
</span><span class="default">?&gt;<br />
</span><br />
// Output "WierdoO"<br />
<br />
Notice that this anomaly is observed only for No Argument Constructor case.</span>
</code></div>
  </div>
 </div>
 <a name="103383"></a>
 <div class="note">
  ...
  <a href="#103383" class="date">11-Apr-2011 07:12</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
print </span><span class="string">'End'</span><span class="keyword">; </span><span class="comment">// this won't be printed<br />
 ...
 <div class="note">
  ...
  <a href="#102882" class="date">11-Mar-2011 04:26</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
public function </span><span class="default">__construct_string_integer</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">, </span><span class="default">$b</span><span class="keyword">) {}<br />
 ...
 <div class="note">
  ...
  <a href="#101009" class="date">19-Nov-2010 11:46</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#99903" class="date">14-Sep-2010 03:35</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
// __construct with 3 params called: sheep,cat,dog<br />
 ...
 <div class="note">
  ...
  <a href="#99007" class="date">21-Jul-2010 02:14</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; echo </span><span class="string">"constructor $id not defined\n"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp;&nbsp; else { <br />
...
&nbsp;&nbsp; &nbsp; &nbsp; echo </span><span class="string">"Error: Not enough parameters (Constructor min(int $a, int $b)) !!!\n"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; }<br />
&nbsp;&nbsp; &nbsp; else {<br />
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; echo </span><span class="string">"Constructor min(): Result = $c\n"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; }<br />
&nbsp;&nbsp; }<br />
<br />
...
&nbsp;&nbsp; &nbsp; if (! </span><span class="default">is_array</span><span class="keyword">(</span><span class="default">$args</span><span class="keyword">) || </span><span class="default">count</span><span class="keyword">(</span><span class="default">$args</span><span class="keyword">) &lt; </span><span class="default">2</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp; echo </span><span class="string">"Error: Not enough parameters (Constructor fullname(string $firstname, string $lastname)) !!!\n"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; }<br />
&nbsp;&nbsp; &nbsp; else {<br />
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; echo </span><span class="string">"Constructor fullname(): Result = $c\n"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; }<br />
&nbsp;&nbsp; }<br />
<br />
...
<br />
 ...
 <div class="note">
  ...
  <a href="#98514" class="date">20-Jun-2010 02:39</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#98352" class="date">10-Jun-2010 04:50</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Be careful when using a class as reference or copy in another one in regard of the __destruct() method:<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">class </span><span class="default">MyMainClass </span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; private </span><span class="default">$tables </span><span class="keyword">= array();<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">__construct</span><span class="keyword">() {&nbsp; &nbsp; &nbsp; &nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"Create "</span><span class="keyword">,</span><span class="default">get_class</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">), </span><span class="string">" Object!&lt;br&gt;"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">__destruct</span><span class="keyword">() {&nbsp; &nbsp; &nbsp; &nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"Destroy "</span><span class="keyword">,</span><span class="default">get_class</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">),</span><span class="string">" Object!&lt;br&gt;"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; public function &amp;</span><span class="default">getSubClass</span><span class="keyword">(</span><span class="default">$name</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; if(!isset(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">tables</span><span class="keyword">[</span><span class="default">$name</span><span class="keyword">])) {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment"># This will result in NOT calling the __destruct() method when <br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; # unsetting an objct of MyMainClass<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">tables</span><span class="keyword">[</span><span class="default">$name</span><span class="keyword">] = new </span><span class="default">MySubClass</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">, </span><span class="default">$name</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment"># If you clone the class (for testing) it will work as expected<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; // $this-&gt;tables[$name] = new MySubClass(clone $this, $name);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">}<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">tables</span><span class="keyword">[</span><span class="default">$name</span><span class="keyword">];<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
class </span><span class="default">MySubClass </span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; private </span><span class="default">$name </span><span class="keyword">= </span><span class="default">null</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; private </span><span class="default">$main_class </span><span class="keyword">= </span><span class="default">null</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">__construct</span><span class="keyword">(</span><span class="default">MyMainClass </span><span class="keyword">&amp;</span><span class="default">$main_class</span><span class="keyword">, </span><span class="default">$name</span><span class="keyword">) {&nbsp; &nbsp; &nbsp; &nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"Create "</span><span class="keyword">,</span><span class="default">get_class</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">), </span><span class="string">" '$name' Object!&lt;br&gt;"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">name </span><span class="keyword">= </span><span class="default">$name</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">main_class </span><span class="keyword">= </span><span class="default">$main_class</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">__destruct</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"Destroy "</span><span class="keyword">,</span><span class="default">get_class</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">),</span><span class="string">" '$this-&gt;name' Object!&lt;br&gt;"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="default">$my </span><span class="keyword">= new </span><span class="default">MyMainClass</span><span class="keyword">(</span><span class="default">$logger</span><span class="keyword">);<br />
</span><span class="default">$my</span><span class="keyword">-&gt;</span><span class="default">getSubClass</span><span class="keyword">(</span><span class="string">'bar'</span><span class="keyword">);<br />
</span><span class="default">$my</span><span class="keyword">-&gt;</span><span class="default">getSubClass</span><span class="keyword">(</span><span class="string">'foo'</span><span class="keyword">);<br />
unset(</span><span class="default">$my</span><span class="keyword">);<br />
echo </span><span class="string">"_____End of skript reached!_____&lt;br&gt;"</span><span class="keyword">;<br />
</span><span class="default">?&gt;<br />
</span><br />
This will result in:<br />
<br />
Create MyMainClass Object!<br />
Create MySubClass 'bar' Object!<br />
Create MySubClass 'foo' Object!<br />
_____End of Skript reached!_____<br />
Destroy MyMainClass Object!<br />
Destroy MySubClass 'bar' Object!<br />
Destroy MySubClass 'foo' Object!</span>
</code></div>
  </div>
 </div>
 <a name="97337"></a>
 <div class="note">
  <strong class='user'>Anonymous</strong>
  <a href="#97337" class="date">14-Apr-2010 11:07</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
If you are not aware of the parameter list, you could use the following in __construct to call up the chain:<br />
<br />
<span class="default">&lt;?php<br />
$args </span><span class="keyword">= </span><span class="default">func_get_args</span><span class="keyword">();<br />
 ...
 <div class="note">
  ...
  <a href="#96446" class="date">27-Feb-2010 03:20</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
It appears as though the variable will be unset BEFORE it actually can execute the if statement.&nbsp; Removing the unset will fix this.&nbsp; It's not needed anyways as PHP will release everything anyways, but just in case you run across this, you know why ;)</span>
 ...
 <a name="94945"></a>
 <div class="note">
  <strong class='user'>jon at fatcatsoftware dot net</strong>
  <a href="#94945" class="date">03-Dec-2009 01:33</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I'm not sure why this was happening, but I had an instance were the __destruct was being called BEFORE my __construct in a certain class.<br />
<br />
I'm using a Factory Class where I would call this statement to grab the class:<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">public static function &amp;</span><span class="default">getBookingSession</span><span class="keyword">()<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; static </span><span class="default">$instance </span><span class="keyword">=</span><span class="default">null</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; if (</span><span class="default">is_null</span><span class="keyword">(</span><span class="default">$instance</span><span class="keyword">))<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment">//requiring the class file<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">require_once </span><span class="string">'bookingSession.php'</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment">//request the instance<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$instance </span><span class="keyword">= new </span><span class="default">bookingSession</span><span class="keyword">();<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
<br />
...
The __destruct was actually being called each time I grabbed this class with <br />
<br />
<span class="default">&lt;?php $session </span><span class="keyword">=&amp; </span><span class="default">Factory</span><span class="keyword">::</span><span class="default">getBookingSession</span><span class="keyword">(); </span><span class="default">?&gt;<br />
</span><br />
Only after the destruct ran once or twice the construct would run. Obviously causing some major problems.<br />
<br />
MY SOLUTION: was to call the register shutdown function in my fake session construct, like so:<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">class </span><span class="default">bookingSession </span><span class="keyword">{<br />
<br />
function </span><span class="default">__construct</span><span class="keyword">(){<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$session </span><span class="keyword">=&amp; </span><span class="default">Factory</span><span class="keyword">::</span><span class="default">getSession</span><span class="keyword">();<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">setProperties</span><span class="keyword">( </span><span class="default">unserialize</span><span class="keyword">(</span><span class="default">base64_decode</span><span class="keyword">( </span><span class="default">$session</span><span class="keyword">-&gt;</span><span class="default">get</span><span class="keyword">(</span><span class="string">'bookingSession'</span><span class="keyword">) )) );<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">setProperties</span><span class="keyword">(</span><span class="default">JRequest</span><span class="keyword">::</span><span class="default">get</span><span class="keyword">(</span><span class="string">'post'</span><span class="keyword">));<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">register_shutdown_function</span><span class="keyword">(array(</span><span class="default">$this</span><span class="keyword">,</span><span class="string">"destruct"</span><span class="keyword">));<br />
&nbsp;&nbsp;&nbsp; }<br />
<br />
&nbsp;*/<br />
&nbsp;&nbsp;&nbsp; function </span><span class="default">destruct</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$session </span><span class="keyword">=&amp; </span><span class="default">JFactory</span><span class="keyword">::</span><span class="default">getSession</span><span class="keyword">();<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$session</span><span class="keyword">-&gt;</span><span class="default">set</span><span class="keyword">( </span><span class="string">'bookingSession'</span><span class="keyword">, </span><span class="default">base64_encode </span><span class="keyword">(</span><span class="default">serialize </span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">)) );<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
</span><span class="default">?&gt;</span>
</span>
 ...
 <div class="note">
  ...
  <a href="#94003" class="date">11-Oct-2009 04:13</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
This makes it much easier to use your script with fewer compatibility issues.</span>
 ...
 <div class="note">
  ...
  <a href="#93097" class="date">23-Aug-2009 07:05</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp; }<br />
 ...
 <div class="note">
  ...
  <a href="#91813" class="date">26-Jun-2009 06:49</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
constructor is called</span>
 ...
 <div class="note">
  ...
  <a href="#91013" class="date">20-May-2009 06:43</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#90746" class="date">07-May-2009 10:38</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
I was hoping to get the HTTP connection closed and done, and do some slow non-output processing after that, but no luck.</span>
 ...
 <div class="note">
  ...
  <a href="#88575" class="date">29-Jan-2009 10:26</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
I hope this helps somebody else!</span>
 ...
 <div class="note">
  ...
  <a href="#86348" class="date">14-Oct-2008 07:01</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Should be noted that according to the NEWS (in PHP 5.3) file, in PHP 5.3, handling an exception in the __destructor should not output a FATAL error ...</span>
 ...
 <div class="note">
  ...
  <a href="#86260" class="date">09-Oct-2008 02:04</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
The fact that $obj1 is useless and cannot be used as a reference, is further evidence that MyClassB objects should not be instantiated. NOTICE that MyClassB does not use private members or functions to make it behave that way. Rather, it is the collective nature of all the class members + what ISN'T there.</span>
 ...
 <div class="note">
  <strong class='user'>Anonymous</strong>
  <a href="#85638" class="date">09-Sep-2008 05:42</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp; {<br />
&nbsp;&nbsp;&nbsp; return </span><span class="string">"$this-&gt;name the $this-&gt;type goes $this-&gt;sound"</span><span class="keyword">;<br />
&nbsp; }<br />
}<br />
<br />
</span><span class="default">?&gt;<br />
...
</span><span class="keyword">foreach(</span><span class="default">$animals </span><span class="keyword">as </span><span class="default">$animal</span><span class="keyword">) echo </span><span class="string">"$animal&lt;br&gt;\n"</span><span class="keyword">;<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
...
Notice how subclass definitions are really short - no variables or functions at all, and there is no private __construct() method anywhere? Notice how objects of type Dog, Cat, and Bird are all sorted by our base class Animal? All the class definitions above address several issues (keeping objects from being instantiated) and enforces the desired, consistent, and reliable behavior everytime... with the least amount of code. In addition, new extenstions can easily be created. Each subclass is now super easy to redefine or even extend... now that you can see a way to do it.</span>
 ...
 <div class="note">
  ...
  <a href="#83252" class="date">16-May-2008 01:57</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Ensuring that instance of some class will be available in destructor of some other class is easy: just keep a reference to that instance in this other class.</span>
 ...
 <div class="note">
  ...
  <a href="#82477" class="date">12-Apr-2008 10:26</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Since my last note, I've been instructed to _NEVER_ call "unset($this)", never ever ever.&nbsp; Since my previous testing of behavior did not explicitly show me that it was indeed necessary, I'm inclined to trust those telling me not to do it.</span>
 ...
 <div class="note">
  <strong class='user'>ashnazg at php dot net</strong>
  <a href="#81458" class="date">28-Feb-2008 02:39</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
This seems to be the best cleanup approach to take.&nbsp; Just for my own sanity, I also will always keep an unset($this) at the end of each __destruct() method.</span>
 ...
 <div class="note">
  ...
  <a href="#80314" class="date">09-Jan-2008 11:11</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
In short, when a script die()s, there doesn't seem to be any way to predict the order in which the destructors will fire.</span>
 ...
 <div class="note">
  ...
  <a href="#79987" class="date">21-Dec-2007 09:33</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I mentioned in my post below this one that the solution is not perfect and has some flaws.<br />
<br />
Because my note was too big and was not allowed to be submitted, I had to write a new note here containing the flaws. If an editor sees this, please combine both notes to allow for easier reading.<br />
<br />
- This solution assumes that Class B and Class C extend or build upon Class AAbstract. If Class B or Class C extend from each other or from Class A, the original problem will be encountered again.<br />
<br />
- There will be extra overhead in including an extra file ... the dummy Class AAbstract.</span>
</code></div>
  </div>
 </div>
 <a name="79986"></a>
 <div class="note">
  <strong class='user'>Typer85 at gmail dot com</strong>
  <a href="#79986" class="date">21-Dec-2007 09:31</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Good Luck,</span>
 ...
 <div class="note">
  ...
  <a href="#78766" class="date">26-Oct-2007 10:17</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I've been working on a project for a while now, and for example in my DB handler I wanted to load var's to the objects late; However, without doing it manually on the object itself but through a single static call. For other reasons, in my Sessions I then wanted to end them early without registering a shutdown routine for every possible session. Hence, I needed a way to track EVERY instance or object of the class.<br />
<br />
(Of course in a normal website design, this would be overly coded. It's more of a framework for a CMS, Daemon service, anything I wanna create etc...)<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">class </span><span class="default">example </span><span class="keyword">{<br />
<br />
&nbsp;&nbsp;&nbsp; public static </span><span class="default">$OBJS </span><span class="keyword">= array();<br />
&nbsp;&nbsp;&nbsp; public </span><span class="default">$id</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">__construct</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">example</span><span class="keyword">::</span><span class="default">$OBJS</span><span class="keyword">[] = </span><span class="default">$this</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment"># I actually use a 'lastKey' routine here, but in this example the following should work:<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">id </span><span class="keyword">= </span><span class="default">key</span><span class="keyword">( </span><span class="default">array_slice</span><span class="keyword">(</span><span class="default">example</span><span class="keyword">::</span><span class="default">$OBJS</span><span class="keyword">, </span><span class="default">count</span><span class="keyword">(</span><span class="default">example</span><span class="keyword">::</span><span class="default">$OBJS</span><span class="keyword">) -</span><span class="default">1</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">, </span><span class="default">true</span><span class="keyword">) );<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">__destruct</span><span class="keyword">() {<br />
...
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
</span><span class="comment"># unset the tracked object<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">private function </span><span class="default">destruct</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; if ( isset(</span><span class="default">example</span><span class="keyword">::</span><span class="default">$OBJS</span><span class="keyword">[</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">id</span><span class="keyword">]) )<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; unset(</span><span class="default">example</span><span class="keyword">::</span><span class="default">$OBJS</span><span class="keyword">[</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">id</span><span class="keyword">]);<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
</span><span class="comment"># public shutdown routine<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">close</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; if ( isset(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">destructed</span><span class="keyword">) )<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; return;<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment"># ...<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">destruct</span><span class="keyword">();<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">destructed </span><span class="keyword">= </span><span class="default">true</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
}<br />
<br />
...
You could then also use register_shutdown_function(...) to call a static class method, which loops through ALL the objects and calls the $obj-&gt;close routine.<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="comment"># register a shutdown function which triggers before destructors (hence when such results are desired for a Session class, etc)<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">register_shutdown_function</span><span class="keyword">(</span><span class="string">"example::destructors"</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; <br />
class </span><span class="default">example </span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; </span><span class="comment"># ... see above code example<br />
&nbsp;&nbsp;&nbsp; <br />
# static class method to destruct all objects<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public static function </span><span class="default">destructors</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; foreach ( </span><span class="default">example</span><span class="keyword">::</span><span class="default">$OBJS </span><span class="keyword">as </span><span class="default">$obj </span><span class="keyword">)<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$obj</span><span class="keyword">-&gt;</span><span class="default">destruct</span><span class="keyword">();<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
}<br />
<br />
</span><span class="default">This will probably give some people </span><span class="keyword">new </span><span class="default">ideas</span><span class="keyword">, and </span><span class="default">other will probably be confused</span><span class="keyword">. </span><span class="default">Happy coding</span><span class="keyword">...<br />
<br />
</span><span class="default">NOTE</span><span class="keyword">: </span><span class="default">I didnt test the code</span><span class="keyword">(</span><span class="default">s</span><span class="keyword">) </span><span class="default">above</span><span class="keyword">. </span><span class="default">They were a rewritten example from my frameworks</span><span class="keyword">.<br />
<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
 ...
 <div class="note">
  ...
  <a href="#78737" class="date">25-Oct-2007 02:45</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp; </span><span class="keyword">}<br />
 ...
 <div class="note">
  ...
  <a href="#78430" class="date">11-Oct-2007 12:20</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
regards, J</span>
 ...
 <div class="note">
  ...
  <a href="#76446" class="date">16-Jul-2007 06:59</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#76361" class="date">11-Jul-2007 04:35</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
What you could do is write the constructor without any declared arguments, then iterate through the arguments given and check their types/values to determine what other function to use as the constructor.</span>
 ...
 <div class="note">
  ...
  <a href="#76235" class="date">06-Jul-2007 07:46</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp; }<br />
 ...
 <div class="note">
  <strong class='user'>Typer85 at gmail dot com</strong>
  <a href="#75514" class="date">03-Jun-2007 07:16</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I am not sure if the following is known or not, but here goes.<br />
<br />
I am sure most are aware of the concept of making a Class Constructor private to prevent an Object of that Class from being created as follows:<br />
<br />
<span class="default">&lt;?php<br />
<br />
...
In some code, if I try to do the following:<br />
<br />
<span class="default">&lt;?php<br />
<br />
$Obj </span><span class="keyword">= new </span><span class="default">A</span><span class="keyword">( );<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
PHP will fail with a fatal error. This is useful when creating Classes that are composed of only static functions or in a more advanced example, when applying the Singleton Pattern to a Class design.<br />
<br />
However what is not properly documented in this manual but is pretty simple to note, especially if you read the notes regarding the Singleton Pattern, is that you can create an Object of a Class that has a private Constructor from within the Class itself.<br />
<br />
Confused ... so am I, so allow me to provide a visual example as follows:<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">class </span><span class="default">A<br />
...
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">/**<br />
&nbsp;&nbsp; &nbsp; * Function To Return An Instance Of This Class.<br />
&nbsp;&nbsp; &nbsp; */<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public static function </span><span class="default">getNewInstance</span><span class="keyword">( ) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
...
<span class="default">&lt;?php<br />
<br />
$Obj </span><span class="keyword">= </span><span class="default">A</span><span class="keyword">::</span><span class="default">getNewInstance</span><span class="keyword">( );<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
PHP in this case will not fail with a fatal error and instead the variable '$Obj' becomes an Object with an instance of Class 'A'.<br />
<br />
This is a simple example and pretty advanced things can be done using this method. I am sure advanced developers are aware of this so this is just a little note going out to new PHP developers.</span>
</code></div>
  </div>
 </div>
 <a name="75197"></a>
...
This is obviously not true. If you instantiate a class in a function or class method, but it is not returned by the method, nor is it saved in a global or object member variable, the object is cleaned up, and it's destructor is called. This can of course occur before anything is printed or sent to the client.</span>
 ...
 <div class="note">
  ...
  <a href="#74511" class="date">14-Apr-2007 07:11</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
The manual says:<br />
...
---</span>
 ...
 <a name="71107"></a>
 <div class="note">
  <strong class='user'>robert at lax-berlin dot de</strong>
  <a href="#71107" class="date">12-Nov-2006 12:48</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
In response to prauscher at gmx dot net:<br />
<br />
As tcknetwork wrote earlier, if you try to access a file from a destructor, you have to be aware that you are probably in the webservers root directory, because the destructor already "forgot" what you working directory was. If you try to write a file there, you will probably have no permission to do so.<br />
Read tcknetwork's post for a solution.</span>
</code></div>
  </div>
 </div>
 <a name="70928"></a>
 <div class="note">
  <strong class='user'>maniac_warlord at web dot de</strong>
  <a href="#70928" class="date">04-Nov-2006 04:50</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
as reported in bug 34206 the working dir is changed to the server root<br />
the best workaround is<br />
<span class="default">&lt;?php<br />
...
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">_cwd </span><span class="keyword">= </span><span class="default">getcwd</span><span class="keyword">();<br />
&nbsp;&nbsp;&nbsp; }<br />
<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">__destruct</span><span class="keyword">()<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">chdir</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">_cwd</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
</span><span class="default">?&gt;<br />
</span>Be aware the booty trap!<br />
<a href="http://bugs.php.net/bug.php?id=34206" rel="nofollow" target="_blank">http://bugs.php.net/bug.php?id=34206</a></span>
</code></div>
  </div>
 </div>
 <a name="70876"></a>
 <div class="note">
  ...
  <a href="#70876" class="date">01-Nov-2006 09:23</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
I have no idea how efficient this is, but it works at any rate.&nbsp; Hopefully this helps someone.</span>
 ...
 <a name="70051"></a>
 <div class="note">
  <a href="#70051" class="date">01-Oct-2006 11:03</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
For example, if your superclass includes a database connection and your subclass __destruct method commits things to the database then if you call the superclass destruct before doing so then the database connection will no longer be valid and you will be unable to commit your changes.</span>
 ...
 <div class="note">
  ...
  <a href="#69036" class="date">20-Aug-2006 09:56</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Adding a reference from the contained class to the containing one (the # comment) will not change that, but beware, because it can cause random errors in other destructors in the parts of the script which seem unrelated! (PHP Version 5.1.2)</span>
 ...
 <a name="68870"></a>
 <div class="note">
  <strong class='user'>prauscher at gmx dot net</strong>
  <a href="#68870" class="date">14-Aug-2006 04:05</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I saw no note in the manual about my function. If you want to write a file in a __destruct - function, it will fail with a "Permission denied" Error.</span>
</code></div>
  </div>
 </div>
 <a name="68028"></a>
...
The only solution is to merge the two constructors in one by adding an optional $inDom parameter to every constructor.</span>
 ...
 <div class="note">
  <strong class='user'>Peter Molnar</strong>
  <a href="#66288" class="date">18-May-2006 06:24</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; }<br />
 ...
 <a name="64107"></a>
 <div class="note">
  <strong class='user'>ckoschmied at web dot de</strong>
  <a href="#64107" class="date">07-Apr-2006 07:58</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Be aware of the fact that if you create a new instance of a class like this:<br />
<br />
$instance = new Class();<br />
<br />
$instance will not contain a valid reference to the newly created object until the constructor is finished. So don't use $instance while the constructor is still running.<br />
<br />
Well, on the other side, why would you want to do it? I wanted to, and it took me some hours to figure out.<br />
Even though it's quite obvious if you think about it :-)</span>
</code></div>
  </div>
 </div>
 <a name="63590"></a>
 <div class="note">
  ...
  <a href="#63590" class="date">24-Mar-2006 09:52</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
__construct and __destruct must be declared public in any class that you intend to instantiate with new.&nbsp;&nbsp; However, in an abstract (or never-instantiated base) class you can declare them private or protected, and subclasses can still refer to them via parent::__construct (!) (tested in PHP 5.1.2).</span>
 ...
 <a name="61691"></a>
 <div class="note">
  <a href="#61691" class="date">09-Feb-2006 10:55</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
(Refering to: caliban at darklock dot com)<br />
<br />
To force a constructor always to be called, and still be able to define a constructor on a derived class use the model below. Ideal for module architectures, because you only have to know the file and classname to construct an object.<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">class </span><span class="default">Parameter </span><span class="keyword">{}<br />
<br />
abstract class </span><span class="default">BaseClass<br />
</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; protected </span><span class="default">$param</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; public final function </span><span class="default">__construct</span><span class="keyword">( </span><span class="default">Parameter $param </span><span class="keyword">)<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">param </span><span class="keyword">= </span><span class="default">$param</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">pseudoConstruct</span><span class="keyword">();<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; protected abstract function </span><span class="default">pseudoConstruct</span><span class="keyword">();<br />
}<br />
<br />
class </span><span class="default">ConcreteClass </span><span class="keyword">extends </span><span class="default">BaseClass<br />
</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; protected function </span><span class="default">pseudoConstruct</span><span class="keyword">()<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="default">__CLASS__</span><span class="keyword">.</span><span class="string">' constructor'</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="default">$refl </span><span class="keyword">= new </span><span class="default">ReflectionClass</span><span class="keyword">( </span><span class="string">'ConcreteClass' </span><span class="keyword">);<br />
if( !</span><span class="default">$refl</span><span class="keyword">-&gt;</span><span class="default">isSubclassOf</span><span class="keyword">( </span><span class="string">'BaseClass' </span><span class="keyword">) ) throw new </span><span class="default">Exception</span><span class="keyword">( </span><span class="string">'Invalid base class!' </span><span class="keyword">);<br />
</span><span class="default">$refl</span><span class="keyword">-&gt;</span><span class="default">newInstance</span><span class="keyword">( new </span><span class="default">Parameter</span><span class="keyword">() );<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
  </div>
 ...
 <a name="61286"></a>
 <div class="note">
  <strong class='user'>jochem AT mondrian-it d_o_t nl</strong>
  <a href="#61286" class="date">30-Jan-2006 04:07</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
at: derk AT oneindig DOT com<br />
<br />
You can achieve identical functionality by doing this:<br />
<span class="default">&lt;?php<br />
...
</span>Added advantage is that Parent doesn't need to have the method myConstruct(), and that you're using constructors like they were intended.</span>
</code></div>
  </div>
 </div>
 <a name="61083"></a>
...
&nbsp; public function </span><span class="default">__construct</span><span class="keyword">()<br />
&nbsp; {<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">//do smth<br />
&nbsp; </span><span class="keyword">}<br />
}<br />
<br />
abstract class </span><span class="default">B </span><span class="keyword">extends </span><span class="default">A<br />
</span><span class="keyword">{<br />
&nbsp; public function </span><span class="default">__construct</span><span class="keyword">()<br />
&nbsp; {<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">parent</span><span class="keyword">::</span><span class="default">__construct</span><span class="keyword">();<br />
...
thus, you avoid instanciating class B as if it had a protected contructor</span>
</code></div>
  </div>
 </div>
 <a name="59272"></a>
 <div class="note">
  <strong class='user'>aya at eh dot org</strong>
  <a href="#59272" class="date">01-Dec-2005 02:20</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
For those who aren't already aware, PHP5 currently suffers from the classic reference counting leak. See <a href="http://en.wikipedia.org/wiki/Reference_counting" rel="nofollow" target="_blank">http://en.wikipedia.org/wiki/Reference_counting</a> for more info.<br />
<br />
Example code:<br />
<br />
<span class="default">&lt;?php<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">class </span><span class="default">Noisy<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">{<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; private </span><span class="default">$name</span><span class="keyword">;<br />
<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; public function </span><span class="default">__construct</span><span class="keyword">(</span><span class="default">$name</span><span class="keyword">)<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">name </span><span class="keyword">= </span><span class="default">$name</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"Noisy::__construct($this-&gt;name)\n"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; public function </span><span class="default">__destruct</span><span class="keyword">()<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"Noisy::__destruct($this-&gt;name)\n"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; function </span><span class="default">foo</span><span class="keyword">(</span><span class="default">$num</span><span class="keyword">)<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$noisy </span><span class="keyword">= new </span><span class="default">Noisy</span><span class="keyword">(</span><span class="default">$num</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment">//$noisy-&gt;me = $noisy; // Uncomment this line to create a cyclic reference<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">}<br />
<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">foo</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">);<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
As it stands, the destructor of class 'Noisy' will be called on '$noisy' when it goes out of scope in function 'foo', but uncommenting the second line in function 'foo' will prevent this, and cause a memory leak.<br />
<br />
See <a href="http://bugs.php.net/bug.php?id=33595" rel="nofollow" target="_blank">http://bugs.php.net/bug.php?id=33595</a> for a bug report, which reads as if this is not likely to get fixed in the near future, so watch out!</span>
</code></div>
  </div>
 </div>
 <a name="58426"></a>
 <div class="note">
  ...
  <a href="#58426" class="date">03-Nov-2005 02:02</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Child 'constructor' called</span>
 ...
 <div class="note">
  ...
  <a href="#56996" class="date">21-Sep-2005 12:54</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; (be careful with includes, it will give the path of the file processed and not the main file)</span>
 ...
 <div class="note">
  ...
  <a href="#55799" class="date">13-Aug-2005 09:50</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
This can be misleading if you have debug info printed in the destructor but not a problem if you know it.</span>
 ...
 <div class="note">
  ...
  <a href="#55524" class="date">05-Aug-2005 12:43</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
IMHO using func_get_args() is superior to constructor polymorphism, because you don't have to define constructors for every possible way a class can be initialized.<br />
<br />
The pattern I use looks like this;&nbsp; all you have to do is pass the parameters in the correct order.<br />
<br />
<span class="default">&lt;?php<br />
<br />
&nbsp; </span><span class="keyword">class </span><span class="default">Movie<br />
&nbsp; </span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; public </span><span class="default">$title</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; public </span><span class="default">$director</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; public </span><span class="default">$stars</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; public </span><span class="default">$year_released</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">__construct</span><span class="keyword">()<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp;&nbsp; </span><span class="default">$args </span><span class="keyword">= </span><span class="default">func_get_args</span><span class="keyword">();<br />
&nbsp;&nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp;&nbsp; foreach(array(</span><span class="string">"title"</span><span class="keyword">, </span><span class="string">"director"</span><span class="keyword">, </span><span class="string">"stars"</span><span class="keyword">, </span><span class="string">"year_released"</span><span class="keyword">) as </span><span class="default">$i</span><span class="keyword">)<br />
&nbsp;&nbsp; &nbsp;&nbsp; {<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">$i </span><span class="keyword">= </span><span class="default">array_shift</span><span class="keyword">(</span><span class="default">$args</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp; }<br />
 ...
 <div class="note">
  ...
  <a href="#54639" class="date">10-Jul-2005 07:12</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
The solution? Either turn E_STRICT off (and possibly forgo some other important notices), rename your function (and possibly make things a little more complicated), or look at using an interface.</span>
 ...
 <a name="51958"></a>
 <div class="note">
  <strong class='user'>rocco at bluora dot com dot au</strong>
  <a href="#51958" class="date">16-Apr-2005 08:29</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Before PHP reaches the point where it calls the __destruct functions, it has already done a session_write_close() so you can no longer write anything to the session.<br />
<br />
I wanted it to copy some variables from my class into the session once the script had finished but now having to get the last function to call a SaveToSession() function.<br />
<br />
In php versions 5.0.2 and 5.0.4</span>
</code></div>
  </div>
 </div>
 <a name="51935"></a>
 <div class="note">
  <strong class='user'>contact at tcknetwork dot com</strong>
  <a href="#51935" class="date">15-Apr-2005 08:45</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
In case you use unset($t) in php4, the destructor is not called. so be careful.</span>
 ...
 <div class="note">
  ...
  <a href="#51414" class="date">30-Mar-2005 01:59</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
in general, there is no need to disconnect the database (especially for persistent connections).</span>
 ...
 <a name="50626"></a>
 <div class="note">
  <a href="#50626" class="date">04-Mar-2005 03:48</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
&gt; To caliban at darklock dot com: Why not just define <br />
&gt; a dummy constructor <br />
<br />
Because you don't always get to modify your base classes. Once you get beyond the "build to suit" range of software development, you end up having to work with other people's code, and sometimes you just plain can't change it. When Bob is in charge of making changes to that object, you can't add a dummy constructor. You have to tell Bob to do it, and until Bob does it, you don't get it. So if you want to hit your deadlines, you don't count on Bob caring enough about your job to make the changes you want... you work around it. It might be convenient for *you* to have a constructor on that object, but when you're only one of several thousand people that are using it, your convenience isn't generally among the design criteria. <br />
<br />
Smaller projects where you can add whatever you want wherever you want will not have this problem, in which case the dummy constructor is indeed a better solution.</span>
</code></div>
  </div>
 </div>
 <a name="50301"></a>
 <div class="note">
  <a href="#50301" class="date">24-Feb-2005 01:08</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
To caliban at darklock dot com: Why not just define a dummy constructor <span class="default">&lt;?PHP </span><span class="keyword">function </span><span class="default">__construct</span><span class="keyword">() {} </span><span class="default">?&gt;</span> in the base class? This adds little overhead, and allows you to both extend the class worry-free and later add construct functionality to the base class.<br />
<br />
And now, about destructors: I haven't seen this clarified anywhere in the manual, but object destructors are called implicitly at script shutdown for all objects that still exist at that Tpoint. his happens *after* any shutdown functions set with <span class="default">&lt;?PHP register_shutdown_function</span><span class="keyword">() </span><span class="default">?&gt;</span> have been called.<br />
<br />
Objects appear to be destructed in the order they were defined, which means you have to be careful with destruct methods that rely on the functionality of other objects (e.g. on a database-handler) as they will have shut down already.</span>
</code></div>
  </div>
 </div></div>

 <div class="foot"><a href="/manual/add-note.php?sect=language.oop5.decon&amp;redirect=http://www.php.net/manual/en/language.oop5.decon.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.oop5.decon&amp;redirect=http://www.php.net/manual/en/language.oop5.decon.php">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.oop5.decon.php">show source</a> |

...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="language.operators.assignment.php" />
 <link rel="next" href="language.operators.comparison.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/operators.bitwise" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/language.operators.bitwise.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="@w{5B3FC3DK}" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.operators.bitwise.php">Bitwise Operators</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.operators.comparison.php">Comparison Operators<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.operators.assignment.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Assignment Operators</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.operators.bitwise.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
 <div class="langchooser">
  <form action="/manual/change.php" method="get">
   <p>view this page in </p><fieldset><select name="page">
    ...
    <option value="pl/language.operators.bitwise.php">Polish</option>
    ...
    <option value="fa/language.operators.bitwise.php">Persian</option>
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.operators.bitwise&amp;redirect=@w{5B3FC3DK}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.operators.bitwise&amp;redirect=@w{5B3FC3DK}">add a note</a></small></span>
 ...
 <div class="note">
  ...
  <a href="#108679" class="date">17-May-2012 03:52</a>
  <div class="text">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#106123" class="date">12-Oct-2011 07:56</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
and the result is "10" which is 100% correct.</span>
 ...
 <div class="note">
  ...
  <a href="#105821" class="date">17-Sep-2011 06:21</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
You might be wondering how does 1101 = -3. Well PHP uses the method "2's complement" to render negative binary numbers. If the left most bit is a 1 then the binary number is negative and you flip the bits and add 1. If it is 0 then it is positive and you don't have to do anything. So 0010 would be a positive 2. If it is 1101, it is negative and you flip the bits to get 0010. Add 1 and you get 0011 which equals -3.</span>
 ...
 <div class="note">
  ...
  <a href="#105370" class="date">12-Aug-2011 05:07</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; //Therefore 110001 &amp; 110011 = 110001<br />
 ...
 <div class="note">
  <strong class='user'>Anonymous</strong>
  <a href="#105157" class="date">31-Jul-2011 04:33</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Using stings will just use every byte of the string - which is for me not unexpected at all:<br />
<span class="default">&lt;?php<br />
</span><span class="string">'18'</span><span class="keyword">&amp; </span><span class="string">'32'</span><span class="keyword">== </span><span class="string">'10'<br />
</span><span class="comment">// ord( '1' )== 49, ord( '8' )== 56, ord( '3' )== 51, ord( '2' )== 50<br />
// 49&amp; 51== 49, 56&amp; 50== 48<br />
// chr( 49 )== '1', chr( 48 )== '0'<br />
</span><span class="default">?&gt;<br />
</span>You have to typecast each operand to the data type you're expecting.</span>
</code></div>
  </div>
 </div>
 <a name="104291"></a>
 <div class="note">
  ...
  <a href="#104291" class="date">06-Jun-2011 04:44</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
As an additional curiosity, for some reason the result of the operation ("18" &amp; "32") is "10". In other words, try avoiding using the binary operators on strings :)</span>
 ...
 <div class="note">
  ...
  <a href="#102403" class="date">11-Feb-2011 07:54</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
//&nbsp; &nbsp; return ($u);<br />
 ...
 <div class="note">
  ...
  <a href="#99589" class="date">25-Aug-2010 08:19</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
I hope this helps someone as much as it would have helped me a week ago!</span>
 ...
 <div class="note">
  ...
  <a href="#99335" class="date">11-Aug-2010 10:24</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
My password hashing function was always returning the same hash... Because I was XOR-ing it with a salt that was sometimes empty!</span>
 ...
 <a name="98979"></a>
 <div class="note">
  <strong class='user'>steffen at NO-SPAM dot haugk dot co dot uk</strong>
  <a href="#98979" class="date">20-Jul-2010 03:23</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
It says above that the effect of <br />
E_ALL &amp; ~E_NOTICE<br />
can also be achieved by<br />
E_ALL ^ E_NOTICE<br />
<br />
NB: XOR is not equivalent to AND NOT.<br />
<br />
This only works here because E_ALL consists of 1s mostly, with the exception of the bit for E_STRICT.<br />
As E_ALL means all error levels apart from E_STRICT. XORing any error level switches it off, but XORing E_STRICT will switch it on.<br />
<br />
E_ALL ^ E_NOTICE : E_NOTICE switched off<br />
E_ALL ^ E_STRICT : E_STRICT switched on<br />
<br />
E_ALL &amp; ~E_NOTICE : E_STRICT switched off<br />
E_ALL &amp; ~E_STRICT : E_STRICT remains switched off</span>
</code></div>
  </div>
 </div>
 <a name="97917"></a>
 <div class="note">
  ...
  <a href="#97917" class="date">15-May-2010 01:25</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
and the latter of the two should be used.</span>
 ...
 <div class="note">
  <strong class='user'>Anonymous</strong>
  <a href="#95614" class="date">12-Jan-2010 10:18</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#94552" class="date">11-Nov-2009 10:10</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
return </span><span class="default">$Shiftr</span><span class="keyword">;<br />
 ...
 <div class="note">
  ...
  <a href="#94144" class="date">19-Oct-2009 07:52</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#91291" class="date">03-Jun-2009 08:48</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Once you get your head around it, it's VERY useful! Just remember to raise each value by the power of two to avoid problems</span>
 ...
 <div class="note">
  ...
  <a href="#90850" class="date">12-May-2009 04:36</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
I always avoid using decimal notation when I have a large amount of different flags, because it's very easy to misspell numbers like 2^20 (1048576).</span>
 ...
 <div class="note">
  ...
  <a href="#90514" class="date">26-Apr-2009 12:19</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
If you want to understand binary numbers, bits and bitwise operation better, the wikipedia page explains it well - <a href="http://en.wikipedia.org/wiki/Bitwise_operation." rel="nofollow" target="_blank">http://en.wikipedia.org/wiki/Bitwise_operation.</a></span>
 ...
 <div class="note">
  ...
  <a href="#90310" class="date">15-Apr-2009 02:22</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; return </span><span class="default">$num</span><span class="keyword">; <br />
 ...
 <div class="note">
  ...
  <a href="#84954" class="date">07-Aug-2008 12:03</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; return </span><span class="default">$res</span><span class="keyword">;<br />
 ...
 <div class="note">
  ...
  <a href="#82344" class="date">07-Apr-2008 02:27</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
cheers, Bart</span>
 ...
 <div class="note">
  ...
  <a href="#79662" class="date">06-Dec-2007 06:35</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; }<br />
 ...
 <div class="note">
  ...
  <a href="#75888" class="date">20-Jun-2007 06:42</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
To perform bitwise operations on floats, or anything for that matter, in the binary representation of your choice, simply use pack() on the data with the appropriate parameters, then you can operate on the resulting strings. in the end just unpack()</span>
</code></div>
  </div>
 </div>
 <a name="73578"></a>
 <div class="note">
  ...
  <a href="#73578" class="date">01-Mar-2007 04:23</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
XNOR is very usefull ;D</span>
 ...
 <div class="note">
  ...
  <a href="#73088" class="date">08-Feb-2007 11:19</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
 ...
 <div class="note">
  ...
  <a href="#72300" class="date">11-Jan-2007 11:28</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
This will save you many headaches when troubleshooting a completely illogical result.</span>
 ...
 <div class="note">
  ...
  <a href="#71145" class="date">13-Nov-2006 04:12</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; return </span><span class="default">$binary</span><span class="keyword">{</span><span class="default">0</span><span class="keyword">} == </span><span class="string">"1" </span><span class="keyword">? -(</span><span class="default">pow</span><span class="keyword">(</span><span class="default">2</span><span class="keyword">, </span><span class="default">31</span><span class="keyword">) - </span><span class="default">bindec</span><span class="keyword">(</span><span class="default">substr</span><span class="keyword">(</span><span class="default">$binary</span><span class="keyword">, </span><span class="default">1</span><span class="keyword">))) : </span><span class="default">bindec</span><span class="keyword">(</span><span class="default">$binary</span><span class="keyword">);<br />
 ...
 <div class="note">
  ...
  <a href="#61478" class="date">04-Feb-2006 01:34</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
<span class="default">&lt;?php<br />
<br />
...
<br />
 ...
 <div class="note">
  ...
  <a href="#61415" class="date">02-Feb-2006 02:11</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
is not a way to test for four-way equality. If a is zero, it'll always be true, and in general it will be true any time a has no bits not also in the other three values.</span>
 ...
 <div class="note">
  ...
  <a href="#58272" class="date">29-Oct-2005 09:50</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#58190" class="date">26-Oct-2005 07:30</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<a href="http://www.evergreen.edu/biophysics/technotes/program/2s_comp.htm" rel="nofollow" target="_blank">http://www.evergreen.edu/biophysics/technotes/program/2s_comp.htm</a></span>
 ...
 <div class="note">
  ...
  <a href="#58186" class="date">26-Oct-2005 05:22</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; return $total;<br />
 ...
 <div class="note">
  ...
  <a href="#57281" class="date">29-Sep-2005 05:23</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
5</span>
 ...
 <div class="note">
  ...
  <a href="#56382" class="date">31-Aug-2005 05:19</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
echo("D: $d&lt;br /&gt;");</span>
 ...
 <a name="52032"></a>
 <div class="note">
  <strong class='user'>Séb.</strong>
  <a href="#52032" class="date">19-Apr-2005 07:28</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; // 8192<br />
 ...
 <div class="note">
  <strong class='user'>Séb.</strong>
  <a href="#50622" class="date">04-Mar-2005 03:13</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; // Red : FE (254), Green : A9 (169), Blue : 46 (70)<br />
 ...
 <div class="note">
  ...
  <a href="#50299" class="date">23-Feb-2005 11:24</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
array(0) {<br />
 ...
 <div class="note">
  ...
  <a href="#49231" class="date">20-Jan-2005 02:12</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Note that the ^ operator, unlike in some other languages, is *not* the same as the pow() function.</span>
 ...
 <div class="note">
  ...
  <a href="#40107" class="date">22-Feb-2004 01:07</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp; }<br />
 ...
 <div class="note">
  ...
  <a href="#38019" class="date">04-Dec-2003 02:30</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
2 + 4 = 6 (Strip HTML + Convert to lower case)</span>
 ...
 <div class="foot"><a href="/manual/add-note.php?sect=language.operators.bitwise&amp;redirect=@w{5B3FC3DK}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.operators.bitwise&amp;redirect=@w{5B3FC3DK}">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.operators.bitwise.php">show source</a> |

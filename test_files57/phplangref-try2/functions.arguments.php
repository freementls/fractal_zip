...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="functions.user-defined.php" />
 <link rel="next" href="functions.returning-values.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/functions.arguments" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/functions.arguments.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="http://www.php.net/manual/en/functions.arguments.php" />
...
<ul class="toc">
 ...
 <li class="active"><a href="functions.arguments.php">Function arguments</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="functions.returning-values.php">Returning values<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="functions.user-defined.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />User-defined functions</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/functions.arguments.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
   ...
   <div class="sect2" id="functions.variable-arg-list">
    ...
    <p class="simpara">
     ...
     user-defined functions. This is really quite easy, using the
      <span class="function"><a href="function.func-num-args.php" class="function">func_num_args()</a></span>,
      <span class="function"><a href="function.func-get-arg.php" class="function">func_get_arg()</a></span>, and
      <span class="function"><a href="function.func-get-args.php" class="function">func_get_args()</a></span> functions.
    </p>
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=functions.arguments&amp;redirect=http://www.php.net/manual/en/functions.arguments.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=functions.arguments&amp;redirect=http://www.php.net/manual/en/functions.arguments.php">add a note</a></small></span>
  <small>User Contributed Notes</small>
  <strong>Function arguments</strong>
 </div><div id="allnotes">
 <a name="104404"></a>
 <div class="note">
  <strong class='user'>jacob at jacobweber dot com</strong>
  <a href="#104404" class="date">13-Jun-2011 02:05</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
This page states:<br />
<br />
"Note that when using default arguments, any defaults should be on the right side of any non-default arguments; otherwise, things will not work as expected."<br />
<br />
There seems to be one exception to this. Say you're using type-hinting for an argument, but you want to allow it to be NULL, and you want additional required arguments to the right of it. PHP allows this, as long as you give it the type-hinted argument a default value of NULL. For example:<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">sample</span><span class="keyword">(</span><span class="default">ClassA $a </span><span class="keyword">= </span><span class="default">NULL</span><span class="keyword">, </span><span class="default">$b</span><span class="keyword">) {<br />
}<br />
</span><span class="default">sample</span><span class="keyword">(new </span><span class="default">ClassA</span><span class="keyword">(), </span><span class="string">''</span><span class="keyword">); </span><span class="comment">// success<br />
</span><span class="default">sample</span><span class="keyword">(new </span><span class="default">ClassB</span><span class="keyword">(), </span><span class="string">''</span><span class="keyword">); </span><span class="comment">// failure; wrong type<br />
</span><span class="default">sample</span><span class="keyword">(</span><span class="default">NULL</span><span class="keyword">, </span><span class="string">''</span><span class="keyword">); </span><span class="comment">// success<br />
</span><span class="default">sample</span><span class="keyword">(new </span><span class="default">ClassA</span><span class="keyword">()); </span><span class="comment">// failure; missing second argument<br />
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; case </span><span class="string">'class'</span><span class="keyword">: </span><span class="default">$class </span><span class="keyword">= </span><span class="string">"class = '$v'"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; break;<br />
...
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; return </span><span class="string">"&lt;div $class&gt;$text&lt;/div&gt;"</span><span class="keyword">;<br />
}<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
...
Building upon this, it's also easy to provide fallback behaviors when the argument given is not valid: simply put a default that is known to be invalid in the prototype, and then check for general validity instead of a specific value: if the argument is not valid (either not given, so the default is used, or an invalid value was given), the function computes a (valid) default to use.</span>
 ...
 <div class="note">
  ...
  <a href="#79326" class="date">20-Nov-2007 05:50</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Actually the use of class or global constants does buy us something. It helps enforce the DRY (don't repeat yourself) principle.</span>
 ...
 <div class="note">
  ...
  <a href="#79008" class="date">06-Nov-2007 06:07</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
@ jbarnett at flowershopnetwork dot com:<br />
<br />
Yes, but that doesn't get us anywhere; you could just as well have said:<br />
myMethod($arg = "constant value")<br />
<br />
Class constants must have constant values, as well. <a href="@w{YJG6GKB3}" rel="nofollow" target="_blank">@w{YJG6GKB3}</a></span>
</code></div>
  </div>
 </div>
 <a name="74676"></a>
...
I think you are referring to Type Hinting. It is documented here: <a href="http://ch2.php.net/language.oop5.typehinting" rel="nofollow" target="_blank">http://ch2.php.net/language.oop5.typehinting</a></span>
 ...
 <div class="note">
  ...
  <a href="#73338" class="date">18-Feb-2007 09:43</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Note that constants can also be used as default argument values<br />
so the following code:<br />
<br />
&nbsp; define('TEST_CONSTANT','Works!');<br />
&nbsp; function testThis($var=TEST_CONSTANT) {<br />
&nbsp;&nbsp; &nbsp;&nbsp; echo "Passing constants as default values $var";<br />
&nbsp; }<br />
&nbsp; testThis();<br />
<br />
will produce :<br />
<br />
Passing constants as default values Works!<br />
<br />
...
outputs 0 (false)</span>
 ...
 <a name="70511"></a>
 <div class="note">
  <strong class='user'>keuleu at hotmail dot com</strong>
  <a href="#70511" class="date">19-Oct-2006 02:59</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I ran into the problem that jcaplan mentionned. I had just finished building 2 handler classes and one interface. <br />
<br />
During my testing I realized that my handlers were not initializing their variables to their default values when my interface was calling them with 'null' values:<br />
<br />
this is a simplified illustration:<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">function </span><span class="default">some_function</span><span class="keyword">(</span><span class="default">$v1</span><span class="keyword">=</span><span class="string">'value1'</span><span class="keyword">,</span><span class="default">$v2</span><span class="keyword">=</span><span class="string">'value2'</span><span class="keyword">,</span><span class="default">$v3</span><span class="keyword">=</span><span class="string">'value3'</span><span class="keyword">){<br />
&nbsp; echo </span><span class="default">$v1</span><span class="keyword">.</span><span class="string">',&nbsp; '</span><span class="keyword">;<br />
&nbsp; echo </span><span class="default">$v2</span><span class="keyword">.</span><span class="string">',&nbsp; '</span><span class="keyword">;<br />
&nbsp; echo </span><span class="default">$v3</span><span class="keyword">;<br />
}<br />
<br />
</span><span class="default">some_function</span><span class="keyword">(); </span><span class="comment">//this will behave as expected, displaying 'value1,&nbsp; value2,&nbsp; value3'<br />
</span><span class="default">some_function</span><span class="keyword">(</span><span class="default">null</span><span class="keyword">,</span><span class="default">null</span><span class="keyword">,</span><span class="default">null</span><span class="keyword">); </span><span class="comment">//this on the other hand will display ',&nbsp; ,' since the variables will take the null value.<br />
</span><span class="default">?&gt;<br />
</span><br />
I came to about the same conclusion as jcaplan. To force your function parameters to take a default value when a null is passed you need to include a conditionnal assignment inside the function definition. <br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">some_function</span><span class="keyword">(</span><span class="default">$v1</span><span class="keyword">=</span><span class="string">'value1'</span><span class="keyword">,</span><span class="default">$v2</span><span class="keyword">=</span><span class="string">'value1'</span><span class="keyword">,</span><span class="default">$v3</span><span class="keyword">=</span><span class="default">null</span><span class="keyword">){<br />
&nbsp; </span><span class="default">$v1</span><span class="keyword">=(</span><span class="default">is_null</span><span class="keyword">(</span><span class="default">$v1</span><span class="keyword">)?</span><span class="string">'value1'</span><span class="keyword">:</span><span class="default">$v1</span><span class="keyword">);<br />
&nbsp; </span><span class="default">$v2</span><span class="keyword">=(</span><span class="default">is_null</span><span class="keyword">(</span><span class="default">$v2</span><span class="keyword">)?</span><span class="string">'value2'</span><span class="keyword">:</span><span class="default">$v2</span><span class="keyword">);<br />
&nbsp; </span><span class="default">$v3</span><span class="keyword">=(</span><span class="default">is_null</span><span class="keyword">(</span><span class="default">$v3</span><span class="keyword">)?</span><span class="string">'value3'</span><span class="keyword">:</span><span class="default">$v3</span><span class="keyword">);<br />
&nbsp; echo </span><span class="default">$v1</span><span class="keyword">;<br />
&nbsp; echo </span><span class="default">$v2</span><span class="keyword">;<br />
&nbsp; echo </span><span class="default">$v3</span><span class="keyword">;<br />
}<br />
</span><span class="comment">/* <br />
The default value whether null or an actual value is not so important in the parameter list, what is important is that you include it to allow a default behavior. The default value in the declaration becomes more important at this point:<br />
*/<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
...
&nbsp; echo </span><span class="string">"--$x--$y--$z--\n"</span><span class="keyword">;<br />
...
Sergio.</span>
 ...
 <a name="57141"></a>
 <div class="note">
  <strong class='user'>grinslives13 at hotmail dot com~=s/i/ee/g</strong>
  <a href="#57141" class="date">24-Sep-2005 10:55</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Given that we have two coding styles:<br />
<br />
#<br />
# Code (A)<br />
#<br />
funtion foo_a (&amp;$var)<br />
{<br />
&nbsp;&nbsp;&nbsp; $var *= 2;<br />
&nbsp;&nbsp;&nbsp; return $var;<br />
}<br />
...
foo_b(&amp;$a);<br />
<br />
I personally wouldn't recommend (B) - I think it strange why php would support such a convention as it would have violated foo_b's design - its use would not do justice to its function prototype. And thinking about such use, I might have to think about copying all variables instead of working directly on them... <br />
<br />
Coding that respects function prototypes strictly would, I believe, result in code that is more intuitive to read. Of course, in php &lt;=4, not being able to use default values with references, we can't do this that we can do in C:<br />
<br />
#<br />
# optional return-value parameters<br />
#<br />
int foo_c (int var, int *ret)<br />
{<br />
&nbsp;&nbsp;&nbsp; var *= 2;<br />
&nbsp;&nbsp;&nbsp; if (ret) *ret = var;<br />
&nbsp;&nbsp;&nbsp; return var;<br />
...
foo_c(2, NULL);<br />
<br />
Of course, since variables are "free" anyway, we can always get away with it by using dummy variables...<br />
<br />
zlel</span>
</code></div>
  </div>
...
&nbsp; </span><span class="keyword">return </span><span class="default">sprintf</span><span class="keyword">(</span><span class="string">"&lt;a href=%s?page=%s&amp;perpage=%s&gt;%s&lt;/a&gt;"</span><span class="keyword">, </span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">"PHP_SELF"</span><span class="keyword">], </span><span class="default">$page</span><span class="keyword">, </span><span class="default">$per_page</span><span class="keyword">, </span><span class="default">$text</span><span class="keyword">);<br />
 ...
 <div class="note">
  ...
  <a href="#55103" class="date">25-Jul-2005 12:40</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
...</span>
 ...
 <a name="54132"></a>
 <div class="note">
  <strong class='user'>benk at NOSPAM dot icarz dot com</strong>
  <a href="#54132" class="date">24-Jun-2005 07:21</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
$def = &amp;$abc;<br />
print("ABC = $abc\tDEF = $def\n");&nbsp; &nbsp; &nbsp; &nbsp; // ABC = Test&nbsp; &nbsp; &nbsp; DEF = Test<br />
$abc = "test2";<br />
print("ABC = $abc\tDEF = $def\n");&nbsp; &nbsp; &nbsp; &nbsp; // ABC = test2&nbsp; &nbsp;&nbsp; DEF = test2<br />
$def = "nextval";<br />
print("ABC = $abc\tDEF = $def\n");&nbsp; &nbsp; &nbsp; &nbsp; // ABC = nextval&nbsp;&nbsp; DEF = nextval<br />
unset($def);<br />
print("ABC = $abc\tDEF = $def\n");&nbsp; &nbsp; &nbsp; &nbsp; // ABC = nextval&nbsp;&nbsp; DEF =<br />
$def = "yet another value";<br />
print("ABC = $abc\tDEF = $def\n");&nbsp; &nbsp; &nbsp; &nbsp; // ABC = nextval&nbsp;&nbsp; DEF = yet another value</span>
</code></div>
  </div>
 </div>
 <a name="49389"></a>
 <div class="note">
  ...
  <a href="#49389" class="date">26-Jan-2005 04:58</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Argument evaluation left to right means that you can save yourself a temporary variable in the example below whereas $current = $prior + ($prior=$current) is just the same as $current *= 2;<br />
<br />
function Sum() { return array_sum(func_get_args()); }<br />
function Fib($n,$current=1,$prior=0) {<br />
&nbsp;&nbsp;&nbsp; for (;--$n;) $current = Sum($prior,$prior=$current);<br />
&nbsp;&nbsp;&nbsp; return $current;<br />
}<br />
<br />
Csaba Gabor<br />
PS.&nbsp; You could, of course, just use array_sum(array(...)) in place of Sum(...)</span>
</code></div>
  </div>
 </div>
 <a name="40967"></a>
 <div class="note">
  ...
  <a href="#40967" class="date">24-Mar-2004 05:49</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I have some functions that I'd like to be able to pass arguments two ways: Either as an argument list of variable length (e.g. func(1, 2, 3, 4)) or as an array (e.g., func(array(1,2,3,4)). Only the latter can be constructed on the fly (e.g., func($ar)), but the syntax of the former can be neater. <br />
<br />
The way to do it is to begin the function as follows:<br />
&nbsp; $args = func_get_args();<br />
&nbsp; if (is_array ($args[0]))<br />
&nbsp;&nbsp;&nbsp; $args = $args[0];<br />
Then one can just use $args as the list of arguments.</span>
</code></div>
  </div>
 </div>
 <a name="33559"></a>
...
Note that trying to pass a value of NULL will produce an error.</span>
 ...
 <div class="note">
  ...
  <a href="#32616" class="date">03-Jun-2003 02:06</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
A tiny clarification on the notes of "keeper at odi dot com dot br", et. al.<br />
<br />
Functions explicitly prototyped with formal parameters passed by reference can't have default values. However, functions prototyped to assign default values to formal parameters may be passed references.<br />
<br />
For example, this is a parse error:<br />
<br />
function foo(&amp;$bar = null) {<br />
&nbsp;&nbsp;&nbsp; // formal parameters as references can't have default values<br />
&nbsp;&nbsp;&nbsp; $bar = 242;<br />
}<br />
<br />
While this is perfectly legal (and probably what you want, mostly):<br />
<br />
function foo($bar = null) {<br />
&nbsp;&nbsp;&nbsp; $bar = 242;<br />
}<br />
<br />
foo();&nbsp; &nbsp; // valid call, no warnings about missing args<br />
foo(&amp;$x); // valid call, post $x == 242</span>
</code></div>
  </div>
 </div>
 <a name="30733"></a>
 <div class="note">
  <strong class='user'>mjohnston at planetactive dot com</strong>
  <a href="#30733" class="date">26-Mar-2003 07:14</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
not only do default values not work with passing by reference, but you can't pass NULL as a parameter that is expected to be a reference, and passing too few parameters to a function causes a warning.</span>
</code></div>
  </div>
 </div>
 <a name="27507"></a>
 <div class="note">
  <strong class='user'>bostjan dot skufca at domenca dot com</strong>
  <a href="#27507" class="date">09-Dec-2002 04:16</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
have function<br />
<br />
function foo($bar=3) {<br />
&nbsp; if (!isset($bar)) {<br />
&nbsp;&nbsp;&nbsp; echo "I'm not set to my default value";<br />
}<br />
<br />
and if you do<br />
<br />
foo($some_unset_variable);<br />
<br />
the $bar variable does not adopt default value (3) as one might expect but it is not set.</span>
</code></div>
  </div>
 </div>
 <a name="23498"></a>
...
Setting $defaultValue to null enables you to write functions with optional arguments which, if given, are to be modified.</span>
 ...
 <a name="21298"></a>
 <div class="note">
  <strong class='user'>t dot orf at gmx dot de</strong>
  <a href="#21298" class="date">07-May-2002 06:48</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
concerning rbronosky@mac.com 11-May-2001 06:17:<br />
You can include the variable name in the output if you simply pass that name instead of the value:<br />
<br />
function show($arrayName) {<br />
&nbsp; global $$arrayName;<br />
&nbsp; echo("&lt;pre&gt;\n$arrayName == ");<br />
...
than at function execution.</span>
 ...
 <a name="15897"></a>
 <div class="note">
  <strong class='user'>keeper at odi dot com dot br</strong>
  <a href="#15897" class="date">07-Oct-2001 04:20</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Whem arguments are passed by reference, default values won't work.</span>
</code></div>
  </div>
 </div>
 <a name="15313"></a>
 <div class="note">
  <strong class='user'>duncanmadcow at hotmail dot com</strong>
  <a href="#15313" class="date">05-Sep-2001 03:50</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I have tried the example given by ak@avatartech.com <br />
it did not work I use php 4.0.6 on windows 98<br />
<br />
I do think that it is good that there is no automatic parameter passing, thus it would force people to do good programming practie</span>
</code></div>
  </div>
 </div>
 <a name="13563"></a>
 <div class="note">
  <strong class='user'>rwillmann at nocomment dot sk</strong>
  <a href="#13563" class="date">21-Jun-2001 03:05</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
rwi</span>
 ...
 <a name="11565"></a>
 <div class="note">
  <strong class='user'>artiebob at go dot com</strong>
  <a href="#11565" class="date">25-Feb-2001 01:48</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
here is the code to pass a user defined function as an argument.&nbsp; Just like in the usort method.<br />
<br />
<span class="default">&lt;?php<br />
func2</span><span class="keyword">(</span><span class="string">"func1"</span><span class="keyword">);<br />
function </span><span class="default">func1 </span><span class="keyword">(</span><span class="default">$arg</span><span class="keyword">){<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; print (</span><span class="string">"Hello $arg"</span><span class="keyword">);&nbsp; &nbsp; &nbsp; &nbsp; <br />
}<br />
function </span><span class="default">func2 </span><span class="keyword">(</span><span class="default">$arg1</span><span class="keyword">){&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$arg1</span><span class="keyword">(</span><span class="string">"World"</span><span class="keyword">);&nbsp; </span><span class="comment">//Does the same thing as the next line<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">call_user_func </span><span class="keyword">(</span><span class="default">$arg1</span><span class="keyword">, </span><span class="string">"World"</span><span class="keyword">);<br />
}<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
 ...
 <a name="10884"></a>
 <div class="note">
  <strong class='user'>david at petshelter dot net</strong>
  <a href="#10884" class="date">24-Jan-2001 11:23</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
With reference to the note about extract() by dietricha@subpop.com:<br />
<br />
He is correct and this is great!&nbsp; What he does not say explicitly is that the extracted variable names have the scope of the function, not the global namespace.&nbsp; (This is the appropriate behavior IMO.)&nbsp; If for some reason you want the extracted variables to be visible in the global namespace, you must declare them 'global' inside the function.</span>
</code></div>
  </div>
 </div>
 <a name="10488"></a>
 <div class="note">
  <strong class='user'>marvinalone at gmx dot net</strong>
  <a href="#10488" class="date">06-Jan-2001 06:19</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">my_test </span><span class="keyword">(</span><span class="default">$var</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; if (isset (</span><span class="default">$var</span><span class="keyword">)) echo (</span><span class="string">"set"</span><span class="keyword">);<br />
}<br />
<br />
</span><span class="default">my_test </span><span class="keyword">(</span><span class="default">$unused</span><span class="keyword">);<br />
</span><span class="default">?&gt;<br />
</span><br />
This will _not_ echo "set", regardless of the variable being passed by value or by reference.<br />
<br />
(If my newlines are messed up, sorry, this seems to be a konqueror problem)</span>
</code></div>
  </div>
 </div>
 <a name="8983"></a>
 <div class="note">
  <strong class='user'>dietricha at subpop dot com</strong>
  <a href="#8983" class="date">10-Oct-2000 01:39</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
if you compiled with "--enable-track-vars" then an easy way to get variable function args is to use extract().<br />
<br />
<span class="default">&lt;?php<br />
$args </span><span class="keyword">= array(</span><span class="string">"color" </span><span class="keyword">= </span><span class="string">"blue"</span><span class="keyword">,</span><span class="string">"number" </span><span class="keyword">= </span><span class="default">3</span><span class="keyword">);<br />
<br />
function </span><span class="default">my_func</span><span class="keyword">(</span><span class="default">$args</span><span class="keyword">){<br />
</span><span class="default">extract</span><span class="keyword">(</span><span class="default">$args</span><span class="keyword">);<br />
echo </span><span class="default">$color</span><span class="keyword">;<br />
echo </span><span class="default">$number</span><span class="keyword">;<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
...
&nbsp;or <br />
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">my_func</span><span class="keyword">(</span><span class="default">$HTTP_POST_VARS</span><span class="keyword">){<br />
&nbsp;</span><span class="default">extract</span><span class="keyword">(</span><span class="default">$HTTP_POST_VARS</span><span class="keyword">); <br />
&nbsp;</span><span class="comment">// use all your vars by name! <br />
&nbsp; </span><span class="keyword">}<br />
 ...
 <a name="8978"></a>
 <div class="note">
  <strong class='user'>coop at better-mouse-trap dot com</strong>
  <a href="#8978" class="date">09-Oct-2000 08:59</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">foo</span><span class="keyword">(</span><span class="default">$args</span><span class="keyword">)<br />
{<br />
&nbsp;&nbsp;&nbsp; print </span><span class="string">"named_arg1 : " </span><span class="keyword">. </span><span class="default">$args</span><span class="keyword">[</span><span class="string">"named_arg1"</span><span class="keyword">] . </span><span class="string">"\n"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; print </span><span class="string">"named_arg2 : " </span><span class="keyword">. </span><span class="default">$args</span><span class="keyword">[</span><span class="string">"named_arg2"</span><span class="keyword">] . </span><span class="string">"\n"</span><span class="keyword">;<br />
}<br />
<br />
</span><span class="default">foo</span><span class="keyword">(array(</span><span class="string">"named_arg1" </span><span class="keyword">=&gt; </span><span class="string">"arg1_value"</span><span class="keyword">, </span><span class="string">"named_arg2" </span><span class="keyword">=&gt; </span><span class="string">"arg2_value"</span><span class="keyword">));<br />
</span><span class="default">?&gt;<br />
</span><br />
will output:<br />
named_arg1 : arg1_value<br />
named_arg2 : arg2_value</span>
</code></div>
  </div>
 </div>
 <a name="7925"></a>
 <div class="note">
  <strong class='user'>almasy at axisdata dot com</strong>
  <a href="#7925" class="date">20-Aug-2000 04:11</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Which is the new "assign by reference" syntax that was added in PHP4.</span>
</code></div>
  </div>
 </div>
 <a name="5239"></a>
 <div class="note">
  <a href="#5239" class="date">21-Apr-2000 02:45</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
This behavior is useful for setting default values for function arguments and for ensuring that a certain number of arguments get passed to a function.</span>
</code></div>
  </div>
 </div></div>

 <div class="foot"><a href="/manual/add-note.php?sect=functions.arguments&amp;redirect=http://www.php.net/manual/en/functions.arguments.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=functions.arguments&amp;redirect=http://www.php.net/manual/en/functions.arguments.php">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/functions.arguments.php">show source</a> |

...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="language.oop5.static.php" />
 <link rel="next" href="language.oop5.interfaces.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/oop5.abstract" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/language.oop5.abstract.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="@w{X7R9XFHY}" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.oop5.abstract.php">Class Abstraction</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.oop5.interfaces.php">Object Interfaces<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.oop5.static.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Static Keyword</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.oop5.abstract.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
 <div class="langchooser">
  <form action="/manual/change.php" method="get">
   <p>view this page in </p><fieldset><select name="page">
    ...
    <option value="pl/language.oop5.abstract.php">Polish</option>
    <option value="ro/language.oop5.abstract.php">Romanian</option>
    <option value="ru/language.oop5.abstract.php">Russian</option>
    <option value="fa/language.oop5.abstract.php">Persian</option>
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.oop5.abstract&amp;redirect=@w{X7R9XFHY}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.oop5.abstract&amp;redirect=@w{X7R9XFHY}">add a note</a></small></span>
  <small>User Contributed Notes</small>
  <strong>Class Abstraction</strong>
 </div><div id="allnotes">
 <a name="106676"></a>
 <div class="note">
  <strong class='user'>oliver at ananit dot de</strong>
  <a href="#106676" class="date">27-Nov-2011 08:07</a>
  <div class="text">
...
Oliver Anan</span>
 ...
 <a name="106140"></a>
 <div class="note">
  <strong class='user'>darkmantis at cybershade dot org</strong>
  <a href="#106140" class="date">13-Oct-2011 09:25</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
This may be irrelevant to you, but I just had an idea about ‘abstract’ classes and the ‘final’ keyword. If you declare a class as abstract and the constructor of that class as final, then the extending class will not work:<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">abstract class </span><span class="default">newClass</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; final public function </span><span class="default">__construct</span><span class="keyword">(){<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">'You failed xD'</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }&nbsp; &nbsp; <br />
}<br />
<br />
class </span><span class="default">MyClass </span><span class="keyword">extends </span><span class="default">newClass</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">__construct</span><span class="keyword">(){<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">'Will this work?'</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; public static function </span><span class="default">myFunc</span><span class="keyword">(){<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">'FooBar'</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="default">$init </span><span class="keyword">= new </span><span class="default">MyClass</span><span class="keyword">();<br />
</span><span class="default">$init</span><span class="keyword">::</span><span class="default">myFunc</span><span class="keyword">();<br />
</span><span class="default">?&gt;<br />
</span><br />
And that will return :<br />
Fatal error: Cannot override final method newClass::__construct() in C:\wamp\Projects\BMPortal\public_html\newPHPClass.php on line 16</span>
</code></div>
  </div>
 </div>
 <a name="104210"></a>
 <div class="note">
  ...
  <a href="#104210" class="date">31-May-2011 07:27</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <a name="103752"></a>
 <div class="note">
  <strong class='user'>Adrian N</strong>
  <a href="#103752" class="date">02-May-2011 04:10</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
By their nature, although sometimes they may look quite similar, abstract classes and class interfaces serve very distinct purposes. <br />
<br />
The interface of a class is meant as a tool for the "user" of that class. An interface is a public presentation for the class, and it should advertise, to anyone considering to use it, what methods and constants are available and accessible from the outside. So, as it name suggests, it always sits between the user and the class implementing it.<br />
<br />
On the other hand, an abstract class is a tool aimed at helping the "implementor" of the classes that extend it. It is an infrastructure that can impose restrictions and guidelines about what the concrete classes should look like. From a class design perspective, abstract classes are more architecturally important than interfaces. In this case, the implementor sits between the abstract class and the concrete one, building the latter on top of the former.</span>
</code></div>
  </div>
 </div>
 <a name="103118"></a>
 <div class="note">
  ...
  <a href="#103118" class="date">26-Mar-2011 03:57</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Alexios Tsiaparas</span>
 ...
 <div class="note">
  ...
  <a href="#101572" class="date">26-Dec-2010 06:29</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Please be aware of the visibility of the parent fields. If the fields are private, then you are not going to see those fields in their childrens. Its basic OOP, but can be problematic sometimes.</span>
 ...
 <div class="note">
  ...
  <a href="#99117" class="date">28-Jul-2010 10:36</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#95404" class="date">31-Dec-2009 11:59</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Now just think about a Database class where MySQL and PostgreSQL extend it. Also, a note. An abstract class is just like an interface, but you can define methods in an abstract class whereas in an interface they are all abstract.</span>
 ...
 <div class="note">
  ...
  <a href="#94655" class="date">16-Nov-2009 10:55</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
echo </span><span class="default">$classtwo</span><span class="keyword">-&gt;</span><span class="default">changestaticone</span><span class="keyword">();</span>
 ...
 <div class="note">
  ...
  <a href="#94034" class="date">13-Oct-2009 02:49</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
So you need to take care that incompatibilities don't arise due to not returning the right kind of value and this is not enforced in any way.</span>
 ...
 <div class="note">
  ...
  <a href="#93687" class="date">22-Sep-2009 04:13</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
And reading a decent OOP book.</span>
 ...
 <div class="note">
  ...
  <a href="#92637" class="date">01-Aug-2009 12:04</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp; </span><span class="comment">// Properties for Person objects.<br />
</span><span class="keyword">}<br />
<br />
interface </span><span class="default">IStudent </span><span class="keyword">{<br />
&nbsp; </span><span class="comment">// ...<br />
</span><span class="keyword">}<br />
<br />
interface </span><span class="default">IEmployee </span><span class="keyword">{<br />
&nbsp; </span><span class="comment">// ...<br />
</span><span class="keyword">}<br />
<br />
class </span><span class="default">Student </span><span class="keyword">implements </span><span class="default">IStudent </span><span class="keyword">extends </span><span class="default">Person </span><span class="keyword">{<br />
&nbsp; </span><span class="comment">// ...<br />
</span><span class="keyword">}<br />
<br />
class </span><span class="default">StudentEmployee </span><span class="keyword">implements </span><span class="default">IStudent</span><span class="keyword">, </span><span class="default">IEmployee </span><span class="keyword">extends </span><span class="default">Person </span><span class="keyword">{<br />
&nbsp; </span><span class="comment">// ...<br />
</span><span class="keyword">}<br />
</span><span class="default">?&gt;</span>
</span>
 ...
 <div class="note">
  ...
  <a href="#83582" class="date">02-Jun-2008 09:04</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
OUTPUT:Writing Sbody's info to emloyee dbase table</span>
 ...
 <a name="83153"></a>
 <div class="note">
  <strong class='user'>keithjfrank at gmail dot com</strong>
  <a href="#83153" class="date">13-May-2008 01:19</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
While building my database class, I came across something I didn't see any documentation on...<br />
<br />
abstract class db<br />
{<br />
&nbsp;&nbsp;&nbsp; abstract protected function prepareSelect();<br />
}<br />
<br />
class dbPlugin extends db<br />
{<br />
&nbsp;&nbsp;&nbsp; /**<br />
&nbsp;&nbsp; &nbsp; *&nbsp; &nbsp; Prepare Select<br />
&nbsp;&nbsp; &nbsp; *&nbsp; &nbsp; Populates $this-&gt;currentQuery with MySQL formatted SELECT query.<br />
&nbsp;&nbsp; &nbsp; *<br />
&nbsp;&nbsp; &nbsp; *&nbsp; &nbsp; @param&nbsp; &nbsp; string&nbsp; &nbsp; Fields to retrieve<br />
&nbsp;&nbsp; &nbsp; *&nbsp; &nbsp; @param&nbsp; &nbsp; string&nbsp; &nbsp; Table from which fields will be selected<br />
&nbsp;&nbsp; &nbsp; *&nbsp; &nbsp; @param&nbsp; &nbsp; string&nbsp; &nbsp; Optional WHERE restriction<br />
&nbsp;&nbsp;&nbsp; **/<br />
&nbsp;&nbsp;&nbsp; protected function prepareSelect( $fields, $table, $where = NULL )<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; $this-&gt;currentQuery .= "SELECT {$fields} FROM {$this-&gt;dbSettings['sqlPrefix']}{$table}";<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; if ( $where !== NULL )<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; $this-&gt;currentQuery .= " WHERE {$where}";<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; }<br />
<br />
}<br />
<br />
While executing the script I was greeted with: Fatal error:&nbsp; Declaration of dbPlugin::prepareSelect() must be compatible with that of db::prepareSelect() in [...]\includes\plugins\dbMySQL.php on line 209<br />
<br />
The fix? Adding the same expected variables to the parent abstract method.<br />
<br />
abstract class db<br />
{<br />
&nbsp;&nbsp;&nbsp; abstract protected function prepareSelect( $fields, $table, $where );<br />
}<br />
<br />
I am unsure as to whether this is common knowledge or not, but I figured I would share to ease someone else's frustration while figuring out what was going awry. :)</span>
</code></div>
  </div>
 </div>
 <a name="82111"></a>
 <div class="note">
  ...
  <a href="#82111" class="date">27-Mar-2008 01:56</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
These concepts, while easy to confuse, are specifically different and distinct. For all intents and purposes, if you're the only user of any of your classes, you don't need to implement interfaces.</span>
 ...
 <div class="note">
  ...
  <a href="#78388" class="date">09-Oct-2007 05:05</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
An abstract class that extends an abstract class can pass the buck to its child classes when it comes to implementing the abstract methods of its parent abstract class.</span>
 ...
 <a name="76577"></a>
 <div class="note">
  <strong class='user'>eamon at gizzle dot co dot uk Eamon Straughn</strong>
  <a href="#76577" class="date">20-Jul-2007 04:20</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Sometimes I wonder. PHP needs to be pushed to its limits and below everyone fails to understand what an interface is and what abstraction is. So let me make it extremely clear as I have many languages under my belt.<br />
<br />
Interfaces are in general WYSIWYG implementations of logic which in PHP are not accessible like in other languages like Java \ ASP.NET where you don't have to access the class itself...however in future I hope PHP does give us this functionality. Interfaces in PHP only define public functions without any basic or core functionality therefore making it lesser a friend to PROs from OOP &amp;&amp; OOD backgrounds.<br />
<br />
Instead Abstraction in PHP is perfered as this allows your objects a core with the ability to define different levels of access to methods | variables | constants. Although publicly allowing access to variables (to me) | (to official \ senior programmers) defeats the whole idea of OO. Abstraction allows the keywords of final which is very important to me as I can have many child objects of objects and of child objects.<br />
<br />
Thus knowing the difference helps with your choosen style but if your really looking to make an application with Abstraction I would always suggest using an Abstract Class instead of Interfaces as Interfaces are limited and provides no functionality and is a waste of bytes on your hard drive.<br />
<br />
The below is an example of Abstraction used in an automated system.<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">Abstract Class </span><span class="default">events<br />
</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; protected </span><span class="default">$priority</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; protected </span><span class="default">$message</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; protected </span><span class="default">$environment</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; protected </span><span class="default">$syslog</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; protected </span><span class="default">$config</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; protected </span><span class="default">$global</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; protected </span><span class="default">$classes</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; protected </span><span class="default">$super</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp; public function </span><span class="default">__construct</span><span class="keyword">(array &amp;</span><span class="default">$config</span><span class="keyword">)<br />
&nbsp;&nbsp;&nbsp; {<br />
...
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; abstract protected function </span><span class="default">writeToDatabase</span><span class="keyword">(</span><span class="default">Environment </span><span class="keyword">&amp;</span><span class="default">$environment</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; abstract protected function </span><span class="default">writeToSystem</span><span class="keyword">(</span><span class="default">Environment </span><span class="keyword">&amp;</span><span class="default">$environment</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; abstract protected function </span><span class="default">writeToEmail</span><span class="keyword">(</span><span class="default">Environment </span><span class="keyword">&amp;</span><span class="default">$environment</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; abstract protected function </span><span class="default">writeToMobile</span><span class="keyword">(</span><span class="default">Environment </span><span class="keyword">&amp;</span><span class="default">$environment</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; abstract public function </span><span class="default">execute</span><span class="keyword">(&amp;</span><span class="default">$class</span><span class="keyword">, </span><span class="default">$method</span><span class="keyword">, </span><span class="default">$args</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; protected function </span><span class="default">environment</span><span class="keyword">(</span><span class="default">Exception </span><span class="keyword">&amp;</span><span class="default">$object</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">super </span><span class="keyword">=&amp; new </span><span class="default">Environment</span><span class="keyword">(</span><span class="default">$object</span><span class="keyword">, </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">config</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">global </span><span class="keyword">= </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">super</span><span class="keyword">-&gt;</span><span class="default">env</span><span class="keyword">();<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">global </span><span class="keyword">= </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">global</span><span class="keyword">[</span><span class="string">'environment'</span><span class="keyword">];<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">super</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
...
&nbsp; }<br />
 ...
 <a name="75990"></a>
 <div class="note">
  <strong class='user'>pierre at pamdata dot com</strong>
  <a href="#75990" class="date">25-Jun-2007 06:25</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I love examples.<br />
This example will let you see that an Interface and an Astract Class are two different entities.<br />
<br />
Just go and read the Object Interface section at :<br />
<a href="@w{VQ9ZFBSA}" rel="nofollow" target="_blank">@w{VQ9ZFBSA}</a><br />
<br />
and look at this example<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="comment">/*<br />
* A Very simple example to understand why we should use ABSRACT CLASSES.<br />
* This abstract class contains&nbsp; 2 methods : 1 abstract and 1 common methods.<br />
*<br />
*/<br />
</span><span class="keyword">abstract class </span><span class="default">Shape<br />
</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment"># Let's assume a shape will always have a base and a height<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">protected&nbsp; </span><span class="default">$base</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; protected </span><span class="default">$height</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">#This function can be the same for both classes&nbsp; 'Triangle' and 'Rectangle'<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">getValue</span><span class="keyword">(</span><span class="default">$base</span><span class="keyword">,</span><span class="default">$height</span><span class="keyword">)<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">base </span><span class="keyword">= </span><span class="default">$base</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">height </span><span class="keyword">= </span><span class="default">$height</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; </span><span class="comment"># This might be different for each class of shape, because each Surface is calculated by a different formula ( St = b*h/2&nbsp; and&nbsp; Sr = b*h)<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">abstract public function </span><span class="default">surface</span><span class="keyword">();<br />
}<br />
<br />
class </span><span class="default">Triangle </span><span class="keyword">extends </span><span class="default">Shape <br />
</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment"># s = b*h/2<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">surface</span><span class="keyword">(){<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">round</span><span class="keyword">(((</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">base</span><span class="keyword">)*(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">height</span><span class="keyword">)/</span><span class="default">2</span><span class="keyword">),</span><span class="default">2</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
class </span><span class="default">Rectangle </span><span class="keyword">extends </span><span class="default">Shape <br />
</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment"># s = b*h<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">surface</span><span class="keyword">(){<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">round</span><span class="keyword">(((</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">base</span><span class="keyword">)*(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">height</span><span class="keyword">)),</span><span class="default">2</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="default">$r </span><span class="keyword">= new </span><span class="default">Rectangle</span><span class="keyword">();<br />
</span><span class="default">$r</span><span class="keyword">-&gt;</span><span class="default">getValue</span><span class="keyword">(</span><span class="default">15</span><span class="keyword">,</span><span class="default">3</span><span class="keyword">);<br />
echo </span><span class="default">$r</span><span class="keyword">-&gt;</span><span class="default">surface</span><span class="keyword">() .</span><span class="string">"\n"</span><span class="keyword">;&nbsp;&nbsp; </span><span class="comment"># echo 45<br />
<br />
</span><span class="default">$t </span><span class="keyword">= new </span><span class="default">Triangle</span><span class="keyword">();<br />
</span><span class="default">$t</span><span class="keyword">-&gt;</span><span class="default">getValue</span><span class="keyword">(</span><span class="default">15</span><span class="keyword">,</span><span class="default">3</span><span class="keyword">);<br />
echo </span><span class="default">$t</span><span class="keyword">-&gt;</span><span class="default">surface</span><span class="keyword">() .</span><span class="string">"\n"</span><span class="keyword">;&nbsp;&nbsp; </span><span class="comment"># echo 22.5<br />
<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
 ...
 <div class="note">
  ...
  <a href="#75961" class="date">24-Jun-2007 04:09</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
So, an Object Interface is really a built-in part of an Abstract Class.</span>
 ...
 <a name="68396"></a>
 <div class="note">
  <strong class='user'>david at mr-t dot nl</strong>
  <a href="#68396" class="date">25-Jul-2006 08:27</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
It took me a while to figure this out and i couldn't find it easily in the documentation anywhere.<br />
<br />
If you want to override a method from a base class and want to call the base class in the method, then you have to use the parent::function() syntax, even though the method isn't static. There is no $base variable in php that i know of.<br />
<br />
Expamle:<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">public abstract class </span><span class="default">BasePerson</span><span class="keyword">() {<br />
&nbsp; </span><span class="comment">/*<br />
&nbsp;&nbsp; * alot of code..<br />
&nbsp;&nbsp; */<br />
&nbsp; </span><span class="keyword">public function </span><span class="default">getName</span><span class="keyword">() {<br />
&nbsp;&nbsp;&nbsp; return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">name</span><span class="keyword">;<br />
&nbsp; }<br />
}<br />
<br />
public class </span><span class="default">Person</span><span class="keyword">() extends </span><span class="default">BasePerson </span><span class="keyword">{<br />
&nbsp; </span><span class="comment">/*<br />
&nbsp;&nbsp; * alot of code..<br />
&nbsp;&nbsp; */<br />
&nbsp; // override of base getName()..<br />
&nbsp; </span><span class="keyword">public function </span><span class="default">getName</span><span class="keyword">() {<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// you would expect $base-&gt;getName() instead of parrent::getName()...<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">return </span><span class="default">htmlspecialchars</span><span class="keyword">(</span><span class="default">parent</span><span class="keyword">::</span><span class="default">getName</span><span class="keyword">());<br />
&nbsp; }<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
Hope this helps!</span>
 ...
 <a name="60179"></a>
 <div class="note">
  <strong class='user'>rasto_klc (at) yahoo (dot) obvious</strong>
  <a href="#60179" class="date">28-Dec-2005 01:27</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Variable-length argument lists in abstract methods will generate fatal error if derived. Here is an simple example:<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="comment">// common wrap for all validators is forcing uniform interface<br />
</span><span class="keyword">abstract class </span><span class="default">ValidatorWrap </span><span class="keyword">{<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// just example why variable-length arguments are needed<br />
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">call_user_func_array</span><span class="keyword">(array(&amp;</span><span class="default">$this</span><span class="keyword">, </span><span class="string">'setupValidator'</span><span class="keyword">), </span><span class="default">$arg_list</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; } else {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">setupValidator</span><span class="keyword">();<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment">// continue with construction<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">}<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// amount of arguments is specific to validator implementation<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">abstract public function </span><span class="default">setupValidator</span><span class="keyword">();<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// known interface<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">abstract public function </span><span class="default">validate</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">);<br />
}<br />
<br />
class </span><span class="default">Validator1 </span><span class="keyword">extends </span><span class="default">ValidatorWrap </span><span class="keyword">{<br />
<br />
&nbsp;&nbsp;&nbsp; protected </span><span class="default">$pattern </span><span class="keyword">= </span><span class="string">''</span><span class="keyword">;<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// this will generate PHP Fatal error because $pattern is not expected<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">setupValidator</span><span class="keyword">(</span><span class="default">$pattern</span><span class="keyword">)<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">pattern </span><span class="keyword">= </span><span class="default">$pattern</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// this will do OK<br />
...
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">preg_match</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">pattern</span><span class="keyword">, </span><span class="default">$value</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="comment">// make numeric validator<br />
</span><span class="default">$validator </span><span class="keyword">= new </span><span class="default">Validator1</span><span class="keyword">(</span><span class="string">'/^\d+$/'</span><span class="keyword">);<br />
echo (int) </span><span class="default">$validator</span><span class="keyword">-&gt;</span><span class="default">validate</span><span class="keyword">(</span><span class="default">$_REQUEST</span><span class="keyword">[</span><span class="string">'digits'</span><span class="keyword">]);<br />
</span><span class="default">?&gt;<br />
</span><br />
I need it to work so I just redefine troublemaking function as follows:<br />
<br />
<span class="default">&lt;?php<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">setupValidator</span><span class="keyword">() { }<br />
</span><span class="default">?&gt;<br />
</span><br />
This will give me functionality I need and generates only PHP Strict Standards warning.</span>
</code></div>
  </div>
 </div>
 <a name="59310"></a>
 <div class="note">
  ...
  <a href="#59310" class="date">02-Dec-2005 09:38</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
<span class="default">&lt;?php<br />
<br />
</span><span class="comment">// Design Pattern ABSTRACT FACTORY&nbsp; implementation //<br />
<br />
</span><span class="keyword">abstract class </span><span class="default">AbstractFactory </span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; public abstract function </span><span class="default">CreateProductA</span><span class="keyword">();&nbsp; </span><span class="comment">// return data type is AbstractProductA<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public abstract function </span><span class="default">CreateProductB</span><span class="keyword">();&nbsp; </span><span class="comment">// return data type is AbstractProductB<br />
</span><span class="keyword">}<br />
<br />
</span><span class="comment">// Abstract factory #1 //<br />
</span><span class="keyword">class </span><span class="default">ConcreteFactory1 </span><span class="keyword">extends </span><span class="default">AbstractFactory </span><span class="keyword">{<br />
<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">CreateProductA</span><span class="keyword">() { </span><span class="comment">// return data type is AbstractProductA<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">return new </span><span class="default">ProductA1</span><span class="keyword">();<br />
&nbsp;&nbsp;&nbsp; }<br />
<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">CreateProductB</span><span class="keyword">() { </span><span class="comment">// return data type is AbstractProductB<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">return new </span><span class="default">ProductB1</span><span class="keyword">();<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="comment">// Abstract factory #2 //<br />
</span><span class="keyword">class </span><span class="default">ConcreteFactory2 </span><span class="keyword">extends </span><span class="default">AbstractFactory </span><span class="keyword">{<br />
<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">CreateProductA</span><span class="keyword">() { </span><span class="comment">// return data type is AbstractProductA //<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">return new </span><span class="default">ProductA2</span><span class="keyword">();<br />
&nbsp;&nbsp;&nbsp; }<br />
<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">CreateProductB</span><span class="keyword">() { </span><span class="comment">// return data type is AbstractProductB //<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">return new </span><span class="default">ProductB2</span><span class="keyword">();<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="comment">// "AbstractProductA" //<br />
</span><span class="keyword">abstract class </span><span class="default">AbstractProductA </span><span class="keyword">{<br />
}<br />
<br />
</span><span class="comment">// "AbstractProductB" //<br />
</span><span class="keyword">abstract class </span><span class="default">AbstractProductB </span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; public abstract function </span><span class="default">Interact</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">); </span><span class="comment">// return type is void // // input type is&nbsp; AbstractProductA<br />
</span><span class="keyword">}<br />
<br />
</span><span class="comment">// "ProductA1" //<br />
</span><span class="keyword">class </span><span class="default">ProductA1 </span><span class="keyword">extends&nbsp; </span><span class="default">AbstractProductA </span><span class="keyword">{<br />
}<br />
<br />
</span><span class="comment">// "ProductB1" //<br />
</span><span class="keyword">class </span><span class="default">ProductB1 </span><span class="keyword">extends&nbsp; </span><span class="default">AbstractProductB </span><span class="keyword">{<br />
<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">Interact</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="default">__CLASS__</span><span class="keyword">.</span><span class="string">" interacts with "</span><span class="keyword">.</span><span class="default">__METHOD__</span><span class="keyword">.</span><span class="string">"\n"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="comment">// "ProductA2"<br />
</span><span class="keyword">class </span><span class="default">ProductA2 </span><span class="keyword">extends </span><span class="default">AbstractProductA </span><span class="keyword">{<br />
}<br />
<br />
</span><span class="comment">// "ProductB2"<br />
</span><span class="keyword">class </span><span class="default">ProductB2 </span><span class="keyword">extends </span><span class="default">AbstractProductB </span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">Interact</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="default">__CLASS__</span><span class="keyword">.</span><span class="string">" interacts with "</span><span class="keyword">.</span><span class="default">__METHOD__</span><span class="keyword">.</span><span class="string">"\n"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
...
<br />
class </span><span class="default">Client </span><span class="keyword">{<br />
<br />
&nbsp;&nbsp;&nbsp; private&nbsp; </span><span class="default">$AbstractProductA</span><span class="keyword">;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span><span class="comment">// type AbstractProductA;<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">private&nbsp; </span><span class="default">$AbstractProductB</span><span class="keyword">;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span><span class="comment">// type AbstractProductB;<br />
<br />
&nbsp;&nbsp;&nbsp; // Constructor<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">__construct</span><span class="keyword">(</span><span class="default">$factory</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">AbstractProductB </span><span class="keyword">= </span><span class="default">$factory</span><span class="keyword">-&gt;</span><span class="default">CreateProductB</span><span class="keyword">();<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">AbstractProductA </span><span class="keyword">= </span><span class="default">$factory</span><span class="keyword">-&gt;</span><span class="default">CreateProductA</span><span class="keyword">();<br />
&nbsp;&nbsp;&nbsp; }<br />
<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">Run</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">AbstractProductB</span><span class="keyword">-&gt;</span><span class="default">Interact</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">AbstractProductA</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="comment">// Abstract factory #1<br />
</span><span class="default">$factory1 </span><span class="keyword">= new </span><span class="default">ConcreteFactory1</span><span class="keyword">();<br />
</span><span class="default">$c1 </span><span class="keyword">= new </span><span class="default">Client</span><span class="keyword">(</span><span class="default">$factory1</span><span class="keyword">);<br />
</span><span class="default">$c1</span><span class="keyword">-&gt;</span><span class="default">Run</span><span class="keyword">();<br />
<br />
</span><span class="comment">// Abstract factory #2<br />
</span><span class="default">$factory2 </span><span class="keyword">= new </span><span class="default">ConcreteFactory2</span><span class="keyword">();<br />
</span><span class="default">$c2 </span><span class="keyword">= new </span><span class="default">Client</span><span class="keyword">(</span><span class="default">$factory2</span><span class="keyword">);<br />
</span><span class="default">$c2</span><span class="keyword">-&gt;</span><span class="default">Run</span><span class="keyword">();<br />
<br />
</span><span class="comment">// TURGUT Z. YESILYURT, MS<br />
...
<br />
ProductB1 interacts with ProductB1::Interact<br />
object(ProductA1)#4 (0) {<br />
}<br />
ProductB2 interacts with ProductB2::Interact<br />
object(ProductA2)#8 (0) {<br />
}</span>
</code></div>
  </div>
 </div></div>

 <div class="foot"><a href="/manual/add-note.php?sect=language.oop5.abstract&amp;redirect=@w{X7R9XFHY}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.oop5.abstract&amp;redirect=@w{X7R9XFHY}">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.oop5.abstract.php">show source</a> |

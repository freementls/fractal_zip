...
<head profile="@w{B8XXCD23}">
 <title>PHP: Type Juggling - Manual</title>
 ...
 <link rel="prev" href="language.pseudo-types.php" />
 <link rel="next" href="language.variables.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/types.type-juggling" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/language.types.type-juggling.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="@w{HWAFTHV9}" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.types.type-juggling.php">Type Juggling</a></li>
</ul><!--/UdmComment-->
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.variables.php">Variables<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.pseudo-types.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Pseudo-types and variables used in this documentation</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.types.type-juggling.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
 <div class="langchooser">
  <form action="/manual/change.php" method="get">
   <p>view this page in </p><fieldset><select name="page">
    <option value="pt_BR/language.types.type-juggling.php">Brazilian Portuguese</option>
    ...
    <option value="pl/language.types.type-juggling.php">Polish</option>
    ...
    <option value="fa/language.types.type-juggling.php">Persian</option>
...
<div id="language.types.type-juggling" class="sect1">
 ...
 <p class="simpara">
  ...
  variable is used. That is to say, if a <span class="type"><a href="language.types.string.php" class="type string">string</a></span> value is assigned
  to variable <var class="varname"><var class="varname">$var</var></var>, <var class="varname"><var class="varname">$var</var></var> becomes a
  <span class="type"><a href="language.types.string.php" class="type string">string</a></span>. If an <span class="type"><a href="language.types.integer.php" class="type integer">integer</a></span> value is then assigned to
  <var class="varname"><var class="varname">$var</var></var>, it becomes an <span class="type"><a href="language.types.integer.php" class="type integer">integer</a></span>.
 </p>

 <p class="para">
  An example of PHP&#039;s automatic type conversion is the addition operator &#039;+&#039;.
  If either operand is a <span class="type"><a href="language.types.float.php" class="type float">float</a></span>, then both operands are evaluated as
  <span class="type"><a href="language.types.float.php" class="type float">float</a></span>s, and the result will be a <span class="type"><a href="language.types.float.php" class="type float">float</a></span>. Otherwise,
  the operands will be interpreted as <span class="type"><a href="language.types.integer.php" class="type integer">integer</a></span>s, and the result will
  also be an <span class="type"><a href="language.types.integer.php" class="type integer">integer</a></span>. Note that this does <em class="emphasis">not</em>
...
<span style="color: #0000BB">&lt;?php<br />$foo&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #DD0000">"0"</span><span style="color: #007700">;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;$foo&nbsp;is&nbsp;string&nbsp;(ASCII&nbsp;48)<br /></span><span style="color: #0000BB">$foo&nbsp;</span><span style="color: #007700">+=&nbsp;</span><span style="color: #0000BB">2</span><span style="color: #007700">;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;$foo&nbsp;is&nbsp;now&nbsp;an&nbsp;integer&nbsp;(2)<br /></span><span style="color: #0000BB">$foo&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">$foo&nbsp;</span><span style="color: #007700">+&nbsp;</span><span style="color: #0000BB">1.3</span><span style="color: #007700">;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;$foo&nbsp;is&nbsp;now&nbsp;a&nbsp;float&nbsp;(3.3)<br /></span><span style="color: #0000BB">$foo&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">5&nbsp;</span><span style="color: #007700">+&nbsp;</span><span style="color: #DD0000">"10&nbsp;Little&nbsp;Piggies"</span><span style="color: #007700">;&nbsp;</span><span style="color: #FF8000">//&nbsp;$foo&nbsp;is&nbsp;integer&nbsp;(15)<br /></span><span style="color: #0000BB">$foo&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">5&nbsp;</span><span style="color: #007700">+&nbsp;</span><span style="color: #DD0000">"10&nbsp;Small&nbsp;Pigs"</span><span style="color: #007700">;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;$foo&nbsp;is&nbsp;integer&nbsp;(15)<br /></span><span style="color: #0000BB">?&gt;</span>
 ...
 <blockquote class="note"><p><strong class="note">Note</strong>: 
  <p class="para">
   The behaviour of an automatic conversion to <span class="type"><a href="language.types.array.php" class="type array">array</a></span> is currently
   undefined.
  </p>

  <p class="para">
   Also, because PHP supports indexing into <span class="type"><a href="language.types.string.php" class="type string">string</a></span>s via offsets
...
<span style="color: #0000BB">&lt;?php<br />$foo&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">10</span><span style="color: #007700">;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;$foo&nbsp;is&nbsp;an&nbsp;integer<br /></span><span style="color: #0000BB">$bar&nbsp;</span><span style="color: #007700">=&nbsp;(boolean)&nbsp;</span><span style="color: #0000BB">$foo</span><span style="color: #007700">;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;$bar&nbsp;is&nbsp;a&nbsp;boolean<br /></span><span style="color: #0000BB">?&gt;</span>
  ...
  <ul class="itemizedlist">
   <li class="listitem">
    <span class="simpara">(int), (integer) - cast to <span class="type"><a href="language.types.integer.php" class="type integer">integer</a></span></span>
   </li>
   <li class="listitem">
    <span class="simpara">(bool), (boolean) - cast to <span class="type"><a href="language.types.boolean.php" class="type boolean">boolean</a></span></span>
   </li>
   <li class="listitem">
    <span class="simpara">(float), (double), (real) - cast to <span class="type"><a href="language.types.float.php" class="type float">float</a></span></span>
   </li>
   <li class="listitem">
    <span class="simpara">(string) - cast to <span class="type"><a href="language.types.string.php" class="type string">string</a></span></span>
   </li>
   
   <li class="listitem">
    <span class="simpara">(array) - cast to <span class="type"><a href="language.types.array.php" class="type array">array</a></span></span>
   </li>
   <li class="listitem">
    <span class="simpara">(object) - cast to <span class="type"><a href="language.types.object.php" class="type object">object</a></span></span>
   </li>
   <li class="listitem">
    <span class="simpara">(unset) - cast to <span class="type"><a href="language.types.null.php" class="type NULL">NULL</a></span> (PHP 5)</span>
   </li>
  </ul>
...
<span style="color: #0000BB">&lt;?php<br />$foo&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #0000BB">10</span><span style="color: #007700">;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;$foo&nbsp;is&nbsp;an&nbsp;integer<br /></span><span style="color: #0000BB">$str&nbsp;</span><span style="color: #007700">=&nbsp;</span><span style="color: #DD0000">"</span><span style="color: #0000BB">$foo</span><span style="color: #DD0000">"</span><span style="color: #007700">;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #FF8000">//&nbsp;$str&nbsp;is&nbsp;a&nbsp;string<br /></span><span style="color: #0000BB">$fst&nbsp;</span><span style="color: #007700">=&nbsp;(string)&nbsp;</span><span style="color: #0000BB">$foo</span><span style="color: #007700">;&nbsp;</span><span style="color: #FF8000">//&nbsp;$fst&nbsp;is&nbsp;also&nbsp;a&nbsp;string<br /><br />//&nbsp;This&nbsp;prints&nbsp;out&nbsp;that&nbsp;"they&nbsp;are&nbsp;the&nbsp;same"<br /></span><span style="color: #007700">if&nbsp;(</span><span style="color: #0000BB">$fst&nbsp;</span><span style="color: #007700">===&nbsp;</span><span style="color: #0000BB">$str</span><span style="color: #007700">)&nbsp;{<br />&nbsp;&nbsp;&nbsp;&nbsp;echo&nbsp;</span><span style="color: #DD0000">"they&nbsp;are&nbsp;the&nbsp;same"</span><span style="color: #007700">;<br />}<br /></span><span style="color: #0000BB">?&gt;</span>
  ...
  <ul class="itemizedlist">
   <li class="listitem">
    <span class="simpara">
     <a href="language.types.boolean.php#language.types.boolean.casting" class="link">Converting to boolean</a>
    </span>
   </li>
   <li class="listitem">
    <span class="simpara">
   ...
   <li class="listitem">
    <span class="simpara">
     <a href="language.types.float.php#language.types.float.casting" class="link">Converting to float</a>
    </span>
   </li>
   <li class="listitem">
    <span class="simpara">
     <a href="language.types.string.php#language.types.string.casting" class="link">Converting to string</a>
    </span>
   </li>
   <li class="listitem">
    <span class="simpara">
     <a href="language.types.array.php#language.types.array.casting" class="link">Converting to array</a>
    </span>
   </li>
   <li class="listitem">
    <span class="simpara">
     <a href="language.types.object.php#language.types.object.casting" class="link">Converting to object</a>
    </span>
   </li>
   <li class="listitem">
    <span class="simpara">
     <a href="language.types.resource.php#language.types.resource.casting" class="link">Converting to
     resource</a>
    </span>
   </li>
   <li class="listitem">
    <span class="simpara">
     <a href="language.types.null.php#language.types.null.casting" class="link">Converting to NULL</a>
    </span>
   </li>
   <li class="listitem">
    <span class="simpara">
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.types.type-juggling&amp;redirect=@w{HWAFTHV9}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.types.type-juggling&amp;redirect=@w{HWAFTHV9}">add a note</a></small></span>
...
</span><span class="default">$str </span><span class="keyword">= </span><span class="string">"{$foo['ten']}"</span><span class="keyword">;&nbsp; </span><span class="comment">// works "10"<br />
</span><span class="default">$str </span><span class="keyword">= </span><span class="string">"$foo[ten]"</span><span class="keyword">;&nbsp; &nbsp; &nbsp; </span><span class="comment">// DO NOT work!</span>
</span>
</code></div>
  </div>
 </div>
...
$foo</span><span class="keyword">[</span><span class="string">'ten'</span><span class="keyword">] = </span><span class="default">10</span><span class="keyword">;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span><span class="comment">// $foo['ten'] is an array holding an integer at key "ten"<br />
</span><span class="default">$str </span><span class="keyword">= </span><span class="string">"$foo['ten']"</span><span class="keyword">;&nbsp; &nbsp; &nbsp; &nbsp; </span><span class="comment">// throws T_ENCAPSED_AND_WHITESPACE error<br />
</span><span class="default">$str </span><span class="keyword">= </span><span class="string">"$foo[ten]"</span><span class="keyword">;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span><span class="comment">// works because constants are skipped in quotes<br />
 ...
 <a name="89916"></a>
 <div class="note">
  <strong class='user'>radek at pinkbike dot com</strong>
  <a href="#89916" class="date">28-Mar-2009 11:40</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
$a</span><span class="keyword">=</span><span class="default">3</span><span class="keyword">;<br />
</span><span class="default">$b</span><span class="keyword">=</span><span class="string">'3d'</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
if (</span><span class="default">$a</span><span class="keyword">==</span><span class="default">$b</span><span class="keyword">) {<br />
&nbsp; echo </span><span class="string">"a is b"</span><span class="keyword">;<br />
} else {<br />
&nbsp; echo </span><span class="string">"a is not b"</span><span class="keyword">;<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
Result:&nbsp; a is b <br />
This can cause some issues if you don't expect it</span>
</code></div>
  </div>
 </div>
 <a name="89637"></a>
...
+-------+-------+---------+--------+</span>
 ...
 <div class="note">
  ...
  <a href="#86806" class="date">04-Nov-2008 09:22</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
The behavior of comparisons between objects of different types is, in fact, already documented (though a cross-reference from this page might be handy for future readers):<br />
<br />
<a href="@w{6KY7YK6Z}" rel="nofollow" target="_blank">@w{6KY7YK6Z}</a></span>
</code></div>
  </div>
 </div>
 <a name="86419"></a>
...
</span>I have &lt;?=$bar?&gt; bar.<br />
<span class="default">&lt;?php<br />
$bar</span><span class="keyword">++;<br />
</span><span class="default">?&gt;<br />
</span>I now have &lt;?=$bar?&gt; bar.<br />
<span class="default">&lt;?php<br />
...
</span>I finally have &lt;?=$bar?&gt; bar.<br />
&lt;/body&gt;<br />
&lt;/html&gt;<br />
<br />
That will print<br />
...
echo FALSE; //prints nothing!</span>
 ...
 <div class="foot"><a href="/manual/add-note.php?sect=language.types.type-juggling&amp;redirect=@w{HWAFTHV9}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.types.type-juggling&amp;redirect=@w{HWAFTHV9}">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.types.type-juggling.php">show source</a> |

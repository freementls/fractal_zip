...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="language.operators.bitwise.php" />
 <link rel="next" href="language.operators.errorcontrol.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/operators.comparison" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/language.operators.comparison.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="@w{6KY7YK6Z}" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.operators.comparison.php">Comparison Operators</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.operators.errorcontrol.php">Error Control Operators<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.operators.bitwise.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Bitwise Operators</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.operators.comparison.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
 <div class="langchooser">
  <form action="/manual/change.php" method="get">
   <p>view this page in </p><fieldset><select name="page">
    ...
    <option value="pl/language.operators.comparison.php">Polish</option>
    ...
    <option value="fa/language.operators.comparison.php">Persian</option>
...
<span style="color: #0000BB">&lt;?php<br />var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">0&nbsp;</span><span style="color: #007700">==&nbsp;</span><span style="color: #DD0000">"a"</span><span style="color: #007700">);&nbsp;</span><span style="color: #FF8000">//&nbsp;0&nbsp;==&nbsp;0&nbsp;-&gt;&nbsp;true<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #DD0000">"1"&nbsp;</span><span style="color: #007700">==&nbsp;</span><span style="color: #DD0000">"01"</span><span style="color: #007700">);&nbsp;</span><span style="color: #FF8000">//&nbsp;1&nbsp;==&nbsp;1&nbsp;-&gt;&nbsp;true<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #DD0000">"10"&nbsp;</span><span style="color: #007700">==&nbsp;</span><span style="color: #DD0000">"1e1"</span><span style="color: #007700">);&nbsp;</span><span style="color: #FF8000">//&nbsp;10&nbsp;==&nbsp;10&nbsp;-&gt;&nbsp;true<br /></span><span style="color: #0000BB">var_dump</span><span style="color: #007700">(</span><span style="color: #0000BB">100&nbsp;</span><span style="color: #007700">==&nbsp;</span><span style="color: #DD0000">"1e2"</span><span style="color: #007700">);&nbsp;</span><span style="color: #FF8000">//&nbsp;100&nbsp;==&nbsp;100&nbsp;-&gt;&nbsp;true<br /><br /></span><span style="color: #007700">switch&nbsp;(</span><span style="color: #DD0000">"a"</span><span style="color: #007700">)&nbsp;{<br />case&nbsp;</span><span style="color: #0000BB">0</span><span style="color: #007700">:<br />&nbsp;&nbsp;&nbsp;&nbsp;echo&nbsp;</span><span style="color: #DD0000">"0"</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;break;<br />case&nbsp;</span><span style="color: #DD0000">"a"</span><span style="color: #007700">:&nbsp;</span><span style="color: #FF8000">//&nbsp;never&nbsp;reached&nbsp;because&nbsp;"a"&nbsp;is&nbsp;already&nbsp;matched&nbsp;with&nbsp;0<br />&nbsp;&nbsp;&nbsp;&nbsp;</span><span style="color: #007700">echo&nbsp;</span><span style="color: #DD0000">"a"</span><span style="color: #007700">;<br />&nbsp;&nbsp;&nbsp;&nbsp;break;<br />}<br /></span><span style="color: #0000BB">?&gt;</span>
    ...
    <caption><strong>Comparison with Various Types</strong></caption>
     ...
     <tbody class="tbody">
      ...
      <tr>
       ...
       <td>anything</td>
       <td>Convert to <span class="type"><a href="language.types.boolean.php" class="type bool">bool</a></span>, <strong><code>FALSE</code></strong> &lt; <strong><code>TRUE</code></strong></td>
      </tr>
   ...
   <p class="para">
    <div class="example" id="example-118">
     <p><strong>Example #1 Transcription of standard array comparison</strong></p>
     <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000">
   ...
   <div class="sect2" id="language.operators.comparison.ternary">
    ...
    <p class="para">
     ...
     <div class="example" id="example-119">
      <p><strong>Example #2 Assigning a default value</strong></p>
      <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000">
    ...
    <blockquote class="note"><p><strong class="note">Note</strong>: 
     <p class="para">
      ...
      <div class="example" id="example-120">
       <p><strong>Example #3 Non-obvious Ternary Behaviour</strong></p>
       <div class="example-contents">
<div class="phpcode"><code><span style="color: #000000">
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.operators.comparison&amp;redirect=@w{6KY7YK6Z}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.operators.comparison&amp;redirect=@w{6KY7YK6Z}">add a note</a></small></span>
 ...
 <div class="note">
  ...
  <a href="#109373" class="date">11-Jul-2012 01:56</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
it looks that<br />
<br />
if you check 0 against a string with == then PHP returns true:<br />
<br />
php -r 'var_dump(0 == "statuses");'<br />
-&gt; returns TRUE<br />
<br />
but not if your string has a number at the beginning:<br />
<br />
php -r 'var_dump(0 == "2statuses");'<br />
-&gt; returns FALSE<br />
<br />
from the specs I get it that it attempts a conversion - in this case the string to number.<br />
<br />
so better use ===<br />
as always :)</span>
</code></div>
 ...
 <div class="note">
  ...
  <a href="#108690" class="date">17-May-2012 09:20</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
COMPARING PHP OBJECTS (compound type)<br />
<br />
We have seen that PHP does a lot of type-juggling on its own -- which can wreak havoc in unexpected ways -- but it is still up to us to produce code that is clear, maintainable AND follows the rules we want to follow.<br />
<br />
When creating a PHP Object, it is sometimes unclear what makes two of them the same. But the good part is that we can say what is equal and what is not equal. For example, let's say we have a Student class that includes an equals() method which defines what is equal for this type of object.<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="comment">#Student.php<br />
<br />
</span><span class="keyword">class </span><span class="default">Student<br />
</span><span class="keyword">{<br />
&nbsp; </span><span class="comment">/*<br />
&nbsp;&nbsp; * These variables are protected to prevent outside code<br />
&nbsp;&nbsp; * from tampering with them.<br />
&nbsp;&nbsp; */<br />
&nbsp; </span><span class="keyword">protected </span><span class="default">$student_id</span><span class="keyword">;<br />
&nbsp; protected </span><span class="default">$student_name</span><span class="keyword">;<br />
<br />
&nbsp; public function </span><span class="default">__construct</span><span class="keyword">(</span><span class="default">$id</span><span class="keyword">, </span><span class="default">$name</span><span class="keyword">)<br />
&nbsp; {<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">student_id </span><span class="keyword">= (int)</span><span class="default">$id</span><span class="keyword">;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span><span class="comment">// cast to integer here<br />
...
<br />
&nbsp; </span><span class="comment">/*<br />
&nbsp;&nbsp; * This function requires an instance of type Student and<br />
&nbsp;&nbsp; * only evaluates two integers that we set in __construct().<br />
&nbsp;&nbsp; */<br />
&nbsp; </span><span class="keyword">public function </span><span class="default">equals</span><span class="keyword">(</span><span class="default">Student $student</span><span class="keyword">)<br />
&nbsp; {<br />
&nbsp;&nbsp;&nbsp; return (</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">getId</span><span class="keyword">() == </span><span class="default">$student</span><span class="keyword">-&gt;</span><span class="default">getId</span><span class="keyword">());<br />
&nbsp; }<br />
<br />
&nbsp; public function </span><span class="default">getId</span><span class="keyword">()<br />
&nbsp; {<br />
&nbsp;&nbsp;&nbsp; return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">student_id</span><span class="keyword">;<br />
&nbsp; }<br />
<br />
&nbsp; public function </span><span class="default">getName</span><span class="keyword">()<br />
&nbsp; {<br />
&nbsp;&nbsp;&nbsp; return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">student_name</span><span class="keyword">;<br />
&nbsp; }<br />
<br />
&nbsp; public function </span><span class="default">__toString</span><span class="keyword">()<br />
&nbsp; {<br />
&nbsp;&nbsp;&nbsp; return </span><span class="string">'Student [id=' </span><span class="keyword">. </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">getId</span><span class="keyword">() .<br />
&nbsp;&nbsp;&nbsp; </span><span class="string">', name=' </span><span class="keyword">. </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">getName</span><span class="keyword">() . </span><span class="string">']'</span><span class="keyword">;<br />
&nbsp; }<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
With this class, the protected variables cannot be tampered with by outside code. Also, the __construct() function casts the variables to the PHP primitives WE WANT, while the equals(Student $student) function, requires an argument of type Student -- which eliminates the need for an IDENTITY '===' check AND prevents any other data types from coming in. One other note: notice how the equals() function only evaluates the $student_id, this allows for two students to have the same name -- which is totally possible.<br />
<br />
Here's a short example -- we'll do it correctly AND try to screw it up!<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">require(</span><span class="string">'Student.php'</span><span class="keyword">);<br />
<br />
</span><span class="default">$s1 </span><span class="keyword">= new </span><span class="default">Student</span><span class="keyword">(</span><span class="default">122</span><span class="keyword">, </span><span class="string">'John Doe'</span><span class="keyword">);<br />
</span><span class="default">$s2 </span><span class="keyword">= new </span><span class="default">Student</span><span class="keyword">(</span><span class="default">344</span><span class="keyword">, </span><span class="string">'John Doe'</span><span class="keyword">);<br />
<br />
echo </span><span class="default">$s1 </span><span class="keyword">. </span><span class="string">'&lt;br&gt;'</span><span class="keyword">;&nbsp; </span><span class="comment">// Student [id=122, name=John Doe]<br />
</span><span class="keyword">echo </span><span class="default">$s2 </span><span class="keyword">. </span><span class="string">'&lt;br&gt;'</span><span class="keyword">;&nbsp; </span><span class="comment">// Student [id=344, name=John Doe]<br />
<br />
# Check for equality the CORRECT way...<br />
</span><span class="keyword">echo (</span><span class="default">$s1</span><span class="keyword">-&gt;</span><span class="default">equals</span><span class="keyword">(</span><span class="default">$s2</span><span class="keyword">) ? </span><span class="string">'EQUAL' </span><span class="keyword">: </span><span class="string">'NOT EQUAL'</span><span class="keyword">);&nbsp; </span><span class="comment">// NOT EQUAL<br />
<br />
# Check for equality by HACKING the known value of $student_id...<br />
</span><span class="keyword">echo (</span><span class="default">$s1</span><span class="keyword">-&gt;</span><span class="default">equals</span><span class="keyword">(</span><span class="default">122</span><span class="keyword">) ? </span><span class="string">'EQUAL' </span><span class="keyword">: </span><span class="string">'NOT EQUAL'</span><span class="keyword">);&nbsp; </span><span class="comment">// Catchable fatal error: Argument 1 passed to Student::equals() must be an instance of Student, integer given... etc, etc.<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
See what I mean by writing code that follows OUR RULES? The Student class does the kind of type-juggling we want (and when we want it done) -- NOT when, where, or why PHP does it (not that there's anything wrong with it).</span>
</code></div>
  </div>
 </div>
 <a name="108104"></a>
 <div class="note">
  ...
  <a href="#108104" class="date">28-Mar-2012 08:06</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Beware of the consequences of comparing strings to numbers.&nbsp; You can disprove the laws of the universe.<br />
<br />
echo ('X' == 0 &amp;&amp; 'X' == true &amp;&amp; 0 == false) ? 'true == false' : 'sanity prevails';<br />
<br />
This will output 'true == false'.&nbsp; This stems from the use of the UNIX function strtod() to convert strings to numbers before comparing.&nbsp; Since 'X' or any other string without a number in it converts to 0 when compared to a number, 0 == 0 &amp;&amp; 'X' == true &amp;&amp; 0 == false</span>
</code></div>
  </div>
 </div>
 <a name="106983"></a>
...
i was getting lazy with my types since php vars are so flexible, so be warned to pay attention to the details...</span>
 ...
 <div class="foot"><a href="/manual/add-note.php?sect=language.operators.comparison&amp;redirect=@w{6KY7YK6Z}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.operators.comparison&amp;redirect=@w{6KY7YK6Z}">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.operators.comparison.php">show source</a> |

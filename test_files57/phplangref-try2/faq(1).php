...
<head profile="@w{B8XXCD23}">
 ...
 <base href="http://www.php.net/manual/en/faq.php" />
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="faq.general.php">General Information<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="internals2.ze1.tsrm.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />TSRM API</a>
 </span>
 <hr />
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=faq&amp;redirect=http://www.php.net/manual/en/faq.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=faq&amp;redirect=http://www.php.net/manual/en/faq.php">add a note</a></small></span>

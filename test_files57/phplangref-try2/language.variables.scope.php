...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="language.variables.predefined.php" />
 <link rel="next" href="language.variables.variable.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/variables.scope" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/language.variables.scope.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="@w{T2B349EQ}" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.variables.scope.php">Variable scope</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.variables.variable.php">Variable variables<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.variables.predefined.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Predefined Variables</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.variables.scope.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.variables.scope&amp;redirect=@w{T2B349EQ}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.variables.scope&amp;redirect=@w{T2B349EQ}">add a note</a></small></span>
 ...
 <div class="note">
  ...
  <a href="#109479" class="date">20-Jul-2012 02:16</a>
  <div class="text">
...
37</span>
 ...
 <div class="note">
  ...
  <a href="#109310" class="date">04-Jul-2012 11:54</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
&nbsp;&nbsp;&nbsp; print </span><span class="string">"$o static: {$o::$i}\n$p static: {$p::$i}"</span><span class="keyword">;<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
Output will be:<br />
...
$p static: changed</span>
 ...
 <div class="note">
  ...
  <a href="#107282" class="date">27-Jan-2012 06:23</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">foo</span><span class="keyword">(){<br />
&nbsp;&nbsp;&nbsp; static </span><span class="default">$int </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span><span class="comment">// correct <br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">static </span><span class="default">$int </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">+</span><span class="default">2</span><span class="keyword">;&nbsp; &nbsp; &nbsp; &nbsp; </span><span class="comment">// wrong&nbsp; (as it is an expression)<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">static </span><span class="default">$int </span><span class="keyword">= </span><span class="default">sqrt</span><span class="keyword">(</span><span class="default">121</span><span class="keyword">);&nbsp; </span><span class="comment">// wrong&nbsp; (as it is an expression too)<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$int</span><span class="keyword">++;<br />
&nbsp;&nbsp;&nbsp; echo </span><span class="default">$int</span><span class="keyword">;<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
Please update this example it is not completely correct, it can be confusing.<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">foo</span><span class="keyword">(){<br />
&nbsp;&nbsp;&nbsp; static </span><span class="default">$int </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span><span class="comment">// correct <br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">static </span><span class="default">$int </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">+</span><span class="default">2</span><span class="keyword">;&nbsp; &nbsp; &nbsp; &nbsp; </span><span class="comment">// wrong&nbsp; (as it is an NON-CONSTANT expression)<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">static </span><span class="default">$int </span><span class="keyword">= </span><span class="default">sqrt</span><span class="keyword">(</span><span class="default">121</span><span class="keyword">);&nbsp; </span><span class="comment">// wrong&nbsp; (as it is an NON-CONSTANT expression too)<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$int</span><span class="keyword">++;<br />
&nbsp;&nbsp;&nbsp; echo </span><span class="default">$int</span><span class="keyword">;<br />
}<br />
...
Expressions can be assigned to static variables, they just have to be constants, nothing dynamic, no calculations etc</span>
</code></div>
  </div>
 </div>
 <a name="106178"></a>
 <div class="note">
  ...
  <a href="#106178" class="date">17-Oct-2011 02:04</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; if (</span><span class="default">$name</span><span class="keyword">) </span><span class="default">$template </span><span class="keyword">= </span><span class="string">"templates/{$name}.html"</span><span class="keyword">;<br />
...
Would print 4.</span>
 ...
 <a name="105851"></a>
 <div class="note">
  <strong class='user'>dr_dazzit at yahoo dot co dot uk</strong>
  <a href="#105851" class="date">20-Sep-2011 02:33</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<span class="default">&lt;?php<br />
</span><span class="keyword">function &amp;</span><span class="default">teleport</span><span class="keyword">(</span><span class="default">$vars </span><span class="keyword">= </span><span class="default">null</span><span class="keyword">){<br />
&nbsp; static </span><span class="default">$toSave </span><span class="keyword">= array();<br />
&nbsp; if(</span><span class="default">$vars</span><span class="keyword">){<br />
&nbsp;&nbsp;&nbsp; foreach(</span><span class="default">$vars </span><span class="keyword">as </span><span class="default">$k</span><span class="keyword">=&gt;&amp;</span><span class="default">$v</span><span class="keyword">)<br />
&nbsp;&nbsp; &nbsp;&nbsp; </span><span class="default">$toSave</span><span class="keyword">[</span><span class="default">$k</span><span class="keyword">] = </span><span class="default">$v</span><span class="keyword">;<br />
&nbsp; }<br />
&nbsp; return(</span><span class="default">$toSave</span><span class="keyword">);<br />
}<br />
<br />
function </span><span class="default">myFuncA</span><span class="keyword">(){<br />
&nbsp; </span><span class="default">extract</span><span class="keyword">(</span><span class="default">teleport</span><span class="keyword">(),</span><span class="default">EXTR_REFS</span><span class="keyword">);<br />
&nbsp; </span><span class="default">$a </span><span class="keyword">= array(</span><span class="string">'a'</span><span class="keyword">=&gt;</span><span class="default">1</span><span class="keyword">,</span><span class="string">'b'</span><span class="keyword">=&gt;</span><span class="default">2</span><span class="keyword">);<br />
&nbsp; </span><span class="default">$b </span><span class="keyword">= </span><span class="string">"An arbitrary value of no consequence\n"</span><span class="keyword">;<br />
&nbsp; </span><span class="default">teleport</span><span class="keyword">(array(</span><span class="string">'a'</span><span class="keyword">=&gt;</span><span class="default">$a</span><span class="keyword">,</span><span class="string">'b'</span><span class="keyword">=&gt;</span><span class="default">$b</span><span class="keyword">));<br />
}<br />
function </span><span class="default">myFuncB</span><span class="keyword">(){<br />
&nbsp; </span><span class="default">extract</span><span class="keyword">(</span><span class="default">teleport</span><span class="keyword">(),</span><span class="default">EXTR_REFS</span><span class="keyword">);<br />
&nbsp; </span><span class="default">$b </span><span class="keyword">= </span><span class="string">"Now this is of Consequence\n"</span><span class="keyword">;<br />
&nbsp; </span><span class="default">$c </span><span class="keyword">= </span><span class="string">"Another of Consequence\n"</span><span class="keyword">;<br />
&nbsp; </span><span class="default">teleport</span><span class="keyword">(array(</span><span class="string">'c'</span><span class="keyword">=&gt;</span><span class="default">$c</span><span class="keyword">));<br />
}<br />
function </span><span class="default">myFuncC</span><span class="keyword">(){<br />
&nbsp; </span><span class="default">extract</span><span class="keyword">(</span><span class="default">teleport</span><span class="keyword">(),</span><span class="default">EXTR_REFS</span><span class="keyword">);<br />
&nbsp; </span><span class="comment">// $a,$b,$c are now in current scope<br />
&nbsp; </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">get_defined_vars</span><span class="keyword">());<br />
...
&nbsp; echo(</span><span class="default">$c</span><span class="keyword">);<br />
}<br />
<br />
</span><span class="default">myFuncA</span><span class="keyword">();<br />
</span><span class="default">myFuncB</span><span class="keyword">();<br />
<br />
</span><span class="default">myFuncC</span><span class="keyword">();<br />
</span><span class="default">?&gt;<br />
</span><br />
Purists might shout something about "USE A CLASS" etc...<br />
Maybe but sometimes you might not want to or need to.</span>
</code></div>
  </div>
 </div>
 <a name="103541"></a>
 <div class="note">
  <strong class='user'>pyc</strong>
  <a href="#103541" class="date">19-Apr-2011 04:57</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
My experience is that global keyword must be used both in function and outside</span>
</code></div>
  </div>
 </div>
 <a name="101699"></a>
 <div class="note">
  ...
  <a href="#101699" class="date">05-Jan-2011 03:39</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
This happens on one of my machines, on which I installed Zend AMF a few months before my most recent machine. The globals worked fine when calling the PHP script directly from a browser, but when I called the function from my Flash project, which uses Zend AMF to interface with the PHP script, I was seeing this problem, but it was fixed using this approach.</span>
 ...
 <div class="note">
  ...
  <a href="#100884" class="date">12-Nov-2010 10:37</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">print </span><span class="string">"Global scope FILENAME [$filename]\n"</span><span class="keyword">;<br />
...
&nbsp;&nbsp;&nbsp; print </span><span class="string">"Method scope global FILENAME [$filename]\n"</span><span class="keyword">;<br />
...
print </span><span class="string">"Global scope FILENAME [$filename]\n"</span><span class="keyword">;<br />
class </span><span class="default">MyTestClass </span><span class="keyword">extends </span><span class="default">PHPUnit_Framework_TestCase </span><span class="keyword">{<br />
&nbsp; function </span><span class="default">testMyTest</span><span class="keyword">() {<br />
&nbsp;&nbsp;&nbsp; global </span><span class="default">$filename</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; print </span><span class="string">"Method scope global FILENAME [$filename]\n"</span><span class="keyword">;<br />
...
I don't know what it is that PHPUnit does (I know it uses Reflection) that causes a globally available variable to be implicitly unavailable via "global" or $GLOBALS. But there it is.</span>
 ...
 <div class="note">
  ...
  <a href="#100312" class="date">07-Oct-2010 06:02</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
There're times when global variables comes in handy, like universal read only resources you just need to create once in your application and share to the rest of your scripts. But it may become quite hard to track with "variables".</span>
 ...
 <a name="100076"></a>
 <div class="note">
  <strong class='user'>carlos dot garciadm at gmail dot com</strong>
  <a href="#100076" class="date">23-Sep-2010 09:06</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
If you will work with a lot of global variables, using extract($GLOBALS) has some problems if you will modify the global variables inside a function:<br />
<br />
Example:<br />
<span class="default">&lt;?php<br />
<br />
...
print </span><span class="default">$a</span><span class="keyword">; </span><span class="comment">// will print "1" instead of "5"<br />
</span><span class="default">?&gt;<br />
</span><br />
The problem here is that when doing extract you are only getting the values of all globals in that moment, if you modify a variable, only the local variable will be modified. So you will need to use global $a .<br />
<br />
This is what I did in a script using a lot of global variables, please note that this is the case of 20 or 30 variables. Using global would be a real pain, and I didn't want to use objects.<br />
<br />
<span class="default">&lt;?php<br />
<br />
$a </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">;<br />
<br />
function </span><span class="default">globals</span><span class="keyword">(){<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$vars </span><span class="keyword">= array();<br />
&nbsp;&nbsp;&nbsp; foreach(</span><span class="default">$GLOBALS </span><span class="keyword">as </span><span class="default">$k </span><span class="keyword">=&gt; </span><span class="default">$v</span><span class="keyword">){<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$vars</span><span class="keyword">[] = </span><span class="string">"$"</span><span class="keyword">.</span><span class="default">$k</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; return </span><span class="string">"global "</span><span class="keyword">.&nbsp; </span><span class="default">join</span><span class="keyword">(</span><span class="string">","</span><span class="keyword">, </span><span class="default">$vars</span><span class="keyword">).</span><span class="string">";"</span><span class="keyword">;<br />
}<br />
function </span><span class="default">foo</span><span class="keyword">(){<br />
&nbsp;&nbsp; eval(</span><span class="default">globals</span><span class="keyword">()); </span><span class="comment">// just insert this line at the beggining of each function<br />
&nbsp;&nbsp; </span><span class="default">$a </span><span class="keyword">= </span><span class="default">5</span><span class="keyword">;<br />
}<br />
<br />
</span><span class="default">foo</span><span class="keyword">();<br />
print </span><span class="default">$a</span><span class="keyword">; </span><span class="comment">// will print "5"<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
Carlos Dubus</span>
 ...
 <div class="note">
  <strong class='user'>Anonymous</strong>
  <a href="#99166" class="date">31-Jul-2010 04:48</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
You can use the global function to use variables in classes when included. This means you can have a file such as "MainSettings.php" (Similar to MediaWiki's localsettings) with DB info, etc.<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">require(</span><span class="string">"MainSettings.php"</span><span class="keyword">);<br />
<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; global </span><span class="default">$testVariable</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">$testVariable</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
...
<br />
<span class="default">&lt;?php<br />
$testVariable </span><span class="keyword">= </span><span class="string">"This works!"</span><span class="keyword">;<br />
</span><span class="default">?&gt;<br />
</span><br />
Without the global you would get a E_NOTICE saying that $testVariable is undefined.</span>
</code></div>
  </div>
 </div>
 <a name="99074"></a>
 <div class="note">
  ...
  <a href="#99074" class="date">26-Jul-2010 06:34</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Droope</span>
 ...
 <div class="note">
  ...
  <a href="#98811" class="date">09-Jul-2010 12:26</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;echo </span><span class="string">" -- "</span><span class="keyword">.</span><span class="default">$a</span><span class="keyword">.</span><span class="string">"&lt;br&gt;"</span><span class="keyword">;<br />
 ...
 <div class="note">
  ...
  <a href="#92868" class="date">12-Aug-2009 08:06</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#92166" class="date">12-Jul-2009 07:39</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
function </span><span class="default">b</span><span class="keyword">(){<br />
 ...
 <div class="note">
  ...
  <a href="#91982" class="date">03-Jul-2009 07:32</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#89872" class="date">26-Mar-2009 10:31</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; </span><span class="keyword">if (</span><span class="default">$exists</span><span class="keyword">==</span><span class="default">true</span><span class="keyword">) { include(</span><span class="string">"$file"</span><span class="keyword">); }<br />
...
Pretty simple approach that I could not find anywhere online; only other approach I could find was using PHP's eval().</span>
 ...
 <div class="note">
  ...
  <a href="#88570" class="date">29-Jan-2009 07:17</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
echo </span><span class="string">"original $var\n"</span><span class="keyword">;<br />
</span><span class="default">?&gt;<br />
</span><br />
...
[EDIT BY danbrown AT php DOT net:&nbsp; Merged all thoughts and notes by this author into a single note.]</span>
 ...
 <div class="note">
  ...
  <a href="#85203" class="date">19-Aug-2008 08:15</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#83490" class="date">28-May-2008 06:41</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Useful function:<br />
<span class="default">&lt;?php<br />
...
<br />
 ...
 <div class="note">
  ...
  <a href="#81563" class="date">04-Mar-2008 02:06</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
It might be worth noting in the article that you shouldn't define magic values at global level and use "global" to access them in a function - like I did in the past few years.<br />
<br />
Use define() instead.</span>
</code></div>
  </div>
 </div>
 <a name="81506"></a>
 <div class="note">
  <strong class='user'>Anonymous</strong>
  <a href="#81506" class="date">01-Mar-2008 11:10</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#78778" class="date">27-Oct-2007 02:46</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
<span class="default">&lt;?php<br />
</span><span class="comment">/*<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"$count"</span><span class="keyword">;<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"&lt;br&gt;\n"</span><span class="keyword">. </span><span class="string">"Total $num_count numbers are printed.&lt;br&gt;"</span><span class="keyword">;<br />
<br />
...
print </span><span class="string">"So far $count function call(s) made.&lt;br&gt;&lt;br&gt;"</span><span class="keyword">;<br />
<br />
</span><span class="default">print_1to50</span><span class="keyword">();<br />
</span><span class="default">$count</span><span class="keyword">=</span><span class="default">$count</span><span class="keyword">+</span><span class="default">1</span><span class="keyword">;<br />
print </span><span class="string">"So far $count function call(s) made.&lt;br&gt;"</span><span class="keyword">;<br />
</span><span class="comment">/*<br />
...
<br />
 ...
 <div class="note">
  ...
  <a href="#73890" class="date">14-Mar-2007 11:03</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
#step 2: NULL</span>
 ...
 <div class="note">
  ...
  <a href="#69611" class="date">12-Sep-2006 10:53</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
The advantage to using the keyword is if you have a long list of variables&nbsp; needed by the function - you dont have to pass them every time you call the function.</span>
 ...
 <div class="note">
  ...
  <a href="#68304" class="date">21-Jul-2006 09:18</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
$b = "something";</span>
 ...
 <div class="note">
  ...
  <a href="#61756" class="date">10-Feb-2006 04:25</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
</span><span class="default">$table </span><span class="keyword">= </span><span class="string">"{$GLOBALS["siteParams"]["siteName"]}articles"</span><span class="keyword">; </span><span class="comment">// OK<br />
</span><span class="keyword">echo </span><span class="default">$table</span><span class="keyword">; </span><span class="comment">// output&nbsp; "mywebarticles"<br />
</span><span class="default">$table </span><span class="keyword">= </span><span class="string">"$GLOBALS[siteParams][siteName]articles"</span><span class="keyword">;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment">// Not OK<br />
...
</span><span class="default">$result </span><span class="keyword">= </span><span class="default">mysql_query</span><span class="keyword">(</span><span class="string">"UPDATE $table ..."</span><span class="keyword">);<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
Or use global :<br />
...
global </span><span class="default">$siteParams</span><span class="keyword">;<br />
</span><span class="default">$table </span><span class="keyword">= </span><span class="string">"$siteParams[siteName]articles"</span><span class="keyword">;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment">// OK<br />
</span><span class="keyword">echo </span><span class="default">$table</span><span class="keyword">; </span><span class="comment">// output&nbsp; "mywebarticles"<br />
 ...
 <div class="note">
  ...
  <a href="#60231" class="date">30-Dec-2005 09:07</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
I believe that all normal-thinking people would never even try to make this work with the static-keyword, for those who try (like me), this note maybe helpfull.</span>
 ...
 <div class="note">
  ...
  <a href="#56749" class="date">14-Sep-2005 03:06</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
echo </span><span class="string">"outer: $a\n"</span><span class="keyword">;<br />
function </span><span class="default">testa</span><span class="keyword">()<br />
{<br />
&nbsp;&nbsp;&nbsp; global </span><span class="default">$a</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; echo </span><span class="string">"&nbsp;&nbsp; inner testa: $a\n"</span><span class="keyword">;<br />
...
{<br />
&nbsp;&nbsp;&nbsp; global </span><span class="default">$a</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; echo </span><span class="string">"&nbsp;&nbsp; inner testb: $a\n"</span><span class="keyword">;<br />
...
Thomas Candrian</span>
 ...
 <div class="note">
  ...
  <a href="#55595" class="date">08-Aug-2005 08:02</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
2</span>
 ...
 <div class="note">
  ...
  <a href="#52343" class="date">28-Apr-2005 05:36</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp; </span><span class="comment">// here you have all global variables<br />
 ...
 <a name="52294"></a>
 <div class="note">
  <a href="#52294" class="date">27-Apr-2005 04:46</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
least the behaviour.</span>
 ...
 <div class="note">
  ...
  <a href="#52148" class="date">22-Apr-2005 02:51</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; echo </span><span class="string">"Hello $who"</span><span class="keyword">;<br />
&nbsp; }<br />
}<br />
<br />
...
<br />
&nbsp; </span><span class="comment">// won't work<br />
&nbsp; </span><span class="keyword">echo </span><span class="string">"Hello $who"</span><span class="keyword">;<br />
<br />
&nbsp; </span><span class="comment">// will work<br />
...
&nbsp; echo </span><span class="string">"Hello $who"</span><span class="keyword">;<br />
 ...
 <div class="note">
  ...
  <a href="#45487" class="date">08-Sep-2004 06:02</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#45282" class="date">31-Aug-2004 05:35</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
As you can see, class A and B are using different static variables even though the same function was being used.</span>
 ...
 <div class="note">
  ...
  <a href="#41213" class="date">02-Apr-2004 12:53</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Using such a pattern allows you to separate the code that creates your default static variable value from the function that uses it. Easier to maintain code is good. :)</span>
 ...
 <div class="note">
  ...
  <a href="#39091" class="date">16-Jan-2004 03:34</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Every call to the function Test() is a differenct SCOPE and therefore the static declarations and initializations are NOT executed again. So what Im trying to say is that its OK to declare and initialize a static variable multiple times if you are in one function... but its NOT OK to declare and initialize a static variable multiple times if you call that same function multiple times. In other words the static variable is set once you LEAVE a function (even if you go back into that very same function).</span>
 ...
 <div class="note">
  ...
  <a href="#37427" class="date">14-Nov-2003 10:11</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#37183" class="date">06-Nov-2003 12:26</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; </span><span class="keyword">echo </span><span class="string">"x: $key , y: $val"</span><span class="keyword">;<br />
&nbsp;&nbsp; }<br />
}<br />
</span><span class="default">?&gt;<br />
 ...
 <div class="note">
  ...
  <a href="#33832" class="date">08-Jul-2003 06:59</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Not: aaa / bbb</span>
 ...
 <div class="note">
  ...
  <a href="#29273" class="date">07-Feb-2003 04:10</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; }<br />
 ...
 <div class="note">
  ...
  <a href="#27546" class="date">10-Dec-2002 09:03</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"$Element &lt;hr/&gt;"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp; }<br />
<br />
...
<br />
 ...
 <div class="note">
  ...
  <a href="#26015" class="date">15-Oct-2002 05:12</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; &nbsp; echo </span><span class="string">"$key,"</span><span class="keyword">;<br />
&nbsp;}<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
 ...
 <a name="21140"></a>
 <div class="note">
  <a href="#21140" class="date">30-Apr-2002 01:14</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; echo (</span><span class="string">"$cookieName is set"</span><span class="keyword">);<br />
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">setcookie</span><span class="keyword">(</span><span class="string">"$cookieName"</span><span class="keyword">,</span><span class="string">"$newCookieValue"</span><span class="keyword">, (</span><span class="default">time</span><span class="keyword">() + </span><span class="default">3153600</span><span class="keyword">));<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo (</span><span class="string">"the cookie that was set is now $returnvalue &lt;BR&gt;"</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">$returnvalue</span><span class="keyword">;<br />
 ...
 <div class="note">
  ...
  <a href="#20407" class="date">02-Apr-2002 08:11</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
If you don't include the if ($first_time) you get an error saying you can't define square() twice.&nbsp; Note that square is not local to the function it just appears there.&nbsp; The last line successfully accesses square in the page scope.&nbsp; This is not terribly useful, but interesting.</span>
 ...
 <div class="note">
  ...
  <a href="#20313" class="date">29-Mar-2002 11:47</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Please don't forget:<br />
...
echo </span><span class="string">"remote-value= $paramVal"</span><span class="keyword">;<br />
</span><span class="default">?&gt;<br />
</span><br />
Will not work (!!)</span>
</code></div>
 ...
 <div class="note">
  ...
  <a href="#18905" class="date">09-Feb-2002 04:41</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Solution is to declare the static variable out of the db access class, and declare "global" said variable in the connect method.</span>
 ...
 <div class="note">
  ...
  <a href="#18748" class="date">03-Feb-2002 06:30</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
This really helps with big ugly form submissions.</span>
 ...
 <div class="note">
  ...
  <a href="#17466" class="date">10-Dec-2001 10:53</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
static </span><span class="default">$var </span><span class="keyword">= </span><span class="default">2</span><span class="keyword">+</span><span class="default">3</span><span class="keyword">; </span><span class="comment">//any expression<br />
 ...
 <div class="note">
  ...
  <a href="#14251" class="date">24-Jul-2001 12:28</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
hope this helps someone before they lose all their hair</span>
 ...
 <div class="note">
  ...
  <a href="#12787" class="date">07-May-2001 02:21</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
echo </span><span class="string">"blah.."</span><span class="keyword">;<br />
 ...
 <div class="note">
  ...
  <a href="#3596" class="date">04-Feb-2000 04:51</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; </span><span class="keyword">include(</span><span class="string">"qux"</span><span class="keyword">);<br />
 ...
 <div class="foot"><a href="/manual/add-note.php?sect=language.variables.scope&amp;redirect=@w{T2B349EQ}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.variables.scope&amp;redirect=@w{T2B349EQ}">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.variables.scope.php">show source</a> |

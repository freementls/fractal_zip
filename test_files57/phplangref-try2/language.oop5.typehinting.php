...
<head profile="@w{B8XXCD23}">
 ...
 <base href="http://www.php.net/manual/en/language.oop5.typehinting.php" />
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.oop5.late-static-bindings.php">Late Static Bindings<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.oop5.object-comparison.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Comparing Objects</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.oop5.typehinting.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
...
<div id="language.oop5.typehinting" class="sect1">
  ...
  <p class="para">
   ...
   prototype), interfaces, arrays (since PHP 5.1) or <span class="type"><a href="language.types.callable.php" class="type callable">callable</a></span>
   (since PHP 5.4). However, if <span class="type"><a href="language.types.null.php" class="type NULL">NULL</a></span> is used
  ...
  <p class="para">
   Type hints can not be used with scalar types such as <span class="type"><a href="language.types.integer.php" class="type int">int</a></span> or
   <span class="type"><a href="language.types.string.php" class="type string">string</a></span>.
   <a href="language.oop5.traits.php" class="link">Traits</a> are not allowed either.
  </p>
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.oop5.typehinting&amp;redirect=http://www.php.net/manual/en/language.oop5.typehinting.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.oop5.typehinting&amp;redirect=http://www.php.net/manual/en/language.oop5.typehinting.php">add a note</a></small></span>
  <small>User Contributed Notes</small>
  <strong>Type Hinting</strong>
 </div><div id="allnotes">
 <a name="109405"></a>
 <div class="note">
  <strong class='user'>xianrenb at gmail dot com</strong>
  <a href="#109405" class="date">14-Jul-2012 09:07</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
my scalar type hinting solution (example):<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">class </span><span class="default">Scalar </span><span class="keyword">{<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">/**<br />
&nbsp;&nbsp; &nbsp; *<br />
&nbsp;&nbsp; &nbsp; * @var mixed<br />
&nbsp;&nbsp; &nbsp; */<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">private </span><span class="default">$value</span><span class="keyword">;<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">/**<br />
&nbsp;&nbsp; &nbsp; *<br />
&nbsp;&nbsp; &nbsp; * @param mixed $v<br />
&nbsp;&nbsp; &nbsp; */<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">__construct</span><span class="keyword">(</span><span class="default">$v</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">value </span><span class="keyword">= </span><span class="default">$v</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
...
&nbsp;&nbsp; &nbsp; * @return string<br />
&nbsp;&nbsp; &nbsp; */<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">__toString</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$v </span><span class="keyword">= </span><span class="default">strval</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">value</span><span class="keyword">);<br />
...
&nbsp;&nbsp; &nbsp; * @return bool<br />
&nbsp;&nbsp; &nbsp; */<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">toBool</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$v </span><span class="keyword">= (bool) </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">value</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">$v</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
...
&nbsp;&nbsp; &nbsp; * @return float<br />
&nbsp;&nbsp; &nbsp; */<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">toFloat</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$v </span><span class="keyword">= </span><span class="default">floatval</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">value</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">$v</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
...
&nbsp;&nbsp; &nbsp; * @return int<br />
&nbsp;&nbsp; &nbsp; */<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">toInt</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$v </span><span class="keyword">= </span><span class="default">intval</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">value</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">$v</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
...
&nbsp;&nbsp; &nbsp; * @return string<br />
&nbsp;&nbsp; &nbsp; */<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">toString</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$v </span><span class="keyword">= </span><span class="default">strval</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">value</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">$v</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
...
class </span><span class="default">String </span><span class="keyword">extends </span><span class="default">Scalar </span><span class="keyword">{<br />
...
&nbsp;&nbsp; &nbsp; */<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">__construct</span><span class="keyword">(</span><span class="default">$v</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; if (</span><span class="default">is_string</span><span class="keyword">(</span><span class="default">$v</span><span class="keyword">)) {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">parent</span><span class="keyword">::</span><span class="default">__construct</span><span class="keyword">(</span><span class="default">$v</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; } else {<br />
...
&nbsp;&nbsp; &nbsp; * @return String<br />
&nbsp;&nbsp; &nbsp; */<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public static function </span><span class="default">parse</span><span class="keyword">(</span><span class="default">$v</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$v </span><span class="keyword">= </span><span class="default">strval</span><span class="keyword">(</span><span class="default">$v</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return new </span><span class="default">String</span><span class="keyword">(</span><span class="default">$v</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
...
&nbsp;&nbsp; * @param string $s<br />
&nbsp;&nbsp; */<br />
</span><span class="keyword">function </span><span class="default">myFunction</span><span class="keyword">(</span><span class="default">$s</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; new </span><span class="default">String</span><span class="keyword">(</span><span class="default">$s</span><span class="keyword">);&nbsp; </span><span class="comment">// now $s must be a string to continue<br />
&nbsp;&nbsp;&nbsp; //...<br />
...
p.s. do note: when used in inherited classes a STRICT-notice comes up, because the function definition of the inherited class doesn't match the parent's definition (different type hinting) - but it works great!</span>
 ...
 <div class="note">
  ...
  <a href="#103463" class="date">14-Apr-2011 07:43</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="string">"$this-&gt;value"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;<br />
...
To download the library, just google for 'strong data typing autoboxing' . There is an article describing how to use it, and a download link to the appropriate PHP library.</span>
 ...
 <div class="note">
  ...
  <a href="#102378" class="date">10-Feb-2011 06:48</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
now you know...</span>
 ...
 <div class="note">
  ...
  <a href="#95999" class="date">02-Feb-2010 12:10</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
</span><span class="default">namespace ab </span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; class </span><span class="default">B </span><span class="keyword">implements </span><span class="default">aA </span><span class="keyword">{<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">execute</span><span class="keyword">(</span><span class="default">astring $sth</span><span class="keyword">){} </span><span class="comment">// Correct<br />
...
Hope this can be of use to somebody.</span>
 ...
 <div class="note">
  ...
  <a href="#87731" class="date">18-Dec-2008 07:41</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
You see: typehinting for scalar types (like suggested by Daniel) is not the best thing for the performance if you use it very often.</span>
 ...
 <div class="note">
  ...
  <a href="#84526" class="date">17-Jul-2008 07:39</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; }<br />
 ...
 <div class="note">
  ...
  <a href="#84384" class="date">11-Jul-2008 03:09</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
You get the picture..</span>
 ...
 <div class="note">
  ...
  <a href="#80087" class="date">28-Dec-2007 07:50</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; <br />
 ...
 <div class="note">
  ...
  <a href="#78533" class="date">16-Oct-2007 09:20</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
(True overloading would be a better way, IMHO, but *shrug*)</span>
 ...
 <div class="note">
  ...
  <a href="#73538" class="date">28-Feb-2007 06:52</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
See <a href="http://bugs.php.net/bug.php?id=36601" rel="nofollow" target="_blank">http://bugs.php.net/bug.php?id=36601</a> for a bit more info. Flagged as wontfix, though, so something to keep in mind.</span>
 ...
 <div class="note">
  ...
  <a href="#73447" class="date">23-Feb-2007 07:28</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Hope this clears it up a bit for you... :-)</span>
 ...
 <div class="note">
  ...
  <a href="#73058" class="date">07-Feb-2007 10:12</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
You say: "I'm expection an Object of that Class or a Object of a Subclass of that Class " like you do in every OO languange.</span>
 ...
 <div class="note">
  ...
  <a href="#71141" class="date">13-Nov-2006 12:53</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Nicholas</span>
 ...
 <a name="69369"></a>
 <div class="note">
  <a href="#69369" class="date">02-Sep-2006 08:59</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Type hinting works with interfaces too. In other words, you can specify the name of an interface for a function parameter, and the object passed in must implement that interface, or else type hinting throws an exception.</span>
 ...
 <div class="note">
  ...
  <a href="#50276" class="date">23-Feb-2005 07:34</a>
  <div class="text">
<div class="phpcode"><code><span class="html">

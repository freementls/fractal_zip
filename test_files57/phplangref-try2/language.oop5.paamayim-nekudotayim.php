...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="language.oop5.inheritance.php" />
 <link rel="next" href="language.oop5.static.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/oop5.paamayim-nekudotayim" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/language.oop5.paamayim-nekudotayim.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="@w{3MSPZ45N}" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.oop5.paamayim-nekudotayim.php">Scope Resolution Operator (::)</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.oop5.static.php">Static Keyword<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.oop5.inheritance.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Object Inheritance</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.oop5.paamayim-nekudotayim.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
 <div class="langchooser">
  <form action="/manual/change.php" method="get">
   <p>view this page in </p><fieldset><select name="page">
    ...
    <option value="pl/language.oop5.paamayim-nekudotayim.php">Polish</option>
    ...
    <option value="fa/language.oop5.paamayim-nekudotayim.php">Persian</option>
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.oop5.paamayim-nekudotayim&amp;redirect=@w{3MSPZ45N}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.oop5.paamayim-nekudotayim&amp;redirect=@w{3MSPZ45N}">add a note</a></small></span>
 ...
 <div class="note">
  ...
  <a href="#99486" class="date">19-Aug-2010 10:00</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I'm not sure if this was intentional or not, but it's worth noting...<br />
<br />
As of PHP5.3 you can can say:<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">class </span><span class="default">Foo </span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">__construct</span><span class="keyword">(</span><span class="default">$logClass </span><span class="keyword">= </span><span class="string">'MyLog'</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$logClass</span><span class="keyword">::</span><span class="default">write</span><span class="keyword">();<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
...
&nbsp;&nbsp;&nbsp; protected </span><span class="default">$log</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">__construct</span><span class="keyword">(</span><span class="default">$logClass </span><span class="keyword">= </span><span class="string">'MyLog'</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">log </span><span class="keyword">= </span><span class="default">$logClass</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">log</span><span class="keyword">::</span><span class="default">write</span><span class="keyword">(); </span><span class="comment">// breaks<br />
...
&nbsp;&nbsp;&nbsp; protected static </span><span class="default">$log</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">__construct</span><span class="keyword">(</span><span class="default">$logClass </span><span class="keyword">= </span><span class="string">'MyLog'</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">self</span><span class="keyword">::</span><span class="default">$log </span><span class="keyword">= </span><span class="default">$logClass</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">self</span><span class="keyword">::</span><span class="default">$log</span><span class="keyword">::</span><span class="default">write</span><span class="keyword">(); </span><span class="comment">// breaks<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">}<br />
}<br />
...
&nbsp;}<br />
 ...
 <a name="90240"></a>
 <div class="note">
  <strong class='user'>erwinhaantjes at interurbia dot nl</strong>
  <a href="#90240" class="date">11-Apr-2009 02:36</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">suIsValidArray</span><span class="keyword">( &amp;</span><span class="default">$a</span><span class="keyword">, &amp;</span><span class="default">$iCount </span><span class="keyword">= </span><span class="default">null </span><span class="keyword">)<br />
{<br />
&nbsp; </span><span class="default">$iCount </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br />
&nbsp; return ( </span><span class="default">is_array</span><span class="keyword">( </span><span class="default">$a </span><span class="keyword">) and (( </span><span class="default">$iCount </span><span class="keyword">= @</span><span class="default">count</span><span class="keyword">( </span><span class="default">$a </span><span class="keyword">)) &gt; </span><span class="default">0 </span><span class="keyword">));&nbsp; <br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
...
<span class="default">&lt;?php <br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">inherited</span><span class="keyword">() <br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; </span><span class="comment">// Use DEBUG backtrace to trace caller function<br />
&nbsp;&nbsp; &nbsp;&nbsp; </span><span class="default">$bt </span><span class="keyword">= </span><span class="default">debug_backtrace</span><span class="keyword">();<br />
&nbsp;&nbsp; &nbsp;&nbsp; </span><span class="default">$bt </span><span class="keyword">= </span><span class="default">$bt</span><span class="keyword">[ </span><span class="default">1 </span><span class="keyword">]; </span><span class="comment">// List is in reversed order, 0 reffers to this function so get previous one<br />
&nbsp;&nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp;&nbsp; </span><span class="keyword">if( !</span><span class="default">suIsValidArray</span><span class="keyword">( </span><span class="default">$bt </span><span class="keyword">))<br />
&nbsp;&nbsp; &nbsp;&nbsp; { return; }<br />
&nbsp;&nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp;&nbsp; </span><span class="default">$sClassName </span><span class="keyword">= </span><span class="default">$bt</span><span class="keyword">[</span><span class="string">"class"</span><span class="keyword">];<br />
&nbsp;&nbsp; &nbsp;&nbsp; </span><span class="default">$sParentClassName </span><span class="keyword">= </span><span class="default">get_parent_class</span><span class="keyword">( </span><span class="default">$sClassName </span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp;&nbsp; if( empty( </span><span class="default">$sClassName </span><span class="keyword">) or empty( </span><span class="default">$sParentClassName </span><span class="keyword">) or </span><span class="default">$sParentClassName </span><span class="keyword">== </span><span class="default">$sClassName </span><span class="keyword">)<br />
&nbsp;&nbsp; &nbsp;&nbsp; { return; } <br />
&nbsp;&nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp;&nbsp; </span><span class="default">$sFuncName </span><span class="keyword">= </span><span class="default">$bt</span><span class="keyword">[</span><span class="string">"function"</span><span class="keyword">];<br />
&nbsp;&nbsp; &nbsp; &nbsp; </span><span class="comment">// constructor or destructor called (old fashion way)?<br />
&nbsp;&nbsp; &nbsp;&nbsp; </span><span class="keyword">if( ( </span><span class="default">$bIsConstruct </span><span class="keyword">= ( </span><span class="default">$sFuncName </span><span class="keyword">== </span><span class="default">$sClassName </span><span class="keyword">)) or ( </span><span class="default">$sFuncName </span><span class="keyword">== </span><span class="string">"_"</span><span class="keyword">.</span><span class="default">$sClassName </span><span class="keyword">) )<br />
&nbsp;&nbsp; &nbsp;&nbsp; { <br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment">// get parent constructor/destructor<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$sFuncName </span><span class="keyword">= (( !</span><span class="default">$bIsConstruct </span><span class="keyword">) ? </span><span class="string">"_" </span><span class="keyword">: </span><span class="string">"" </span><span class="keyword">).</span><span class="default">$sParentClassName</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; if( </span><span class="default">$sFuncName </span><span class="keyword">== (( !</span><span class="default">$bIsConstruct </span><span class="keyword">) ? </span><span class="string">"_" </span><span class="keyword">: </span><span class="string">"" </span><span class="keyword">).</span><span class="default">$sClassName </span><span class="keyword">)<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; { return; }<br />
&nbsp;&nbsp; &nbsp;&nbsp; }&nbsp; &nbsp; &nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp; <br />
&nbsp;&nbsp; &nbsp;&nbsp; if( </span><span class="default">method_exists</span><span class="keyword">( </span><span class="default">$sParentClassName</span><span class="keyword">, </span><span class="default">$sFuncName </span><span class="keyword">))<br />
&nbsp;&nbsp; &nbsp; &nbsp; { <br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span><span class="comment">// If there are parameters specified, use these<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; </span><span class="default">$args </span><span class="keyword">= </span><span class="default">func_get_args</span><span class="keyword">();<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; if( !</span><span class="default">suIsValidArray</span><span class="keyword">( </span><span class="default">$args </span><span class="keyword">))<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; { </span><span class="default">$args </span><span class="keyword">= &amp;</span><span class="default">$bt</span><span class="keyword">[</span><span class="string">"args"</span><span class="keyword">]; } </span><span class="comment">// otherwise use previous function parameters if any <br />
&nbsp;&nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span><span class="default">$iCount </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; <br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span><span class="default">$sArgs </span><span class="keyword">= </span><span class="string">""</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; if( </span><span class="default">suIsValidArray</span><span class="keyword">( </span><span class="default">$args</span><span class="keyword">, </span><span class="default">$iCount </span><span class="keyword">))<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; { <br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; for( </span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">$iCount</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">++ )<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; { </span><span class="default">$sArgs</span><span class="keyword">.=</span><span class="string">"&amp;$"</span><span class="keyword">.</span><span class="string">"args[$i]"</span><span class="keyword">.( </span><span class="default">$i </span><span class="keyword">&lt; (</span><span class="default">$iCount</span><span class="keyword">-</span><span class="default">1</span><span class="keyword">) ? </span><span class="string">"," </span><span class="keyword">: </span><span class="string">"" </span><span class="keyword">); }<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; }&nbsp; &nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; </span><span class="comment">// Simple, evaluate it, this is possible because it is done inside the class itself, and<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; // the parent class is already created because is a part of the class structure, no worry, no scope issues&nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">eval( </span><span class="string">"$"</span><span class="keyword">.</span><span class="string">"result = $sParentClassName::"</span><span class="keyword">.</span><span class="default">$sFuncName</span><span class="keyword">.</span><span class="string">"($sArgs);" </span><span class="keyword">);<br />
...
Nice trick</span>
 ...
 <div class="note">
  ...
  <a href="#82008" class="date">24-Mar-2008 06:27</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Actually, for people not using PHP 5.3 yet you should try avoiding the use of a eval() at all costs! THere are too many security risks and dirty code that come from using eval. If you want to call a static method from a class then you can use call_user_func() instead which is much safer.<br />
<br />
Example:<br />
<br />
clas Foo{<br />
<br />
&nbsp; public static method Bar(){<br />
&nbsp;&nbsp;&nbsp; echo "Hello world!";<br />
&nbsp; }<br />
<br />
}<br />
<br />
And to execute that with call_user_func you would do the following:<br />
<br />
call_user_func(array('Foo', 'bar') [, $params] );<br />
<br />
Thanks,<br />
- Richard S.</span>
</code></div>
 ...
 <div class="note">
  ...
  <a href="#80056" class="date">27-Dec-2007 04:15</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
If you need to reference a class using a variable (prior to PHP 5.3.0) you may use something like this:<br />
<br />
<span class="default">&lt;?php<br />
$className </span><span class="keyword">= </span><span class="string">'MyClass'</span><span class="keyword">;<br />
<br />
eval(</span><span class="string">'$foo = ' </span><span class="keyword">. </span><span class="default">$className </span><span class="keyword">. </span><span class="string">'::myFunction();'</span><span class="keyword">);<br />
<br />
 ...
 <div class="note">
  ...
  <a href="#78542" class="date">16-Oct-2007 03:41</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
There's no surprize here. These resolution rules are identical in C++ and Java, where static fields (and methods) are not separately instanciated within the inheritance tree for the new derived classes.<br />
<br />
This is per design. If you want per-class static fields,you have to overload each static field (or method) to assign them a new value that will hide the inherited static field (or method). The "$self::" scope in a static method does not refer to the object or class from which the method is called, as it is statically compiled and resolved within the class declaring the method.<br />
<br />
In other words "$self::" is just needed to specify the field declared in the defining class, instead of a homonym variable (or function) in the local scope which may hide it. This is exactly similar to the "this." scope specifier (used with the "." operator here) used in C++ (or Java).<br />
<br />
The same can be said about the semantic of "$super::" used within a static method (similar to "super." scope specifier used in C++ or Java).<br />
<br />
Neither PHP, nor C++, have a way to work on instanciated class objects as if they were objects of the first grade (that's why C++ and Java are making distinctions between classes and interfaces).<br />
<br />
On the opposite Javascript/ECMAScript defines classes like standard objects with a "prototype" field for the fields (or methods) to inherit instead of duplicating them with the new operator. When working in PHP, forget Javascript, think like in C++ and Java.</span>
</code></div>
  </div>
 </div>
 <a name="73200"></a>
...
[A] -- {B} -- (C){C}{C}[C]</span>
 ...
 <a name="59061"></a>
 <div class="note">
  <strong class='user'>Kristof Coomans</strong>
  <a href="#59061" class="date">25-Nov-2005 03:08</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
In response to ian at [first name]henderson dot org:<br />
<br />
(related bogus bug report: <a href="http://bugs.php.net/bug.php?id=26930" rel="nofollow" target="_blank">http://bugs.php.net/bug.php?id=26930</a>)<br />
<br />
The functionality you've expected maybe will be possible in PHP6, probably by using the static keyword in conjunction with the scope resolution parameter. You can read more about this in the minutes of the PHP developers meeting at 11 and 12 november in Paris: <a href="http://www.php.net/~derick/meeting-notes.html" rel="nofollow" target="_blank">http://www.php.net/~derick/meeting-notes.html</a> point 5.4: Late static binding using "this" without "$" (or perhaps with a different name)</span>
</code></div>
  </div>
 </div>
 <a name="52393"></a>
 <div class="note">
  <strong class='user'>HuugjeWeg</strong>
  <a href="#52393" class="date">29-Apr-2005 05:58</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
In response to ian at [first name]henderson dot org:<br />
<br />
You are not allowed to redefine static methods, see<br />
<a href="@w{HM7GQKQ4}" rel="nofollow" target="_blank">@w{HM7GQKQ4}</a><br />
<br />
And in response to thenewparadigm at hotmail dot com: the behaviour you describe seems appropriate for *classes* with static variables, see "Using static variables" on <a href="http://nl2.php.net/static" rel="nofollow" target="_blank">http://nl2.php.net/static</a></span>
</code></div>
  </div>
 </div>
 <a name="50645"></a>
 <div class="note">
  ...
  <a href="#50645" class="date">05-Mar-2005 09:43</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
There is also a quirk with using the scope resolution operator on static class variables.&nbsp; Below is an example using a highly modified version of Ian's code:<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">class </span><span class="default">ExampleSuperclass<br />
</span><span class="keyword">{<br />
&nbsp;&nbsp; static </span><span class="default">$className</span><span class="keyword">;<br />
<br />
&nbsp;&nbsp; static function </span><span class="default">showClassName</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp;&nbsp; echo </span><span class="default">self</span><span class="keyword">::</span><span class="default">$className </span><span class="keyword">. </span><span class="string">"\n"</span><span class="keyword">;<br />
&nbsp;&nbsp; }<br />
}<br />
<br />
class </span><span class="default">ExampleSubclassOne </span><span class="keyword">extends </span><span class="default">ExampleSuperclass<br />
</span><span class="keyword">{<br />
&nbsp;&nbsp; static function </span><span class="default">setClassName</span><span class="keyword">()<br />
&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; </span><span class="default">self</span><span class="keyword">::</span><span class="default">$className </span><span class="keyword">= </span><span class="string">"subclassOne"</span><span class="keyword">;<br />
&nbsp;&nbsp; }<br />
}<br />
<br />
class </span><span class="default">ExampleSubclassTwo </span><span class="keyword">extends </span><span class="default">ExampleSuperClass<br />
</span><span class="keyword">{<br />
&nbsp;&nbsp; static function </span><span class="default">setClassName</span><span class="keyword">()<br />
&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp;&nbsp; </span><span class="default">self</span><span class="keyword">::</span><span class="default">$className </span><span class="keyword">= </span><span class="string">"subclassTwo"</span><span class="keyword">;<br />
&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="comment">// setting variables for each class<br />
</span><span class="default">ExampleSubclassOne</span><span class="keyword">::</span><span class="default">setClassName</span><span class="keyword">();<br />
</span><span class="default">ExampleSubclassTwo</span><span class="keyword">::</span><span class="default">setClassName</span><span class="keyword">();<br />
<br />
</span><span class="default">ExampleSubclassOne</span><span class="keyword">::</span><span class="default">showClassName</span><span class="keyword">();&nbsp; </span><span class="comment">// output is "subclassTwo"!<br />
<br />
// more output:<br />
<br />
</span><span class="keyword">echo </span><span class="default">ExampleSubclassOne</span><span class="keyword">::</span><span class="default">$className </span><span class="keyword">. </span><span class="string">"\n"</span><span class="keyword">; </span><span class="comment">// output is "subclassTwo"!<br />
</span><span class="keyword">echo </span><span class="default">ExampleSubclassTwo</span><span class="keyword">::</span><span class="default">$className </span><span class="keyword">. </span><span class="string">"\n"</span><span class="keyword">; </span><span class="comment">// output is "subclassTwo"<br />
</span><span class="keyword">echo </span><span class="default">ExampleSuperclass</span><span class="keyword">::</span><span class="default">$className </span><span class="keyword">. </span><span class="string">"\n"</span><span class="keyword">; </span><span class="comment">// output is "subclassTwo"!<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
appearantly, any static variables defined in a superclass are directly referenced in subclasses,<br />
and all changes are visible throughout the class heirarchy.&nbsp; care must be taken when using static<br />
class variables.</span>
</code></div>
  </div>
 </div>
 <a name="49541"></a>
 <div class="note">
  <strong class='user'>ian at [first name]henderson dot org</strong>
  <a href="#49541" class="date">31-Jan-2005 10:43</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Please note that methods called by the scope resolution operator which are defined by a superclass of the first operand are called in the scope of the SUPERCLASS.&nbsp; For example,<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">class </span><span class="default">ExampleSuperclass<br />
</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; static function </span><span class="default">classType</span><span class="keyword">()<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="string">"superclass"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
<br />
&nbsp;&nbsp;&nbsp; static function </span><span class="default">doSomething</span><span class="keyword">()<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"doing something with " </span><span class="keyword">. </span><span class="default">self</span><span class="keyword">::</span><span class="default">classType</span><span class="keyword">();<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
class </span><span class="default">ExampleClass </span><span class="keyword">extends </span><span class="default">ExampleSuperclass<br />
</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; static function </span><span class="default">classType</span><span class="keyword">()<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="string">"subclass"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="default">ExampleClass</span><span class="keyword">::</span><span class="default">doSomething</span><span class="keyword">();<br />
</span><span class="comment">// output is "doing something with superclass"!<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
This can be surprising (it surprised me!) when coming from other object-oriented languages, which would output "doing something with subclass" in this case.</span>
</code></div>
  </div>
 </div></div>

 <div class="foot"><a href="/manual/add-note.php?sect=language.oop5.paamayim-nekudotayim&amp;redirect=@w{3MSPZ45N}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.oop5.paamayim-nekudotayim&amp;redirect=@w{3MSPZ45N}">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.oop5.paamayim-nekudotayim.php">show source</a> |

...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="language.oop5.traits.php" />
 <link rel="next" href="language.oop5.iterations.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/oop5.overloading" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/language.oop5.overloading.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="http://www.php.net/manual/en/language.oop5.overloading.php" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.oop5.overloading.php">Overloading</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.oop5.iterations.php">Object Iteration<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.oop5.traits.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Traits</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.oop5.overloading.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
 <div class="langchooser">
  <form action="/manual/change.php" method="get">
   <p>view this page in </p><fieldset><select name="page">
    ...
    <option value="pl/language.oop5.overloading.php">Polish</option>
    ...
    <option value="fa/language.oop5.overloading.php">Persian</option>
  ...
  <div class="sect2" id="language.oop5.overloading.members">
   ...
   <blockquote class="note"><p><strong class="note">Note</strong>: 
    <p class="para">
     ...
     language constructs than  <span class="function"><a href="function.isset.php" class="function">isset()</a></span>. This 
     means if  <span class="function"><a href="function.empty.php" class="function">empty()</a></span> is called on an overloaded 
    ...
    <p class="para">
     ...
     handed to  <span class="function"><a href="function.empty.php" class="function">empty()</a></span>.
    </p>
   </p></blockquote>
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.oop5.overloading&amp;redirect=http://www.php.net/manual/en/language.oop5.overloading.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.oop5.overloading&amp;redirect=http://www.php.net/manual/en/language.oop5.overloading.php">add a note</a></small></span>
  <small>User Contributed Notes</small>
  <strong>Overloading</strong>
 </div><div id="allnotes">
 <a name="108040"></a>
 <div class="note">
  <strong class='user'>theaceofthespade at gmail dot com</strong>
  <a href="#108040" class="date">23-Mar-2012 09:35</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
A word of warning!&nbsp; It may seem obvious, but remember, when deciding whether to use __get, __set, and __call as a way to access the data in your class (as opposed to hard-coding getters and setters), keep in mind that this will prevent any sort of autocomplete, highlighting, or documentation that your ide mite do.<br />
<br />
Furthermore, it beyond personal preference when working with other people.&nbsp; Even without an ide, it can be much easier to go through and look at hardcoded member and method definitions in code, than having to sift through code and piece together the method/member names that are assembled in __get and __set.<br />
<br />
If you still decide to use __get and __set for everything in your class, be sure to include detailed comments and documenting, so that the people you are working with (or the people who inherit the code from you at a later date) don't have to waste time interpreting your code just to be able to use it.</span>
</code></div>
  </div>
 </div>
 <a name="107547"></a>
 <div class="note">
  <strong class='user'>_ at apakoh dot dk</strong>
  <a href="#107547" class="date">16-Feb-2012 04:11</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I find the following use of __set and __get useful:<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">class </span><span class="default">Post </span><span class="keyword">{<br />
&nbsp; private </span><span class="default">$title</span><span class="keyword">;<br />
&nbsp; private </span><span class="default">$content</span><span class="keyword">;<br />
&nbsp; private </span><span class="default">$author</span><span class="keyword">;<br />
&nbsp; private </span><span class="default">$comments</span><span class="keyword">;<br />
<br />
&nbsp; private </span><span class="default">$_getters </span><span class="keyword">= array(</span><span class="string">'title'</span><span class="keyword">, </span><span class="string">'content'</span><span class="keyword">, </span><span class="string">'author'</span><span class="keyword">, </span><span class="string">'comments'</span><span class="keyword">);<br />
&nbsp; private </span><span class="default">$_setters </span><span class="keyword">= array(</span><span class="string">'title'</span><span class="keyword">, </span><span class="string">'content'</span><span class="keyword">, </span><span class="string">'author'</span><span class="keyword">);<br />
&nbsp; <br />
...
&nbsp;&nbsp;&nbsp; if (</span><span class="default">in_array</span><span class="keyword">(</span><span class="default">$property</span><span class="keyword">, </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">_setters</span><span class="keyword">)) {<br />
&nbsp;&nbsp; &nbsp;&nbsp; return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">$property</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; else if (</span><span class="default">method_exists</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">, </span><span class="string">'_get_' </span><span class="keyword">. </span><span class="default">$property</span><span class="keyword">))<br />
&nbsp;&nbsp; &nbsp;&nbsp; return </span><span class="default">call_user_func</span><span class="keyword">(array(</span><span class="default">$this</span><span class="keyword">, </span><span class="string">'_get_' </span><span class="keyword">. </span><span class="default">$property</span><span class="keyword">));<br />
&nbsp;&nbsp;&nbsp; else if (</span><span class="default">in_array</span><span class="keyword">(</span><span class="default">$property</span><span class="keyword">, </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">_getters</span><span class="keyword">) OR </span><span class="default">method_exists</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">, </span><span class="string">'_set_' </span><span class="keyword">. </span><span class="default">$property</span><span class="keyword">))<br />
&nbsp;&nbsp; &nbsp;&nbsp; throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">'Property "' </span><span class="keyword">. </span><span class="default">$property </span><span class="keyword">. </span><span class="string">'" is write-only.'</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; else<br />
&nbsp;&nbsp; &nbsp;&nbsp; throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">'Property "' </span><span class="keyword">. </span><span class="default">$property </span><span class="keyword">. </span><span class="string">'" is not accessible.'</span><span class="keyword">);<br />
&nbsp; }<br />
<br />
...
&nbsp;&nbsp;&nbsp; if (</span><span class="default">in_array</span><span class="keyword">(</span><span class="default">$property</span><span class="keyword">, </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">_getters</span><span class="keyword">)) {<br />
...
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; else if (</span><span class="default">method_exists</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">, </span><span class="string">'_set_' </span><span class="keyword">. </span><span class="default">$property</span><span class="keyword">))<br />
&nbsp;&nbsp; &nbsp;&nbsp; </span><span class="default">call_user_func</span><span class="keyword">(array(</span><span class="default">$this</span><span class="keyword">, </span><span class="string">'_set_' </span><span class="keyword">. </span><span class="default">$property</span><span class="keyword">), </span><span class="default">$value</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; else if (</span><span class="default">in_array</span><span class="keyword">(</span><span class="default">$property</span><span class="keyword">, </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">_setters</span><span class="keyword">) OR </span><span class="default">method_exists</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">, </span><span class="string">'_get_' </span><span class="keyword">. </span><span class="default">$property</span><span class="keyword">))<br />
&nbsp;&nbsp; &nbsp;&nbsp; throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">'Property "' </span><span class="keyword">. </span><span class="default">$property </span><span class="keyword">. </span><span class="string">'" is read-only.'</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; else<br />
&nbsp;&nbsp; &nbsp;&nbsp; throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">'Property "' </span><span class="keyword">. </span><span class="default">$property </span><span class="keyword">. </span><span class="string">'" is not accessible.'</span><span class="keyword">);<br />
&nbsp; }<br />
}<br />
...
This way the variables in the $_getters array can be read from the outside and the variables in the $_setters array can be modified from the outside, like this:<br />
<br />
<span class="default">&lt;?php<br />
$post </span><span class="keyword">= new </span><span class="default">Post</span><span class="keyword">();<br />
</span><span class="default">$post</span><span class="keyword">-&gt;</span><span class="default">title </span><span class="keyword">= </span><span class="string">'Hello, World'</span><span class="keyword">;<br />
echo </span><span class="default">$post</span><span class="keyword">-&gt;</span><span class="default">title</span><span class="keyword">;<br />
<br />
</span><span class="comment">// The following will throw an exception since $comments is read-only:<br />
</span><span class="default">$post</span><span class="keyword">-&gt;</span><span class="default">comments </span><span class="keyword">= </span><span class="default">23</span><span class="keyword">;<br />
</span><span class="default">?&gt;<br />
</span><br />
And in case you need a less generic getter or setter at some point, you can remove the variable from the $_getters or $_setters array and implement a method like:<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">private function </span><span class="default">_set_title</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">) {<br />
&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">title </span><span class="keyword">= </span><span class="default">str_replace</span><span class="keyword">(</span><span class="string">'World'</span><span class="keyword">, </span><span class="string">'Universe'</span><span class="keyword">, </span><span class="default">$value</span><span class="keyword">);<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
And from the outside the property could still be used with:<br />
<br />
<span class="default">&lt;?php<br />
$post</span><span class="keyword">-&gt;</span><span class="default">title </span><span class="keyword">= </span><span class="string">'Hello, World!'</span><span class="keyword">;<br />
</span><span class="default">?&gt;<br />
</span><br />
I've tried a couple of different ways of doing this, but this seems to be the fastest (although still around 2 times slower than using ugly old school getter- and setter-methods).<br />
Functions like property_exists() are unnecessary and only makes thing even slower (my initial attempt at using __set and __get was up to 9 times slower than traditional getter/setter methods).<br />
<br />
Could probably still be improved/changed in different ways depending on context.</span>
</code></div>
  </div>
 </div>
 <a name="106382"></a>
...
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"__set($name, $value);\n"</span><span class="keyword">;<br />
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; else {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; throw new </span><span class="default">Exception</span><span class="keyword">( </span><span class="string">"Property ({$property}) does not exist"</span><span class="keyword">, </span><span class="default">0 </span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; break;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; default:<br />
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; throw new </span><span class="default">InvalidArgumentException</span><span class="keyword">(</span><span class="string">"Property {$property} doesn't exist"</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">$property</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
...
</span><span class="default">$test</span><span class="keyword">-&gt;</span><span class="default">do_something </span><span class="keyword">= function (</span><span class="default">$var1</span><span class="keyword">, </span><span class="default">$var2</span><span class="keyword">) {echo </span><span class="string">"custom called with $var1 and $var2\n"</span><span class="keyword">;};<br />
...
&nbsp;&nbsp; &nbsp;&nbsp; die(</span><span class="string">"Trying to set protected member '$name' from public scope."</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; break;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; default:<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"Error: Call to undefined function \"$name.\"&lt;br&gt;" </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
...
&nbsp;&nbsp; &nbsp; &nbsp; echo </span><span class="string">"Default $nm value"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
</span><span class="default">$a </span><span class="keyword">= new </span><span class="default">A</span><span class="keyword">;<br />
</span><span class="default">$b </span><span class="keyword">= new </span><span class="default">B</span><span class="keyword">;<br />
...
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$return_value </span><span class="keyword">= </span><span class="string">"Method $method_name was called with " </span><span class="keyword">. </span><span class="default">count</span><span class="keyword">(</span><span class="default">$parameters</span><span class="keyword">) . </span><span class="string">" parameters"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
...
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="string">"Method $method_name was called with " </span><span class="keyword">. </span><span class="default">count</span><span class="keyword">(</span><span class="default">$parameters</span><span class="keyword">) . </span><span class="string">" parameters"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="default">?&gt;</span>
...
&nbsp; public function </span><span class="default">__get</span><span class="keyword">(</span><span class="default">$name</span><span class="keyword">) { return </span><span class="string">"__get of $name" </span><span class="keyword">; }<br />
}<br />
<br />
...
&nbsp;&nbsp;&nbsp; echo </span><span class="string">"Method {$method} called with args: " </span><span class="keyword">. </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$args</span><span class="keyword">, </span><span class="default">TRUE</span><span class="keyword">);<br />
&nbsp; }<br />
}<br />
<br />
...
<br />
&nbsp; function </span><span class="default">__set</span><span class="keyword">(</span><span class="default">$name</span><span class="keyword">, </span><span class="default">$value</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; echo(</span><span class="string">"__set called to set $name to $value\n"</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">$name </span><span class="keyword">= </span><span class="default">$value</span><span class="keyword">;<br />
&nbsp; }<br />
}<br />
<br />
...
&nbsp;&nbsp;&nbsp; echo </span><span class="string">"The property '$set' is read only"</span><span class="keyword">;<br />
&nbsp; else<br />
...
&nbsp;&nbsp;&nbsp; else<br />
&nbsp;&nbsp; &nbsp;&nbsp; echo </span><span class="string">"Property '$set' doesn't exist"</span><span class="keyword">;<br />
&nbsp;}<br />
...
&nbsp;&nbsp;&nbsp; else<br />
&nbsp;&nbsp; &nbsp; echo </span><span class="string">"Property '$get' doesn't exist"</span><span class="keyword">;<br />
&nbsp;}<br />
}<br />
</span><span class="default">?&gt;</span>
</span>
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"Param2($a,$b)\n"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
<br />
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"Param3($a,$b,$c)\n"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
}<br />
<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; else<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; die(</span><span class="string">"method $name dose not exist\n"</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">false</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }</span>
</span>
...
<br />
&nbsp;&nbsp;&nbsp; echo </span><span class="string">"Actual function returns: $ref1 which should be equal to " </span><span class="keyword">. </span><span class="default">$GLOBALS</span><span class="keyword">[</span><span class="string">'var1'</span><span class="keyword">] . </span><span class="string">"&lt;br/&gt;\n"</span><span class="keyword">;<br />
<br />
...
<br />
&nbsp;&nbsp;&nbsp; echo </span><span class="string">"Overloaded function returns: $ref2 which should be equal to " </span><span class="keyword">. </span><span class="default">$GLOBALS</span><span class="keyword">[</span><span class="string">'var2'</span><span class="keyword">] . </span><span class="string">"&lt;br/&gt;\n"</span><span class="keyword">;<br />
<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; foreach (</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">callLog </span><span class="keyword">as </span><span class="default">$c</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$rVal</span><span class="keyword">[] = </span><span class="string">"$c[0]("</span><span class="keyword">.</span><span class="default">implode</span><span class="keyword">(</span><span class="string">', '</span><span class="keyword">, </span><span class="default">$c</span><span class="keyword">[</span><span class="default">1</span><span class="keyword">]).</span><span class="string">");"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
...
&nbsp; { print </span><span class="string">"You called __call($fname)\n"</span><span class="keyword">;<br />
...
&nbsp;&nbsp;&nbsp; print </span><span class="string">"Done: __call($fname)\n"</span><span class="keyword">;<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; else<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; die(</span><span class="string">"method $val does not exist\n"</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
...
Php 5 has a simple recursion system that stops you from using overloading within an overloading function, this means you cannot get an overloaded variable within the __get method, or within any functions/methods called by the _get method, you can however call __get manualy within itself to do the same thing.</span>
 ...
 <div class="foot"><a href="/manual/add-note.php?sect=language.oop5.overloading&amp;redirect=http://www.php.net/manual/en/language.oop5.overloading.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.oop5.overloading&amp;redirect=http://www.php.net/manual/en/language.oop5.overloading.php">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.oop5.overloading.php">show source</a> |

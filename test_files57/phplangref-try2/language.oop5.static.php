...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="language.oop5.paamayim-nekudotayim.php" />
 <link rel="next" href="language.oop5.abstract.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/oop5.static" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/language.oop5.static.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="@w{HM7GQKQ4}" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.oop5.static.php">Static Keyword</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.oop5.abstract.php">Class Abstraction<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.oop5.paamayim-nekudotayim.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Scope Resolution Operator (::)</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.oop5.static.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.oop5.static&amp;redirect=@w{HM7GQKQ4}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.oop5.static&amp;redirect=@w{HM7GQKQ4}">add a note</a></small></span>
...
&nbsp;&nbsp;&nbsp; if (</span><span class="default">defined</span><span class="keyword">(</span><span class="default">self</span><span class="keyword">::$</span><span class="default">$name</span><span class="keyword">)) echo </span><span class="string">"$name is defined"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; else echo </span><span class="string">"$name is not defined"</span><span class="keyword">;<br />
&nbsp; }<br />
<br />
}<br />
<br />
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">. </span><span class="string">"'$property' in class $class."</span><span class="keyword">,</span><span class="default">E_USER_ERROR</span><span class="keyword">);<br />
...
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp;&nbsp; print </span><span class="string">"Hello my name is {$this-&gt; name}!&lt;br&gt;"</span><span class="keyword">;<br />
<br />
&nbsp;&nbsp;&nbsp; }<br />
<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"&lt;p&gt;- Logs &amp;gt; $msg &lt;/p&gt;"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
...
<a href="@w{T2B349EQ}" rel="nofollow" target="_blank">@w{T2B349EQ}</a></span>
</code></div>
  </div>
 </div>
 <a name="80162"></a>
...
Luckily, a work around has been committed to PHP's HEAD, and should be available in the 5.3 series.&nbsp; The concept is called "late static binding" (LSB), and can be read about at <a href="http://www.colder.ch/news/08-24-2007/28/late-static-bindings-expl.html" rel="nofollow" target="_blank">http://www.colder.ch/news/08-24-2007/28/late-static-bindings-expl.html</a> .&nbsp; Basically, you'd have the exact same setup in as in the first example, but instead of calling "self::foo()", you instead would call "static::foo()".</span>
</code></div>
  </div>
 </div>
 <a name="76989"></a>
...
Test::non_static();</span>
 ...
 <div class="foot"><a href="/manual/add-note.php?sect=language.oop5.static&amp;redirect=@w{HM7GQKQ4}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.oop5.static&amp;redirect=@w{HM7GQKQ4}">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.oop5.static.php">show source</a> |

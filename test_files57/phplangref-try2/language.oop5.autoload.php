...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="language.oop5.constants.php" />
 <link rel="next" href="language.oop5.decon.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/oop5.autoload" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/language.oop5.autoload.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="http://www.php.net/manual/en/language.oop5.autoload.php" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.oop5.autoload.php">Autoloading Classes</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.oop5.decon.php">Constructors and Destructors<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.oop5.constants.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Class Constants</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.oop5.autoload.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
...
<div id="language.oop5.autoload" class="sect1">
  ...
  <p class="para">
   In PHP 5, this is no longer necessary. You may define an
    <span class="function"><a href="function.autoload.php" class="function">__autoload()</a></span> function which is automatically
  ...
  <div class="tip"><strong class="tip">Tip</strong>
   <p class="para">
     <span class="function"><a href="function.spl-autoload-register.php" class="function">spl_autoload_register()</a></span> provides a more flexible
    alternative for autoloading classes. For this reason, using
     <span class="function"><a href="function.autoload.php" class="function">__autoload()</a></span> is discouraged and may be deprecated or
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    ...
    __autoload function can be caught in the <a href="language.exceptions.php" class="link">
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.oop5.autoload&amp;redirect=http://www.php.net/manual/en/language.oop5.autoload.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.oop5.autoload&amp;redirect=http://www.php.net/manual/en/language.oop5.autoload.php">add a note</a></small></span>
  <small>User Contributed Notes</small>
  <strong>Autoloading Classes</strong>
 </div><div id="allnotes">
 <a name="107174"></a>
 <div class="note">
  <strong class='user'>shaftouille</strong>
  <a href="#107174" class="date">12-Jan-2012 01:14</a>
  <div class="text">
...
spl_autoload_register</span><span class="keyword">(function(</span><span class="default">$className</span><span class="keyword">)<br />
{<br />
&nbsp;&nbsp;&nbsp; require(</span><span class="default">str_replace</span><span class="keyword">(</span><span class="string">'\\'</span><span class="keyword">, </span><span class="string">'/'</span><span class="keyword">, </span><span class="default">ltrim</span><span class="keyword">(</span><span class="default">$className</span><span class="keyword">, </span><span class="string">'\\'</span><span class="keyword">)) . </span><span class="string">'.php'</span><span class="keyword">);<br />
});<br />
...
<span class="default">&lt;?php<br />
define</span><span class="keyword">(</span><span class="string">'ROOT_DIR'</span><span class="keyword">, </span><span class="default">realpath</span><span class="keyword">(</span><span class="default">__DIR__ </span><span class="keyword">. </span><span class="string">'/..'</span><span class="keyword">));<br />
<br />
</span><span class="default">set_include_path</span><span class="keyword">(</span><span class="default">ROOT_DIR </span><span class="keyword">. </span><span class="default">PATH_SEPARATOR </span><span class="keyword">. </span><span class="default">get_include_path</span><span class="keyword">());<br />
</span><span class="default">?&gt;<br />
</span><br />
And of course you want to catch the loading errors, so you can use class_exists :<br />
<br />
<span class="default">&lt;?php<br />
$className </span><span class="keyword">= </span><span class="string">'\core\Controller\Hello\World'</span><span class="keyword">;<br />
<br />
if (!</span><span class="default">class_exists</span><span class="keyword">(</span><span class="default">$className</span><span class="keyword">))<br />
{<br />
&nbsp;&nbsp;&nbsp; throw new </span><span class="default">ErrorException</span><span class="keyword">(</span><span class="string">'Class Not Found !'</span><span class="keyword">);<br />
}<br />
else<br />
{<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$object </span><span class="keyword">= new </span><span class="default">$className</span><span class="keyword">();<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
...
<span class="default">&lt;?php<br />
namespace coreControllerHello</span><span class="keyword">;<br />
<br />
class </span><span class="default">World<br />
</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; function </span><span class="default">__construct</span><span class="keyword">()<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">"Helloworld"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
...
&nbsp; </span><span class="comment"># ... your logic to include classes here<br />
 ...
 <a name="105539"></a>
 <div class="note">
  <strong class='user'>Nic</strong>
  <a href="#105539" class="date">25-Aug-2011 12:22</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Autoloading camel case classes, ie. loading "controller/product/detail.php" from "ControllerProductDetail":<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="comment">// Autoloading<br />
...
&nbsp;&nbsp;&nbsp; </span><span class="default">$path </span><span class="keyword">= </span><span class="default">strtolower</span><span class="keyword">(</span><span class="default">preg_replace</span><span class="keyword">(</span><span class="string">'/([a-z])([A-Z])/'</span><span class="keyword">, </span><span class="string">'$1/$2'</span><span class="keyword">, </span><span class="default">$class</span><span class="keyword">));<br />
&nbsp;&nbsp;&nbsp; if(</span><span class="default">file_exists</span><span class="keyword">(</span><span class="default">DIR_APPLICATION </span><span class="keyword">. </span><span class="default">$path </span><span class="keyword">. </span><span class="string">'.php'</span><span class="keyword">)) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; require_once(</span><span class="default">DIR_APPLICATION </span><span class="keyword">. </span><span class="default">$path </span><span class="keyword">. </span><span class="string">'.php'</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
</span><span class="default">?&gt;</span>
</span>
 ...
 <div class="note">
  ...
  <a href="#104282" class="date">05-Jun-2011 11:58</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
When multiple scripts try to use __autoload(), there is a collision.<br />
I experienced it while upgrading the Smarty and my own autoload function.<br />
<br />
So, the better way is to avoid __autoload() and use spl_register_autoload() instead. If you have written this already, just rename your function to something like __autoload_my_classes, and in the next, call spl_autoload_register as:<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">__autoload_my_classes</span><span class="keyword">(</span><span class="default">$classname</span><span class="keyword">)<br />
{<br />
&nbsp; </span><span class="comment"># ... your logic to include classes here<br />
</span><span class="keyword">}<br />
</span><span class="default">spl_autoload_register</span><span class="keyword">(</span><span class="string">'__autoload_my_classes'</span><span class="keyword">);<br />
</span><span class="default">?&gt;<br />
</span><br />
You can assign multiple functions to spl_autoload_register() by calling it repeatedly with different function names. Be sure to limit your every function to include a CLASS file.</span>
</code></div>
  </div>
 </div>
 <a name="104187"></a>
 <div class="note">
  <strong class='user'>rahj_1986 at (yahoo) dot com</strong>
  <a href="#104187" class="date">30-May-2011 10:22</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; include_once(</span><span class="string">"classfolder/" </span><span class="keyword">. </span><span class="default">$classname </span><span class="keyword">. </span><span class="string">".php"</span><span class="keyword">);<br />
}<br />
...
</span><span class="keyword">class </span><span class="default">SampleClass </span><span class="keyword">{<br />
&nbsp;&nbsp; public function </span><span class="default">hello_rahj</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp;&nbsp; echo </span><span class="string">"Hello rahj!"</span><span class="keyword">;<br />
&nbsp;&nbsp; }<br />
}<br />
...
</span><span class="keyword">include(</span><span class="string">"config.php"</span><span class="keyword">)<br />
<br />
</span><span class="default">$hello </span><span class="keyword">= new </span><span class="default">SampleClass</span><span class="keyword">();<br />
</span><span class="default">$hello</span><span class="keyword">-&gt;</span><span class="default">hello_rahj</span><span class="keyword">(); </span><span class="comment">// outputs Hello rahj!<br />
...
Hope this Helps!</span>
 ...
 <div class="note">
  ...
  <a href="#103746" class="date">01-May-2011 04:19</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
After a while trying to get __autoload() to work, I used spl_register_autoload instead. __autoload() unexplainably failed so I gave up on it.</span>
</code></div>
  </div>
 </div>
 <a name="102394"></a>
 <div class="note">
  <strong class='user'>T dot  Alexander Lystad tal at lystadonline dot no</strong>
  <a href="#102394" class="date">11-Feb-2011 07:19</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<span class="default">&lt;?php<br />
spl_autoload_register</span><span class="keyword">(function (</span><span class="default">$className</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$possibilities </span><span class="keyword">= array(<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">APPLICATION_PATH</span><span class="keyword">.</span><span class="string">'beans'</span><span class="keyword">.</span><span class="default">DIRECTORY_SEPARATOR</span><span class="keyword">.</span><span class="default">$className</span><span class="keyword">.</span><span class="string">'.php'</span><span class="keyword">,<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">APPLICATION_PATH</span><span class="keyword">.</span><span class="string">'controllers'</span><span class="keyword">.</span><span class="default">DIRECTORY_SEPARATOR</span><span class="keyword">.</span><span class="default">$className</span><span class="keyword">.</span><span class="string">'.php'</span><span class="keyword">,<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">APPLICATION_PATH</span><span class="keyword">.</span><span class="string">'libraries'</span><span class="keyword">.</span><span class="default">DIRECTORY_SEPARATOR</span><span class="keyword">.</span><span class="default">$className</span><span class="keyword">.</span><span class="string">'.php'</span><span class="keyword">,<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">APPLICATION_PATH</span><span class="keyword">.</span><span class="string">'models'</span><span class="keyword">.</span><span class="default">DIRECTORY_SEPARATOR</span><span class="keyword">.</span><span class="default">$className</span><span class="keyword">.</span><span class="string">'.php'</span><span class="keyword">,<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">APPLICATION_PATH</span><span class="keyword">.</span><span class="string">'views'</span><span class="keyword">.</span><span class="default">DIRECTORY_SEPARATOR</span><span class="keyword">.</span><span class="default">$className</span><span class="keyword">.</span><span class="string">'.php'</span><span class="keyword">,<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$className</span><span class="keyword">.</span><span class="string">'.php'<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; foreach (</span><span class="default">$possibilities </span><span class="keyword">as </span><span class="default">$file</span><span class="keyword">) {<br />
...
&nbsp;&nbsp;&nbsp; return </span><span class="default">false</span><span class="keyword">;<br />
 ...
 <a name="101190"></a>
 <div class="note">
  <strong class='user'>b dot rense at gmail dot com</strong>
  <a href="#101190" class="date">01-Dec-2010 08:54</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
php autoloading is a b*tch, nevertheless, i think the following class is a pretty good solution.<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">class </span><span class="default">autoload_autoloader </span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; public static </span><span class="default">$instance</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; private </span><span class="default">$_src</span><span class="keyword">=array(</span><span class="string">'application/controllers/'</span><span class="keyword">, </span><span class="string">'application/models/'</span><span class="keyword">, </span><span class="string">'application/views/helpers/'</span><span class="keyword">, </span><span class="string">'library/'</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; private </span><span class="default">$_ext</span><span class="keyword">=array(</span><span class="string">'.php'</span><span class="keyword">, </span><span class="string">'class.php'</span><span class="keyword">, </span><span class="string">'lib.php'</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">/* initialize the autoloader class */<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public static function </span><span class="default">init</span><span class="keyword">(){<br />
...
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">/* put the custom functions in the autoload register when the class is initialized */<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">private function </span><span class="default">__construct</span><span class="keyword">(){<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">spl_autoload_register</span><span class="keyword">(array(</span><span class="default">$this</span><span class="keyword">, </span><span class="string">'clean'</span><span class="keyword">));<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">spl_autoload_register</span><span class="keyword">(array(</span><span class="default">$this</span><span class="keyword">, </span><span class="string">'dirty'</span><span class="keyword">));<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">/* the clean method to autoload the class without any includes, works in most cases */<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">private function </span><span class="default">clean</span><span class="keyword">(</span><span class="default">$class</span><span class="keyword">){<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; global </span><span class="default">$docroot</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$class</span><span class="keyword">=</span><span class="default">str_replace</span><span class="keyword">(</span><span class="string">'_'</span><span class="keyword">, </span><span class="string">'/'</span><span class="keyword">, </span><span class="default">$class</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">spl_autoload_extensions</span><span class="keyword">(</span><span class="default">implode</span><span class="keyword">(</span><span class="string">','</span><span class="keyword">, </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">_ext</span><span class="keyword">));<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; foreach(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">_src </span><span class="keyword">as </span><span class="default">$resource</span><span class="keyword">){<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">set_include_path</span><span class="keyword">(</span><span class="default">$docroot </span><span class="keyword">. </span><span class="default">$resource</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">spl_autoload</span><span class="keyword">(</span><span class="default">$class</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">/* the dirty method to autoload the class after including the php file containing the class */<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">private function </span><span class="default">dirty</span><span class="keyword">(</span><span class="default">$class</span><span class="keyword">){<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; global </span><span class="default">$docroot</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$class</span><span class="keyword">=</span><span class="default">str_replace</span><span class="keyword">(</span><span class="string">'_'</span><span class="keyword">, </span><span class="string">'/'</span><span class="keyword">, </span><span class="default">$class</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; foreach(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">_src </span><span class="keyword">as </span><span class="default">$resource</span><span class="keyword">){<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; foreach(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">_ext </span><span class="keyword">as </span><span class="default">$ext</span><span class="keyword">){<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; @include(</span><span class="default">$docroot </span><span class="keyword">. </span><span class="default">$resource </span><span class="keyword">. </span><span class="default">$class </span><span class="keyword">. </span><span class="default">$ext</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">spl_autoload</span><span class="keyword">(</span><span class="default">$class</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
...
Obviously you still have to include this class the dirty way, for example:<br />
<br />
<span class="default">&lt;?php<br />
<br />
$path</span><span class="keyword">=</span><span class="string">'../'</span><span class="keyword">;<br />
</span><span class="default">$docroot</span><span class="keyword">=</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'DOCUMENT_ROOT'</span><span class="keyword">] . </span><span class="default">implode</span><span class="keyword">(</span><span class="string">'/'</span><span class="keyword">,</span><span class="default">array_slice</span><span class="keyword">(</span><span class="default">explode</span><span class="keyword">(</span><span class="string">'/'</span><span class="keyword">,</span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'PHP_SELF'</span><span class="keyword">]),</span><span class="default">0</span><span class="keyword">,-</span><span class="default">2</span><span class="keyword">)) . </span><span class="string">'/'</span><span class="keyword">;<br />
include(</span><span class="default">$path </span><span class="keyword">. </span><span class="string">'library/autoload/autoloader.php'</span><span class="keyword">);<br />
</span><span class="default">autoload_autoloader</span><span class="keyword">::</span><span class="default">init</span><span class="keyword">();<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
please note that this autoloader class does require the $docroot variable which is the absolute path of the root of your application, you can set it manually or copy the code i used.<br />
<br />
...
<br />
 ...
 <a name="98687"></a>
 <div class="note">
  <strong class='user'>takingsides at gmail dot com</strong>
  <a href="#98687" class="date">30-Jun-2010 08:15</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
file_exists would work perfectly fine, unless people intentionally create directories ending with ".php". However sometimes classes can be called either "MyClass.php" or "MyClass.class.php"...<br />
<br />
I have a number of configuration constants defined (before the autoload function) i.e:<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="comment">// in: config.php<br />
</span><span class="default">define</span><span class="keyword">(</span><span class="string">'DEV_MODE'</span><span class="keyword">,&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; </span><span class="default">1</span><span class="keyword">);<br />
</span><span class="default">$error_reporting </span><span class="keyword">= </span><span class="default">error_reporting</span><span class="keyword">(</span><span class="default">DEV_MODE </span><span class="keyword">? </span><span class="default">E_ALL </span><span class="keyword">: </span><span class="default">0</span><span class="keyword">);<br />
<br />
</span><span class="default">define</span><span class="keyword">(</span><span class="string">'CONF_DIR_LIB'</span><span class="keyword">, </span><span class="string">'/path/to/classes/'</span><span class="keyword">);<br />
</span><span class="default">?&gt;<br />
</span><br />
Finally inside the config.php after my constants, i define the autoload...<br />
<br />
A. DEV_MODE when 1 or true, will show all errors.<br />
B. DEV_MODE when 0 or false, will supress ALL errors including those thrown from inside classes.<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="comment">// also in: config.php<br />
</span><span class="keyword">function </span><span class="default">__autoload</span><span class="keyword">(</span><span class="default">$f</span><span class="keyword">)<br />
{<br />
&nbsp;&nbsp;&nbsp; if ((</span><span class="default">$f1 </span><span class="keyword">= </span><span class="default">file_exists</span><span class="keyword">(</span><span class="default">$c1 </span><span class="keyword">= </span><span class="default">CONF_DIR_LIB </span><span class="keyword">. </span><span class="string">"$f.class.php"</span><span class="keyword">))<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; || (</span><span class="default">$f2 </span><span class="keyword">= </span><span class="default">file_exists</span><span class="keyword">(</span><span class="default">$c2 </span><span class="keyword">= </span><span class="default">CONF_DIR_LIB </span><span class="keyword">. </span><span class="string">"$f.php"</span><span class="keyword">)))<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; if (</span><span class="default">DEV_MODE</span><span class="keyword">)<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; include_once (</span><span class="default">$f1 </span><span class="keyword">? </span><span class="default">$c1 </span><span class="keyword">: </span><span class="default">$c2</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; else<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; @include_once (</span><span class="default">$f1 </span><span class="keyword">? </span><span class="default">$c1 </span><span class="keyword">: </span><span class="default">$c2</span><span class="keyword">);<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
I hope this helps anyone :)</span>
</code></div>
  </div>
 </div>
 <a name="97862"></a>
 <div class="note">
  <strong class='user'>DaWG</strong>
  <a href="#97862" class="date">12-May-2010 09:21</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Be careful with the use of file_exists, if there were a directory with the name ($classname . "php") then file_exists would return true. (is_file "may" be preferred, YMMV).<br />
<span class="default">&lt;?php <br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">if (</span><span class="default">is_file</span><span class="keyword">(</span><span class="default">$className </span><span class="keyword">. </span><span class="string">'.php'</span><span class="keyword">)) { ... <br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
  </div>
...
It's worth to mention, if your operating system is case-sensitive you need to name your file with same case as in source code eg. MyClass.php instead of myclass.php</span>
 ...
 <a name="95279"></a>
 <div class="note">
  <strong class='user'>EastGhostCom</strong>
  <a href="#95279" class="date">23-Dec-2009 09:04</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
IMPORTANT: Look into spl_autoload_register() which lets you manage a stack of several __autoload() functions.</span>
</code></div>
  </div>
 </div>
 <a name="94441"></a>
...
&nbsp;&nbsp;&nbsp; }<br />
 ...
 <a name="93057"></a>
 <div class="note">
  <strong class='user'>h762017(at)stud(dot)u-szeged(dot)hu</strong>
  <a href="#93057" class="date">20-Aug-2009 07:24</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Hi,<br />
<br />
Because the scripting engine just find the class declaration in the body of the __autoload() function, you also can declare the missing class in the __autoload() function. (No need to include or require a file.)<br />
<br />
Let's see the following code:<br />
<br />
Example 1.:<br />
<br />
<span class="default">&lt;?php<br />
...
&nbsp;&nbsp;&nbsp; echo </span><span class="string">"Now loading: $className&lt;br /&gt;"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; class </span><span class="default">SuperClass </span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
class </span><span class="default">DerivedClass </span><span class="keyword">extends </span><span class="default">SuperClass </span><span class="keyword">{<br />
}<br />
<br />
class </span><span class="default">AnotherDerivedClass </span><span class="keyword">extends </span><span class="default">SuperClass </span><span class="keyword">{<br />
}<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
The scripting engine will found the SuperClass class.<br />
<br />
Example 2.:<br />
<br />
You also can do it with the eval function, and if you dinamycally declare the class, you don't get a Fatal Error, and you can do many interesting things with the eval function;)<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">function </span><span class="default">__autoload</span><span class="keyword">(</span><span class="default">$className</span><span class="keyword">){<br />
&nbsp;&nbsp;&nbsp; echo </span><span class="string">"Now loading: $className&lt;br /&gt;"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; eval(</span><span class="string">"class $className {}"</span><span class="keyword">);<br />
}<br />
<br />
class </span><span class="default">DerivedClass </span><span class="keyword">extends </span><span class="default">SuperClass </span><span class="keyword">{<br />
}<br />
...
&nbsp;&nbsp; else<br />
&nbsp;&nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; die </span><span class="string">"SORRY&nbsp; $func IS NOT USABLE"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; }<br />
&nbsp;<br />
...
// returns 3 if add function defined in add.php sums the first and second parameter..</span>
 ...
 <a name="91119"></a>
 <div class="note">
  <strong class='user'>ranskills at yahoo dot co dot uk</strong>
  <a href="#91119" class="date">26-May-2009 04:02</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
This custom autoload function allows for the flexibility to add directories from which the classes are expected to be found and loads classes/interfaces with different file naming formats. Additionally, it handles classes included in the include path and files in the PEAR package/directory.<br />
You can check this blog entry for a video tutorial <a href="http://ranskills.com/blog/." rel="nofollow" target="_blank">http://ranskills.com/blog/.</a><br />
<br />
<span class="default">&lt;?php<br />
</span><span class="comment">/**<br />
&nbsp;*<br />
&nbsp;* @param string $className Class or Interface name automatically<br />
&nbsp;*&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; passed to this function by the PHP Interpreter<br />
&nbsp;*/<br />
</span><span class="keyword">function </span><span class="default">autoLoader</span><span class="keyword">(</span><span class="default">$className</span><span class="keyword">){<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">//Directories added here must be <br />
//relative to the script going to use this file. <br />
//New entries can be added to this list<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$directories </span><span class="keyword">= array(<br />
&nbsp;&nbsp; &nbsp;&nbsp; </span><span class="string">''</span><span class="keyword">,<br />
&nbsp;&nbsp; &nbsp;&nbsp; </span><span class="string">'classes/'<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">);<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">//Add your file naming formats here<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$fileNameFormats </span><span class="keyword">= array(<br />
&nbsp;&nbsp; &nbsp;&nbsp; </span><span class="string">'%s.php'</span><span class="keyword">,<br />
&nbsp;&nbsp; &nbsp;&nbsp; </span><span class="string">'%s.class.php'</span><span class="keyword">,<br />
&nbsp;&nbsp; &nbsp;&nbsp; </span><span class="string">'class.%s.php'</span><span class="keyword">,<br />
&nbsp;&nbsp; &nbsp;&nbsp; </span><span class="string">'%s.inc.php'<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">);<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// this is to take care of the PEAR style of naming classes<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$path </span><span class="keyword">= </span><span class="default">str_ireplace</span><span class="keyword">(</span><span class="string">'_'</span><span class="keyword">, </span><span class="string">'/'</span><span class="keyword">, </span><span class="default">$className</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; if(@include_once </span><span class="default">$path</span><span class="keyword">.</span><span class="string">'.php'</span><span class="keyword">){<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; foreach(</span><span class="default">$fileNameFormats </span><span class="keyword">as </span><span class="default">$fileNameFormat</span><span class="keyword">){<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$path </span><span class="keyword">= </span><span class="default">$directory</span><span class="keyword">.</span><span class="default">sprintf</span><span class="keyword">(</span><span class="default">$fileNameFormat</span><span class="keyword">, </span><span class="default">$className</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; if(</span><span class="default">file_exists</span><span class="keyword">(</span><span class="default">$path</span><span class="keyword">)){<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; include_once </span><span class="default">$path</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; return;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; }<br />
...
<br />
</span><span class="default">spl_autoload_register</span><span class="keyword">(</span><span class="string">'autoLoader'</span><span class="keyword">);<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
  </div>
 ...
 <a name="90588"></a>
 <div class="note">
  <strong class='user'>contact at casual-web dot com</strong>
  <a href="#90588" class="date">29-Apr-2009 09:22</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Hi,<br />
<br />
To include all classes from differents directories, you can specify the path in the name of class.The replace a caracter of your choice by '/'. Here I used "_".<br />
<br />
ex : the class : dir1_dir2_myclass.class.php will be in dir1/dir2/<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">__autoload</span><span class="keyword">(</span><span class="default">$className</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; <br />
</span><span class="default">$fullclasspath</span><span class="keyword">=</span><span class="string">""</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp;&nbsp; <br />
</span><span class="comment">// get separated directories<br />
</span><span class="default">$pathchunks</span><span class="keyword">=</span><span class="default">explode</span><span class="keyword">(</span><span class="string">"_"</span><span class="keyword">,</span><span class="default">$className</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; <br />
</span><span class="comment">//re-build path without last item<br />
</span><span class="keyword">for(</span><span class="default">$i</span><span class="keyword">=</span><span class="default">0</span><span class="keyword">;</span><span class="default">$i</span><span class="keyword">&lt;(</span><span class="default">count</span><span class="keyword">(</span><span class="default">$pathchunks</span><span class="keyword">)-</span><span class="default">1</span><span class="keyword">);</span><span class="default">$i</span><span class="keyword">++) {<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$fullclasspath</span><span class="keyword">.=</span><span class="default">$pathchunks</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">].</span><span class="string">'/'</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
require_once </span><span class="string">'../../'</span><span class="keyword">.</span><span class="default">$fullclasspath</span><span class="keyword">.</span><span class="default">$className</span><span class="keyword">.</span><span class="string">'.class.php'</span><span class="keyword">;&nbsp; &nbsp; <br />
}<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; include </span><span class="string">"./packages/$class_name.php"</span><span class="keyword">;<br />
}<br />
</span><span class="default">?&gt;<br />
...
Just use require(), which will be better on performance as well as it does not have to check if it is unique.</span>
 ...
 <a name="89173"></a>
 <div class="note">
  <strong class='user'>adam at greatbigmassive dot net</strong>
  <a href="#89173" class="date">25-Feb-2009 03:31</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I've been playing with the idea of automatically running the __construct() function after initiating a static/singleton class.<br />
As we know, it doesn't run unless you create new instance() of the class which doesn't happen on the singleton method.<br />
<br />
I've seen the methods of using the "getInstance" call but this is a manual call that I wanted to avoid. As an additional idea I've done this and would be interested in opinions. Seems to work for me and my framework and it means I don't have to run the __construct() manually via the internal "new self" method. Obviously, in this case, I probably don't even need to call the booter function __construct() but for relationship recognition I have.<br />
<br />
Basic idea<br />
----------<br />
Make the __construct() protected instead of private.<br />
This means an extended class can access/override it.<br />
<br />
Then, in autoload, I use eval to extend the class I've just initiated which simply runs the parent __construct() if it exists..<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">__autoload</span><span class="keyword">(</span><span class="default">$class</span><span class="keyword">){<br />
&nbsp;&nbsp;&nbsp; require_once(</span><span class="default">INC_FILES</span><span class="keyword">.</span><span class="string">"/class/class."</span><span class="keyword">.</span><span class="default">$class</span><span class="keyword">.</span><span class="string">".php"</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; if(</span><span class="default">method_exists</span><span class="keyword">(</span><span class="default">$class</span><span class="keyword">,</span><span class="string">'__construct'</span><span class="keyword">)){<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; eval(</span><span class="string">"class al_$class extends $class{function __construct(){parent::__construct();}}new al_$class;"</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; return </span><span class="default">true</span><span class="keyword">;<br />
}<br />
</span><span class="default">?&gt;</span>
...
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; require(</span><span class="string">"class.$cls.php"</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
Tested on Linux with PHP 5.1.6 and 5.2.5.</span>
 ...
 <a name="85720"></a>
 <div class="note">
  <strong class='user'>andrzeje from wit.edu.pl</strong>
  <a href="#85720" class="date">13-Sep-2008 08:18</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Throwing versions of __autoload based on eval will fail if __autoload will be caled with interface name.<br />
<span class="default">&lt;?php<br />
</span><span class="comment">/* eval+throw __autoload<br />
&nbsp;*/<br />
</span><span class="keyword">class </span><span class="default">Cls </span><span class="keyword">implements </span><span class="default">Iface </span><span class="keyword">{</span><span class="comment">/* ... */</span><span class="keyword">}; </span><span class="comment">// Error<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
  </div>
 ...
 <div class="note">
  ...
  <a href="#85289" class="date">23-Aug-2008 04:09</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
When __autoload doesn't seem to work or if you are in PHP 4:<br />
<br />
<span class="default">&lt;?php<br />
$include_paths </span><span class="keyword">= </span><span class="default">explode</span><span class="keyword">( </span><span class="default">PATH_SEPARATOR </span><span class="keyword">, </span><span class="default">get_include_path</span><span class="keyword">() );<br />
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$d </span><span class="keyword">= </span><span class="default">opendir</span><span class="keyword">( </span><span class="default">$path </span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; while (</span><span class="default">false </span><span class="keyword">!== (</span><span class="default">$f </span><span class="keyword">= </span><span class="default">readdir</span><span class="keyword">(</span><span class="default">$d</span><span class="keyword">))) {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; if( </span><span class="default">ereg</span><span class="keyword">( </span><span class="string">"^.*\.php$" </span><span class="keyword">, </span><span class="default">$f </span><span class="keyword">) &amp;&amp; </span><span class="default">strstr</span><span class="keyword">( </span><span class="default">$path </span><span class="keyword">, </span><span class="default">ABS_PATH </span><span class="keyword">) ) { </span><span class="comment">## avoid PEAR and other files for automatic requirement<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">require_once </span><span class="default">$f</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">closedir</span><span class="keyword">(</span><span class="default">$d</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; }<br />
<br />
</span><span class="comment">// replace ABS_PATH with your app root<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
  </div>
...
&nbsp;&nbsp;&nbsp; }<br />
 ...
 <a name="82860"></a>
 <div class="note">
  <strong class='user'>Chris Continanza</strong>
  <a href="#82860" class="date">29-Apr-2008 11:43</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Decided to warm up to autoload,<br />
but wanted it to use the include_path.<br />
Good default behavior.<br />
<br />
function __autoload($class_name) {<br />
&nbsp;&nbsp; &nbsp;&nbsp; $include_path = get_include_path();<br />
&nbsp;&nbsp; &nbsp;&nbsp; $include_path_tokens = explode(':', $include_path);<br />
&nbsp;&nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp;&nbsp; foreach($include_path_tokens as $prefix){<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; $path = $prefix . '/' . $class_name . '.php';<br />
...
&nbsp;&nbsp;&nbsp; }</span>
 ...
 <a name="80750"></a>
 <div class="note">
  <strong class='user'>jjfitzgerald at gmail dot com</strong>
  <a href="#80750" class="date">30-Jan-2008 07:39</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Regardless of the situation you're in (developing a web-app or writing some code that may use someone else's web-app), always a good idea not to use __autoload() but instead write a differently-named function and register it as an autoloader:<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">function </span><span class="default">class_autoloader</span><span class="keyword">(</span><span class="default">$c</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; if(</span><span class="default">file_exists</span><span class="keyword">(</span><span class="default">dirname</span><span class="keyword">(</span><span class="default">__FILE__</span><span class="keyword">). </span><span class="string">"/classes/{$c}.php"</span><span class="keyword">) &amp;&amp; include_once(</span><span class="default">dirname</span><span class="keyword">(</span><span class="default">__FILE__</span><span class="keyword">). </span><span class="string">"/classes/{$c}.php"</span><span class="keyword">)) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">true</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; } else {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">trigger_error</span><span class="keyword">(</span><span class="string">"Could not load class '{$c}' from file '{$c}.php'"</span><span class="keyword">, </span><span class="default">E_USER_WARNING</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">false</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="default">spl_autoload_register</span><span class="keyword">(</span><span class="string">"class_autoloader"</span><span class="keyword">);<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
Using spl_autoload_register(), the function class_autoloader() will now be used when classes are instantiated, just like __autoload() does, but without the potential conflict with other web-apps __autoload() function.</span>
</code></div>
  </div>
 </div>
 <a name="80670"></a>
...
Though, it may be dangerous on some cases regarding the dependencies, load order, etc. Carefully design your classes.</span>
 ...
 <a name="80445"></a>
 <div class="note">
  <strong class='user'>Mexi-Fry</strong>
  <a href="#80445" class="date">16-Jan-2008 05:19</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Seems like a strange layer of obscurity to me (to be honest).&nbsp; It would be really handy if that could be implemented and remain in memory though, enabling pages to instantiate classes without having to repeatedly include documents.&nbsp; Being able to construct an object without having to include the document that contained it (AND without having to include that function in some form on each document) would be very nice.</span>
</code></div>
  </div>
 </div>
 <a name="80369"></a>
 <div class="note">
  <strong class='user'>boltclock aInACircle NOVALISTIC dot com</strong>
  <a href="#80369" class="date">11-Jan-2008 09:31</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
You can allow __autoload() to throw exceptions without resulting in fatal errors by trying class_exists(), literally.<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">function </span><span class="default">__autoload</span><span class="keyword">(</span><span class="default">$class</span><span class="keyword">)<br />
{<br />
&nbsp;&nbsp;&nbsp; if (</span><span class="default">file_exists</span><span class="keyword">(</span><span class="default">$file </span><span class="keyword">= </span><span class="string">"./inc/$class.php"</span><span class="keyword">))<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; include(</span><span class="default">$file</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; else<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">"Class $class not found"</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="comment">// By 'literally', I mean this<br />
</span><span class="keyword">try<br />
{<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// Since the second argument defaults to true, __autoload()<br />
&nbsp;&nbsp;&nbsp; // will be called from this function<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">class_exists</span><span class="keyword">(</span><span class="string">'MyClass'</span><span class="keyword">);<br />
}<br />
catch (</span><span class="default">Exception $e</span><span class="keyword">)<br />
{<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// Catch the exception and handle it as usual<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">die(</span><span class="default">$e</span><span class="keyword">-&gt;</span><span class="default">getMessage</span><span class="keyword">());<br />
}<br />
<br />
</span><span class="comment">// Safely initialize an object from the class<br />
...
<br />
 ...
 <div class="note">
  ...
  <a href="#79928" class="date">19-Dec-2007 02:46</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
To sandrejev at gmail dot com below: <br />
<br />
if you create the exception in the __autoload() and serialize it, then when you try to access the same missing class later (in another place in the code), then the exception will contain invalid stack trace.<br />
<br />
Also, here's an excellent blog post that discusses the consequences of using eval() as well as provides an example to handle static method calls and namespaces: <a href="http://www.onphp5.com/article/61" rel="nofollow" target="_blank">http://www.onphp5.com/article/61</a></span>
</code></div>
  </div>
 </div>
 <a name="79611"></a>
...
do not use is_subclass_of() in your __autoload() function to identify a class type and thereby its path (f.e exceptions). is_subclass_of() needs to know the class, but you want to check BEFORE you include the class.</span>
 ...
 <a name="77651"></a>
 <div class="note">
  <strong class='user'>knoopx at gmail dot com</strong>
  <a href="#77651" class="date">06-Sep-2007 12:56</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Quick and easiest way to be able to throw exceptions on __autoload() method:<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">__autoload</span><span class="keyword">(</span><span class="default">$class_name</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; </span><span class="default">find_file</span><span class="keyword">(</span><span class="default">$class_name</span><span class="keyword">); </span><span class="comment">//your own routine to locate the class file<br />
&nbsp;&nbsp; &nbsp; </span><span class="keyword">if (!</span><span class="default">class_exists</span><span class="keyword">(</span><span class="default">$class_name</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">)) {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; eval(</span><span class="string">"class $class_name {}"</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">'Class not found'</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; }<br />
}<br />
</span><span class="default">?&gt;</span>
</span>
 ...
 <a name="77471"></a>
 <div class="note">
  <strong class='user'>rlee0001 at sbcglobal dot net</strong>
  <a href="#77471" class="date">30-Aug-2007 01:16</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
If you would like __autoload to throw an exception when the class cannot be loaded instead of causing a fatal error, consider this:<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">__autoload </span><span class="keyword">(</span><span class="default">$className</span><span class="keyword">)<br />
{<br />
...
&nbsp;&nbsp;&nbsp; </span><span class="default">$status </span><span class="keyword">= (@include_once </span><span class="default">$fileName</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; if (</span><span class="default">$status </span><span class="keyword">=== </span><span class="default">false</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; eval(</span><span class="default">sprintf</span><span class="keyword">(</span><span class="string">'class %s {func' </span><span class="keyword">. </span><span class="string">'tion __construct(){throw new Project_Exception_AutoLoad("%s");}}'</span><span class="keyword">, </span><span class="default">$className</span><span class="keyword">, </span><span class="default">$className</span><span class="keyword">));<br />
&nbsp;&nbsp;&nbsp; }&nbsp;&nbsp; <br />
}<br />
<br />
</span><span class="default">$pageController </span><span class="keyword">= </span><span class="string">'Project_My_Class'</span><span class="keyword">; </span><span class="comment">// "Project/My/Class.php"<br />
<br />
</span><span class="keyword">try {<br />
&nbsp; </span><span class="default">$obj </span><span class="keyword">= new </span><span class="default">$pageController</span><span class="keyword">();<br />
} catch (</span><span class="default">Project_Exception_AutoLoad $e</span><span class="keyword">) {<br />
...
&nbsp;&nbsp;&nbsp; </span><span class="default">printf</span><span class="keyword">(</span><span class="string">'&lt;h1&gt;Not Found&lt;/h1&gt;&lt;p&gt;The requested page %s was not found on this server.&lt;/p&gt;&lt;hr /&gt;&lt;em&gt;$id$&lt;/em&gt;'</span><span class="keyword">, </span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'REQUEST_URI'</span><span class="keyword">]);<br />
}<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
 ...
 <a name="76458"></a>
 <div class="note">
  <strong class='user'>emcmanus at gmail dot com</strong>
  <a href="#76458" class="date">16-Jul-2007 06:04</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Note: if you're experiencing unexpected "failed opening required 'filename.php' (include..." errors:<br />
<br />
If you placed your autoload function in an external file which you're requiring at the head of every script, be cautious of some odd behavior regarding PHP's idea of the current working directory.<br />
<br />
I ran into some unexpected path issues when my include file was placed in a subdirectory directory. The solution to my problems was to make sure that the autoload script being included is in the same directory as the calling script.</span>
</code></div>
  </div>
 </div>
 <a name="75832"></a>
...
To remedy this, everyone should look at the spl_autoload functions, eg: spl_autoload_register. This function allows more than one custom functions to be called through the default spl_autoload (default __autoload) handler.</span>
 ...
 <div class="note">
  ...
  <a href="#74026" class="date">21-Mar-2007 03:54</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Another workaround for Exception problem (Klaus Schneider style)<br />
<br />
<span class="default">&lt;?php<br />
define</span><span class="keyword">(</span><span class="string">'CLASS_DIR'</span><span class="keyword">, </span><span class="string">'php/classes/'</span><span class="keyword">);<br />
function </span><span class="default">__autoload</span><span class="keyword">(</span><span class="default">$name</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; if(</span><span class="default">$exists </span><span class="keyword">= !</span><span class="default">class_exists</span><span class="keyword">(</span><span class="default">$name</span><span class="keyword">) &amp;&amp; </span><span class="default">file_exists</span><span class="keyword">(</span><span class="default">$class </span><span class="keyword">= </span><span class="default">CLASS_DIR</span><span class="keyword">.</span><span class="default">$name</span><span class="keyword">.</span><span class="string">'.class.php'</span><span class="keyword">))<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; require </span><span class="default">$class</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; elseif(!</span><span class="default">$exists</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; eval(</span><span class="string">'class '</span><span class="keyword">.</span><span class="default">$name</span><span class="keyword">.</span><span class="string">' extends Exception {}'</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; throw new </span><span class="default">$name</span><span class="keyword">(</span><span class="string">'[__autoload] this file doesn\'t exists: '</span><span class="keyword">.</span><span class="default">$class</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
try {<br />
&nbsp;&nbsp;&nbsp; new </span><span class="default">Undefined</span><span class="keyword">;<br />
}<br />
catch(</span><span class="default">Undefined $e</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; echo </span><span class="default">$e</span><span class="keyword">-&gt;</span><span class="default">getMessage</span><span class="keyword">();<br />
}<br />
</span><span class="comment">// You should use generic Exception too<br />
...
&nbsp;&nbsp;&nbsp; echo </span><span class="default">$e</span><span class="keyword">-&gt;</span><span class="default">getMessage</span><span class="keyword">();<br />
 ...
 <a name="73561"></a>
 <div class="note">
  <strong class='user'>Klaus Schneider</strong>
  <a href="#73561" class="date">01-Mar-2007 07:35</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I just stumbled over one quite nice solution to the __autoload-exception problem.&nbsp; It allows for any kind of exception to be thrown inside __autoload().<br />
<br />
It appears one has to define the requested class (using "eval", which is not nice but inevitable here) and after that can simply throw an exception (and catch it if so desired):<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">__autoload</span><span class="keyword">(</span><span class="default">$className</span><span class="keyword">)<br />
{<br />
&nbsp;&nbsp; </span><span class="comment">// Do your stuff to load a class here, set $ok if everything went fine.<br />
&nbsp;&nbsp; </span><span class="keyword">if (! </span><span class="default">$ok</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp;&nbsp; eval(</span><span class="string">"class $className{};"</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp;&nbsp; throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">'My message'</span><span class="keyword">);<br />
&nbsp;&nbsp; } </span><span class="comment">// if<br />
</span><span class="keyword">}<br />
<br />
try {<br />
&nbsp;&nbsp; </span><span class="default">UndefinedClass</span><span class="keyword">::</span><span class="default">undefinedFunction</span><span class="keyword">();<br />
} catch (</span><span class="default">Exception $ex</span><span class="keyword">) {<br />
&nbsp;&nbsp; echo </span><span class="default">$ex</span><span class="keyword">-&gt;</span><span class="default">getMessage</span><span class="keyword">();<br />
} </span><span class="comment">// try/catch<br />
</span><span class="default">?&gt;<br />
</span><br />
Output: "My Message".&nbsp; <br />
<br />
:-)</span>
</code></div>
  </div>
...
&nbsp;&nbsp;&nbsp; return 0;<br />
 ...
 <div class="note">
  ...
  <a href="#71031" class="date">08-Nov-2006 11:23</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Here is the most complete version of __autoload exception i guess.<br />
The best thing is that it can throw any exception plus the exception is fully functional.<br />
<br />
<span class="default">&lt;?php<br />
...
<br />
class </span><span class="default">AutoloadExceptionRetranslator </span><span class="keyword">extends </span><span class="default">Exception<br />
</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">__construct</span><span class="keyword">(</span><span class="default">$serializedException</span><span class="keyword">)<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; throw </span><span class="default">unserialize</span><span class="keyword">(</span><span class="default">$serializedException</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
...
{<br />
&nbsp;&nbsp;&nbsp; if(!</span><span class="default">file_exists</span><span class="keyword">(</span><span class="default">$classname</span><span class="keyword">))<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$autoloadException </span><span class="keyword">= </span><span class="default">serialize</span><span class="keyword">(new </span><span class="default">AutoloadException</span><span class="keyword">(</span><span class="string">"Class $classname could not be found"</span><span class="keyword">));<br />
<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return eval(</span><span class="string">"<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; class $classname<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; function __construct(\$a=0, \$b=0, \$c=0, \$d=0, \$e=0, \$f=0, \$g=0, \$h=0, \$i=0)<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; throw new AutoloadExceptionRetranslator('$autoloadException');<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; "</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; else<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; require_once </span><span class="default">$classname</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
try<br />
{<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$anyObject </span><span class="keyword">= new </span><span class="default">AnyNonExistantClass</span><span class="keyword">();<br />
}<br />
catch (</span><span class="default">AutoloadException $e</span><span class="keyword">)<br />
{<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$e</span><span class="keyword">-&gt;</span><span class="default">getTrace</span><span class="keyword">());<br />
}<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
 ...
 <a name="70898"></a>
 <div class="note">
  <strong class='user'>andrew dot delete dot cornes at gmail dot delete dot com</strong>
  <a href="#70898" class="date">03-Nov-2006 04:26</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
If you'd like '__autoload()' to support multiple class folders, each containing multiple class files (one per class), you may want to try something like this (file '__autoload.php'):<br />
<br />
<span class="default">&lt;?php<br />
<br />
define</span><span class="keyword">(</span><span class="string">'CLASS_FILENAME_SUFFIX'</span><span class="keyword">, </span><span class="string">'.class.php'</span><span class="keyword">);<br />
<br />
function </span><span class="default">__autoload</span><span class="keyword">(</span><span class="default">$className</span><span class="keyword">)<br />
{<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$__autoloadAbsolutePath </span><span class="keyword">= </span><span class="default">dirname</span><span class="keyword">(</span><span class="default">__FILE__</span><span class="keyword">);<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// 'pathStart' is your web application root folder.<br />
&nbsp;&nbsp;&nbsp; // (This may or may not be where '__autoload.php'<br />
&nbsp;&nbsp;&nbsp; // resides; let's assume here that it resides one<br />
&nbsp;&nbsp;&nbsp; // level 'below' the web app root.)<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$pathStart </span><span class="keyword">= </span><span class="default">$__autoloadAbsolutePath </span><span class="keyword">.<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">DIRECTORY_SEPARATOR </span><span class="keyword">. </span><span class="string">'..' </span><span class="keyword">. </span><span class="default">DIRECTORY_SEPARATOR</span><span class="keyword">;<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// 'classPath' is a list of class folders to look in.<br />
&nbsp;&nbsp;&nbsp; // (In this example, there's just one: 'classlibs/lib1'.<br />
&nbsp;&nbsp;&nbsp; // To add more, simply append them; start with<br />
&nbsp;&nbsp;&nbsp; // 'PATH_SEPARATOR . $pathStart .', and off you go...)<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$classPath </span><span class="keyword">= </span><span class="default">PATH_SEPARATOR </span><span class="keyword">. </span><span class="default">$pathStart </span><span class="keyword">.<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="string">'classlibs' </span><span class="keyword">. </span><span class="default">DIRECTORY_SEPARATOR </span><span class="keyword">. </span><span class="string">'lib1'</span><span class="keyword">;<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// Add list of class folders to 'include_path' for the<br />
&nbsp;&nbsp;&nbsp; // forthcoming 'require()' (or similar directive).<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$oldIncludePath </span><span class="keyword">= </span><span class="default">get_include_path</span><span class="keyword">();<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">set_include_path</span><span class="keyword">(</span><span class="default">$oldIncludePath </span><span class="keyword">. </span><span class="default">$classPath</span><span class="keyword">);<br />
<br />
&nbsp;&nbsp;&nbsp; require_once(</span><span class="default">$className </span><span class="keyword">. </span><span class="default">CLASS_FILENAME_SUFFIX</span><span class="keyword">);<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// Reinstate initial 'include_path'.<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">set_include_path</span><span class="keyword">(</span><span class="default">$oldIncludePath</span><span class="keyword">);<br />
}<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
As your web application develops, new paths containing class files can be added into the '$classPath' variable within '__autoload()'. If hard-coding the '$classPath' variable isn't to your taste, you could arrange for its value to come from 'outside' in whatever way you like.<br />
<br />
Any comments gratefully received.</span>
</code></div>
  </div>
 </div>
 <a name="69514"></a>
...
You can enable this behaviour for undefined classes while unserializing objects by setting the .ini-variable 'unserialize_callback_func' to '__autoload'.</span>
 ...
 <div class="note">
  ...
  <a href="#56974" class="date">20-Sep-2005 11:42</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
The autoload-feature allows to add the behavior of static constructors (like in C#). Static constructors should be called on the first occurence of a class reference - typically a 'new' operator or a static call to a class's operation.<br />
<br />
They can be used used to initialize complex static properties.<br />
<br />
And here is an easy and save way how it can be done:<br />
<br />
Content of MyClass.class.php5:<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="comment">// demo class persisting of a static and a dynamic constructor<br />
</span><span class="keyword">class </span><span class="default">MyClass<br />
</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// static constructor operation<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public static function </span><span class="default">_construct</span><span class="keyword">()<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment">// just say hello<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">echo </span><span class="string">'&lt;div&gt;static constructor&lt;/div&gt;'</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// default dynamic constructor operation<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">__construct</span><span class="keyword">()<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment">// just say hello<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">echo </span><span class="string">'&lt;div&gt;dynamic constructor&lt;/div&gt;'</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
}<br />
<br />
...
Content of index.php5:<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="comment">// declare handler for any unknown class request<br />
</span><span class="keyword">function </span><span class="default">__autoload</span><span class="keyword">(</span><span class="default">$aClassName</span><span class="keyword">)<br />
{<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// load the class<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">require_once (</span><span class="default">$aClassName </span><span class="keyword">. </span><span class="string">'.class.php5'</span><span class="keyword">);<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// create a reference to the static constructor's operation<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$staticConstructorReference </span><span class="keyword">= array(</span><span class="default">$aClassName</span><span class="keyword">, </span><span class="string">'_construct'</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// if the static constructor was declared properly...<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">if (</span><span class="default">is_callable</span><span class="keyword">(</span><span class="default">$staticConstructorReference</span><span class="keyword">))<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment">// call the static constructor<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">call_user_func</span><span class="keyword">(</span><span class="default">$staticConstructorReference</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="comment">// create an example object to see both constructors being executed<br />
</span><span class="default">$article </span><span class="keyword">= new </span><span class="default">MyObject</span><span class="keyword">();<br />
<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
 ...
 <a name="52517"></a>
 <div class="note">
  <strong class='user'>scott at webscott dot com</strong>
  <a href="#52517" class="date">04-May-2005 05:40</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
__autoload() seems to work when saving objects as session variables as well:<br />
<br />
classLoader.php<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">__autoload</span><span class="keyword">(</span><span class="default">$className</span><span class="keyword">) {<br />
&nbsp; require_once(</span><span class="string">"$className.php"</span><span class="keyword">);<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
testClass.php<br />
...
&nbsp; function </span><span class="default">__construct</span><span class="keyword">(</span><span class="default">$propValue</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">prop1 </span><span class="keyword">= </span><span class="default">$propValue</span><span class="keyword">;<br />
&nbsp; }<br />
<br />
&nbsp; function </span><span class="default">showProp</span><span class="keyword">() {<br />
&nbsp;&nbsp;&nbsp; return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">prop1</span><span class="keyword">;<br />
&nbsp; }<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
page1.php<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">require_once(</span><span class="string">'classLoader.php'</span><span class="keyword">);<br />
</span><span class="default">session_start</span><span class="keyword">();<br />
</span><span class="default">$_SESSION</span><span class="keyword">[</span><span class="string">'testObj'</span><span class="keyword">] = new </span><span class="default">testClass</span><span class="keyword">(</span><span class="string">'foo'</span><span class="keyword">);<br />
echo </span><span class="string">'&lt;a href="page2.php"&gt;Go to page 2&lt;/a&gt;'</span><span class="keyword">;<br />
</span><span class="default">?&gt;<br />
</span><br />
page2.php<br />
<span class="default">&lt;?php<br />
...
echo </span><span class="default">$_SESSION</span><span class="keyword">[</span><span class="string">'testObj'</span><span class="keyword">]-&gt;</span><span class="default">showProp</span><span class="keyword">(); </span><span class="comment">// displays foo<br />
</span><span class="default">?&gt;<br />
</span><br />
Works with multiple session objects as well.&nbsp; Tested on a Win2k/IIS machine.</span>
</code></div>
  </div>
 </div>
 <a name="49576"></a>
 <div class="note">
  <strong class='user'>trini0</strong>
  <a href="#49576" class="date">01-Feb-2005 08:04</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Be careful with using that eval() trick within __autoload().<br />
If you use reflection in your code, the so called trick, <br />
*can* provide ill side effects.<br />
For example -&gt;<br />
$reflection = new reflectionClass('some_class');<br />
if (FALSE === $reflection-&gt;isSubClassOf('another_class'))<br />
{<br />
&nbsp;&nbsp;&nbsp; throw new Exception('Class "some_class" must extend base class "another_class"');<br />
}<br />
<br />
If the real class "another_class" doesnt exist at the time, or "some_class" doesn't extend "another_class", with the reflection test, the so called eval() trick, creates a dummy "another_class", <br />
thereby making the reflection test useless...</span>
</code></div>
  </div>
 </div>
 <a name="49496"></a>
...
Then you will just have to use the folder structure and name the classes accordingly. If you want to have a class named Page, which will be in the pseudo namespace System.Web.UI, create a directory named System in /classes, then create Web, then UI, then name the class System_Web_UI_Page. Kind of long to type if you don't have autocomplete, but at least you will not have to manage the loading of all the classes' definitions.</span>
 ...
 <div class="note">
  ...
  <a href="#49425" class="date">27-Jan-2005 06:31</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
If you want to throw an exception if a class isn't defined yet, use class_exists ():<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="comment">// See if the class is defined<br />
</span><span class="keyword">if (!</span><span class="default">class_exists </span><span class="keyword">(</span><span class="default">$className</span><span class="keyword">, </span><span class="default">false</span><span class="keyword">)) {<br />
&nbsp;&nbsp;&nbsp; throw new </span><span class="default">Exception </span><span class="keyword">(</span><span class="string">"Class $className is not defined."</span><span class="keyword">);<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
The second parameter indicates whether or not the __autoload () function should be called before checking for the class's existence.</span>
</code></div>
  </div>
 </div>
 <a name="48099"></a>
 <div class="note">
  <strong class='user'>nhartkamp at eljakim dot N0SP4M dot nl</strong>
  <a href="#48099" class="date">11-Dec-2004 09:14</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
The following might provide a good work-around for throwing exceptions from the __autoload function when a file containing the correct class doesn't exists.<br />
<br />
function __autoload ($class_name) {<br />
&nbsp; $file = 'system/objects/' . $class_name . '.inc.php';<br />
&nbsp; if (!file_exists ($file)) {<br />
&nbsp;&nbsp;&nbsp; return eval ("class $class_name {" .<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; "&nbsp; function $class_name () {" .<br />
...
Nolan</span>
 ...
 <div class="foot"><a href="/manual/add-note.php?sect=language.oop5.autoload&amp;redirect=http://www.php.net/manual/en/language.oop5.autoload.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.oop5.autoload&amp;redirect=http://www.php.net/manual/en/language.oop5.autoload.php">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.oop5.autoload.php">show source</a> |

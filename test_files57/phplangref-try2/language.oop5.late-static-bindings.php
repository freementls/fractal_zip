...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="language.oop5.typehinting.php" />
 <link rel="next" href="language.oop5.references.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/oop5.late-static-bindings" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/language.oop5.late-static-bindings.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="@w{8NWZZX39}" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.oop5.late-static-bindings.php">Late Static Bindings</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.oop5.references.php">Objects and references<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.oop5.typehinting.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Type Hinting</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.oop5.late-static-bindings.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
 <div class="langchooser">
  <form action="/manual/change.php" method="get">
   <p>view this page in </p><fieldset><select name="page">
    ...
    <option value="pl/language.oop5.late-static-bindings.php">Polish</option>
    <option value="ro/language.oop5.late-static-bindings.php">Romanian</option>
    <option value="ru/language.oop5.late-static-bindings.php">Russian</option>
    <option value="fa/language.oop5.late-static-bindings.php">Persian</option>
...
<div id="language.oop5.late-static-bindings" class="sect1">
  ...
  <p class="para">
   ...
   <a href="language.oop5.paamayim-nekudotayim.php" class="link"><em>::</em></a>
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.oop5.late-static-bindings&amp;redirect=@w{8NWZZX39}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.oop5.late-static-bindings&amp;redirect=@w{8NWZZX39}">add a note</a></small></span>
  <small>User Contributed Notes</small>
  <strong>Late Static Bindings</strong>
 </div><div id="allnotes">
 <a name="106289"></a>
 <div class="note">
  <strong class='user'>fchoquet at NOSPAM dot example dot com</strong>
  <a href="#106289" class="date">25-Oct-2011 06:36</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
A tricky behaviour of LSB:<br />
If you forget a "static" keywork in the method definition you can get very unexpected results.<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">class </span><span class="default">BaseClass </span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">callTest</span><span class="keyword">() {&nbsp; &nbsp; </span><span class="comment">// static accidentally omitted<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">static::</span><span class="default">test</span><span class="keyword">();<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; protected static function </span><span class="default">test</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">'BaseClass::test&lt;br /&gt;'</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
class </span><span class="default">ExtendedClass </span><span class="keyword">extends </span><span class="default">BaseClass </span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; protected static function </span><span class="default">test</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">'ExtendedClass::test&lt;br /&gt;'</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
class </span><span class="default">UserClass </span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">useExtendedClass</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">ExtendedClass</span><span class="keyword">::</span><span class="default">callTest</span><span class="keyword">(); </span><span class="comment">// Static call of the *acidentally* non static method<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">}<br />
<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">test</span><span class="keyword">() {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; echo </span><span class="string">'UserClass::test&lt;br /&gt;'</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="default">BaseClass</span><span class="keyword">::</span><span class="default">callTest</span><span class="keyword">();&nbsp; </span><span class="comment">// BaseClass::test, as expected<br />
<br />
</span><span class="default">ExtendedClass</span><span class="keyword">::</span><span class="default">callTest</span><span class="keyword">();&nbsp; </span><span class="comment">// ExtendedClass::test, as expected<br />
<br />
...
</span><span class="default">$userClass</span><span class="keyword">-&gt;</span><span class="default">useExtendedClass</span><span class="keyword">(); </span><span class="comment">// ExtendedClass::test is expected, but displays UserClass::test!!!<br />
<br />
 ...
 <div class="note">
  ...
  <a href="#103027" class="date">21-Mar-2011 06:37</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
In my opinion late static binding is an anti pattern but there are some benefits though:<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">class </span><span class="default">MyClass </span><span class="keyword">extends </span><span class="default">ClassReference<br />
</span><span class="keyword">{<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
MyClass::getQualifiedName() returns the full class name including namespace information. This prevents you from passing class names as plain strings and still lets you take advantage of code completion and type browsing.<br />
<br />
MyClass::cast() ensures the type of an object to be of a certain class. This is a kind of type hinting.<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">abstract class </span><span class="default">ClassReference<br />
</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; final public static function </span><span class="default">getQualifiedName</span><span class="keyword">()<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">get_called_class</span><span class="keyword">();<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; final public static function </span><span class="default">cast</span><span class="keyword">(</span><span class="default">$object</span><span class="keyword">)<br />
&nbsp;&nbsp;&nbsp; {<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; if (!</span><span class="default">is_object</span><span class="keyword">(</span><span class="default">$var</span><span class="keyword">) || !(</span><span class="default">$object </span><span class="keyword">instanceof </span><span class="default">$className</span><span class="keyword">))<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; throw new </span><span class="default">UnexpectedValueException</span><span class="keyword">(</span><span class="string">"Cast failed. Argument is not of type " </span><span class="keyword">. </span><span class="default">$className </span><span class="keyword">. </span><span class="string">"."</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
...
&nbsp;&nbsp;&nbsp; <br />
 ...
 <div class="note">
  ...
  <a href="#101310" class="date">09-Dec-2010 04:05</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
also works the same way with static variables and constants</span>
 ...
 <div class="note">
  <strong class='user'>jrfish dot x at gmail dot com</strong>
  <a href="#101309" class="date">09-Dec-2010 04:01</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
consider this:<br />
...
also works the same way with static variables and constants</span>
 ...
 <div class="note">
  ...
  <a href="#101077" class="date">24-Nov-2010 09:22</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
print </span><span class="string">"The call was: "</span><span class="keyword">. </span><span class="default">ChildClass</span><span class="keyword">::</span><span class="default">parent_method</span><span class="keyword">();<br />
 ...
 <div class="note">
  ...
  <a href="#100812" class="date">08-Nov-2010 10:12</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp; const </span><span class="default">X</span><span class="keyword">=</span><span class="default">1.0</span><span class="keyword">;<br />
 ...
 <div class="note">
  ...
  <a href="#100611" class="date">26-Oct-2010 12:30</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; </span><span class="default">$d </span><span class="keyword">= (string)</span><span class="default">$b</span><span class="keyword">; </span><span class="comment">// Forvet<br />
 ...
 <div class="note">
  ...
  <a href="#100440" class="date">15-Oct-2010 05:10</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
<span class="default">&lt;?php<br />
</span><span class="comment">// tricky implementation of singleton<br />
// creates a function handle to work with the child singleton<br />
// so you can get the object doing: ClassName() instead of ClassName::getInstance()<br />
// or get some property rightaway: ClassName('nameOfPublicProperty');<br />
// enjoy!!<br />
<br />
</span><span class="keyword">Abstract class </span><span class="default">SingletonBase<br />
</span><span class="keyword">{<br />
&nbsp;protected function </span><span class="default">__clone</span><span class="keyword">(){}<br />
&nbsp;public function </span><span class="default">getInstance</span><span class="keyword">()<br />
&nbsp;{<br />
...
&nbsp;&nbsp; if(!</span><span class="default">function_exists</span><span class="keyword">(</span><span class="default">$name</span><span class="keyword">=</span><span class="default">get_called_class</span><span class="keyword">()))<br />
&nbsp;&nbsp; {<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$strCode </span><span class="keyword">= </span><span class="string">"function {$name}(\$attribute=null){<br />
&nbsp;&nbsp; &nbsp; static \$obj = null;<br />
&nbsp;&nbsp; &nbsp; !\$obj AND \$obj = {$name}::getInstance();<br />
&nbsp;&nbsp; &nbsp; return \$attribute ? \$obj-&gt;\$attribute : \$obj;<br />
&nbsp;&nbsp;&nbsp; }"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// creates the getInstance handle function<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">eval(</span><span class="default">$strCode</span><span class="keyword">);<br />
&nbsp;&nbsp; }<br />
&nbsp; }<br />
...
<br />
</span><span class="keyword">class </span><span class="default">MySingletonClass </span><span class="keyword">extends </span><span class="default">SingletonBase<br />
</span><span class="keyword">{<br />
&nbsp;var </span><span class="default">$varTest </span><span class="keyword">= </span><span class="string">"somevalue"</span><span class="keyword">;<br />
}<br />
<br />
</span><span class="default">$obj </span><span class="keyword">= </span><span class="default">MySingletonClass</span><span class="keyword">::</span><span class="default">getInstance</span><span class="keyword">();<br />
echo </span><span class="default">$obj</span><span class="keyword">-&gt;</span><span class="default">varTest</span><span class="keyword">; </span><span class="comment">// somevalue<br />
</span><span class="keyword">echo </span><span class="default">MySingletonClass</span><span class="keyword">(</span><span class="string">'varTest'</span><span class="keyword">); </span><span class="comment">// somevalue<br />
</span><span class="default">$obj </span><span class="keyword">= </span><span class="default">MySingletonClass</span><span class="keyword">();<br />
echo </span><span class="default">$obj</span><span class="keyword">-&gt;</span><span class="default">varTest</span><span class="keyword">; </span><span class="comment">// somevalue<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
 ...
 <div class="note">
  ...
  <a href="#100138" class="date">27-Sep-2010 02:38</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#98382" class="date">11-Jun-2010 09:51</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
…of course this applies anywhere in PHP, but because of the (current) newness late static bindings, I’ve seen lots of code with this particular snafu in it from others.</span>
 ...
 <div class="note">
  ...
  <a href="#97639" class="date">29-Apr-2010 03:59</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
If you're still stuck on a pre-5.3 codebase then you can fake a singleton superclass like this.&nbsp; It ain't pretty, though.&nbsp; To do it you pass the type info down the stack manually and then abuse call_user_func to pass the value back to the originating class so that you can access it's static properties.<br />
<br />
<span class="default">&lt;?php<br />
...
&nbsp;&nbsp;&nbsp; protected function </span><span class="default">__clone</span><span class="keyword">() {}<br />
<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">instance</span><span class="keyword">(</span><span class="default">$class</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$member </span><span class="keyword">= </span><span class="string">'instance'</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$instance </span><span class="keyword">= </span><span class="default">self</span><span class="keyword">::</span><span class="default">getStaticMember</span><span class="keyword">(</span><span class="default">$class</span><span class="keyword">, </span><span class="default">$member</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; if (!</span><span class="default">$instance </span><span class="keyword">instanceof </span><span class="default">$class</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$instance </span><span class="keyword">= new </span><span class="default">$class</span><span class="keyword">();<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">self</span><span class="keyword">::</span><span class="default">setStaticMember</span><span class="keyword">(</span><span class="default">$class</span><span class="keyword">, </span><span class="default">$member</span><span class="keyword">, </span><span class="default">$instance</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">$instance</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; protected function </span><span class="default">setStaticMember</span><span class="keyword">(</span><span class="default">$class</span><span class="keyword">, </span><span class="default">$member</span><span class="keyword">, </span><span class="default">$value</span><span class="keyword">) { </span><span class="default">call_user_func</span><span class="keyword">(array(</span><span class="default">$class</span><span class="keyword">, </span><span class="default">__FUNCTION__</span><span class="keyword">), </span><span class="default">$member</span><span class="keyword">, </span><span class="default">$value</span><span class="keyword">); }<br />
&nbsp;&nbsp;&nbsp; protected function </span><span class="default">getStaticMember</span><span class="keyword">(</span><span class="default">$class</span><span class="keyword">, </span><span class="default">$member</span><span class="keyword">) { return </span><span class="default">call_user_func</span><span class="keyword">(array(</span><span class="default">$class</span><span class="keyword">, </span><span class="default">__FUNCTION__</span><span class="keyword">), </span><span class="default">$member</span><span class="keyword">); }<br />
}<br />
<br />
class </span><span class="default">MySingleton </span><span class="keyword">extends </span><span class="default">Singleton </span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; protected static </span><span class="default">$instance </span><span class="keyword">= </span><span class="default">null</span><span class="keyword">;<br />
<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">instance</span><span class="keyword">() { return </span><span class="default">parent</span><span class="keyword">::</span><span class="default">instance</span><span class="keyword">(</span><span class="default">__CLASS__</span><span class="keyword">); }<br />
<br />
&nbsp;&nbsp;&nbsp; protected function </span><span class="default">setStaticMember</span><span class="keyword">(</span><span class="default">$member</span><span class="keyword">, </span><span class="default">$value</span><span class="keyword">) { </span><span class="default">self</span><span class="keyword">::$</span><span class="default">$member </span><span class="keyword">= </span><span class="default">$value</span><span class="keyword">; }<br />
&nbsp;&nbsp;&nbsp; protected function </span><span class="default">getStaticMember</span><span class="keyword">(</span><span class="default">$member</span><span class="keyword">) { return </span><span class="default">self</span><span class="keyword">::$</span><span class="default">$member</span><span class="keyword">; }<br />
}<br />
<br />
</span><span class="default">?&gt;</span>
</span>
 ...
 <div class="note">
  ...
  <a href="#93065" class="date">21-Aug-2009 06:34</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; eval( </span><span class="string">"$class::\$$prop = \$$val;" </span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
...
<br />
 ...
 <div class="note">
  ...
  <a href="#91980" class="date">03-Jul-2009 06:28</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">"Trying to access undefined property '$id'."</span><span class="keyword">);<br />
&nbsp; }<br />
...
Using these magic function as described above will help you to find classes that try to access an undefined (and undocumented) class-member. In most cases: this is an error based on misspelled member names.</span>
 ...
 <div class="note">
  ...
  <a href="#89946" class="date">30-Mar-2009 02:19</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">trigger_error</span><span class="keyword">(</span><span class="string">"Tried to construct&nbsp; a second instance of class \"$class\""</span><span class="keyword">, </span><span class="default">E_USER_WARNING</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
...
You probably noticed the use of self:: rather than static::, this is because we want the static variable to be private, and using static:: will not allow us to do that.</span>
 ...
 <div class="note">
  ...
  <a href="#86066" class="date">01-Oct-2008 12:30</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
WHOA... KEEP IT SIMPLE!<br />
<br />
Remember, when you write a class definition, you are creating a new "type" of object. And when you extend those classes, you are creating a heirarchy. To get to the point... all the class defs below work together to provide a solid organization of data.<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">abstract class </span><span class="default">Animal </span><span class="keyword">{<br />
&nbsp; protected </span><span class="default">$type</span><span class="keyword">, </span><span class="default">$name</span><span class="keyword">;<br />
<br />
&nbsp; public function </span><span class="default">__construct</span><span class="keyword">(</span><span class="default">$aType</span><span class="keyword">, </span><span class="default">$aName</span><span class="keyword">) {<br />
...
<br />
&nbsp; public function </span><span class="default">__toString</span><span class="keyword">() {<br />
&nbsp;&nbsp;&nbsp; return </span><span class="string">"Animal [type=$this-&gt;type, name=$this-&gt;name]"</span><span class="keyword">;<br />
&nbsp; }<br />
}<br />
<br />
class </span><span class="default">Dog </span><span class="keyword">extends </span><span class="default">Animal </span><span class="keyword">{<br />
&nbsp; public function </span><span class="default">__construct</span><span class="keyword">(</span><span class="default">$aName</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">parent</span><span class="keyword">::</span><span class="default">__construct</span><span class="keyword">(</span><span class="string">"Dog"</span><span class="keyword">, </span><span class="default">$aName</span><span class="keyword">);<br />
&nbsp; }<br />
}<br />
<br />
...
&nbsp; public function </span><span class="default">__construct</span><span class="keyword">(</span><span class="default">$aName</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">parent</span><span class="keyword">::</span><span class="default">__construct</span><span class="keyword">(</span><span class="string">"Cat"</span><span class="keyword">, </span><span class="default">$aName</span><span class="keyword">);<br />
&nbsp; }<br />
}<br />
<br />
echo </span><span class="string">'My dog: ' </span><span class="keyword">. (new </span><span class="default">Dog</span><span class="keyword">(</span><span class="string">'Sam'</span><span class="keyword">)) . </span><span class="string">'&lt;br&gt;'</span><span class="keyword">;<br />
echo </span><span class="string">'My cat: ' </span><span class="keyword">. (new </span><span class="default">Cat</span><span class="keyword">(</span><span class="string">'Fluffy'</span><span class="keyword">)) . </span><span class="string">'&lt;br&gt;'</span><span class="keyword">;<br />
echo </span><span class="string">'Your dog: ' </span><span class="keyword">. (new </span><span class="default">Dog</span><span class="keyword">(</span><span class="string">'Walter'</span><span class="keyword">)) . </span><span class="string">'&lt;br&gt;'</span><span class="keyword">;<br />
echo </span><span class="string">'Yout cat: ' </span><span class="keyword">. (new </span><span class="default">Cat</span><span class="keyword">(</span><span class="string">'Ginger'</span><span class="keyword">));<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
My dog:&nbsp;&nbsp; Animal[type=Dog, name=Sam]<br />
My cat:&nbsp;&nbsp; Animal[type=Cat, name=Fluffy]<br />
Your dog: Animal[type=Dog, name=Walter]<br />
Yout cat: Animal[type=Cat, name=Ginger]<br />
<br />
... and notice the property called $type, is the same as using __CLASS__ in most of the previous posts, but without the complexities of the PHP language.</span>
</code></div>
  </div>
 </div>
 <a name="85802"></a>
 <div class="note">
  ...
  <a href="#85802" class="date">18-Sep-2008 07:51</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; </span><span class="default">preg_match</span><span class="keyword">(</span><span class="string">"#([a-zA-Z0-9_]+){$a_called['type']}<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; {$a_called['function']}( )*\(#"</span><span class="keyword">, </span><span class="default">$a_lines</span><span class="keyword">[</span><span class="default">$i_line</span><span class="keyword">], </span><span class="default">$a_match</span><span class="keyword">);<br />
...
&nbsp;&nbsp;&nbsp; return </span><span class="default">$s_class</span><span class="keyword">;<br />
 ...
 <div class="note">
  ...
  <a href="#85725" class="date">14-Sep-2008 09:39</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#85591" class="date">07-Sep-2008 09:01</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
As you can see, my current workaround has some overhead and is not as water-tight as the late static binding method.</span>
 ...
 <div class="note">
  ...
  <a href="#84525" class="date">17-Jul-2008 07:26</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
With Php 5.3.0, upgrading will be easy : just delete the methods from the basic class, and search/replace any call to getStatic() and setNextStatic() by static:: - or one could use a selector on PHP_VERSION value to include either the BaseClass file with workaround or a BaseClass file using static::</span>
 ...
 <div class="note">
  <strong class='user'>Anonymous</strong>
  <a href="#84405" class="date">12-Jul-2008 12:49</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
echo </span><span class="default">$w</span><span class="keyword">-&gt;</span><span class="default">sayIt</span><span class="keyword">() ; </span><span class="comment">// Hello World<br />
 ...
 <div class="note">
  ...
  <a href="#83978" class="date">21-Jun-2008 01:06</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
echo&nbsp; &nbsp; </span><span class="default">B</span><span class="keyword">::</span><span class="default">constructor</span><span class="keyword">(); </span><span class="comment">// B<br />
 ...
 <div class="note">
  ...
  <a href="#83917" class="date">18-Jun-2008 05:54</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
 ...
 <div class="note">
  ...
  <a href="#83638" class="date">05-Jun-2008 10:39</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">trigger_error</span><span class="keyword">(</span><span class="string">"Static property does not exist: $class::\$$var"</span><span class="keyword">);<br />
...
&nbsp;&nbsp;&nbsp; </span><span class="keyword">return </span><span class="default">$temp</span><span class="keyword">;<br />
 ...
 <div class="note">
  ...
  <a href="#83627" class="date">04-Jun-2008 10:48</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
@ php at mikebird <br />
<br />
...
This would pass the params to your constructor. Love for php.</span>
 ...
 <div class="note">
  ...
  <a href="#83502" class="date">28-May-2008 01:22</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Output: 'Product'</span>
 ...
 <div class="note">
  ...
  <a href="#82727" class="date">23-Apr-2008 08:39</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
The above will output 'it is a singleton'. The obvious downfall to this method is not being able to give arguments to the constructor.</span>
 ...
 <div class="note">
  ...
  <a href="#82441" class="date">10-Apr-2008 03:24</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
If you are using PHP &lt; 5.3.0 you might be interested in the following workaround for late static binding: <a href="http://de2.php.net/manual/de/function.get-class.php#77698" rel="nofollow" target="_blank">http://de2.php.net/manual/de/function.get-class.php#77698</a></span>
 ...
 <div class="foot"><a href="/manual/add-note.php?sect=language.oop5.late-static-bindings&amp;redirect=@w{8NWZZX39}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.oop5.late-static-bindings&amp;redirect=@w{8NWZZX39}">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.oop5.late-static-bindings.php">show source</a> |

...
<head profile="@w{B8XXCD23}">
 <title>PHP: Using namespaces: fallback to global function/constant - Manual</title>
 ...
 <link rel="prev" href="language.namespaces.global.php" />
 <link rel="next" href="language.namespaces.rules.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/namespaces.fallback" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/language.namespaces.fallback.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="http://www.php.net/manual/en/language.namespaces.fallback.php" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.namespaces.fallback.php">Using namespaces: fallback to global function/constant</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.namespaces.rules.php">Name resolution rules<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.namespaces.global.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Global space</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.namespaces.fallback.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
 <div class="langchooser">
  <form action="/manual/change.php" method="get">
   <p>view this page in </p><fieldset><select name="page">
    ...
    <option value="pl/language.namespaces.fallback.php">Polish</option>
    <option value="ro/language.namespaces.fallback.php">Romanian</option>
    <option value="ru/language.namespaces.fallback.php">Russian</option>
    <option value="fa/language.namespaces.fallback.php">Persian</option>
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.namespaces.fallback&amp;redirect=http://www.php.net/manual/en/language.namespaces.fallback.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.namespaces.fallback&amp;redirect=http://www.php.net/manual/en/language.namespaces.fallback.php">add a note</a></small></span>
  <small>User Contributed Notes</small>
  <strong>Using namespaces: fallback to global function/constant</strong>
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.namespaces.fallback.php">show source</a> |

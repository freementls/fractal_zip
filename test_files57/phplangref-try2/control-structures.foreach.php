...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="control-structures.for.php" />
 <link rel="next" href="control-structures.break.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/foreach" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/control-structures.foreach.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="@w{6RBD682K}" />
...
<ul class="toc">
 ...
 <li class="active"><a href="control-structures.foreach.php">foreach</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="control-structures.break.php">break<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="control-structures.for.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />for</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/control-structures.foreach.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
 <div class="langchooser">
  <form action="/manual/change.php" method="get">
   <p>view this page in </p><fieldset><select name="page">
    ...
    <option value="pl/control-structures.foreach.php">Polish</option>
    ...
    <option value="fa/control-structures.foreach.php">Persian</option>
  ...
  <blockquote class="note"><p><strong class="note">Note</strong>: 
   <p class="para">
    ...
    of the array. This means that you do not need to call
     <span class="function"><a href="function.reset.php" class="function">reset()</a></span> before a <em>foreach</em>
    loop.
   </p>
   <p class="para">
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=control-structures.foreach&amp;redirect=@w{6RBD682K}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=control-structures.foreach&amp;redirect=@w{6RBD682K}">add a note</a></small></span>
  <small>User Contributed Notes</small>
  <strong>foreach</strong>
 </div><div id="allnotes">
 <a name="108916"></a>
 <div class="note">
  <strong class='user'>Andreas Otto</strong>
  <a href="#108916" class="date">04-Jun-2012 04:47</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
After some mind-boggling debugging I found out that walking through an array via foreach() may lead to unexpected results if there are references pointing to elements of that array.<br />
<br />
In the example below you wouln't expect a change between the first and the last print_r(), for you only manipulate a copy of the array's elements ($v).<br />
<br />
Behold this black magic:<br />
<br />
<span class="default">&lt;?php<br />
$arr1 </span><span class="keyword">= array(<br />
&nbsp;&nbsp;&nbsp; </span><span class="string">'r0' </span><span class="keyword">=&gt; array(<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="string">'f0' </span><span class="keyword">=&gt; </span><span class="string">'herp'</span><span class="keyword">,<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="string">'f1' </span><span class="keyword">=&gt; </span><span class="string">'derp'</span><span class="keyword">,<br />
&nbsp;&nbsp;&nbsp; ),<br />
&nbsp;&nbsp;&nbsp; </span><span class="string">'r1' </span><span class="keyword">=&gt; array(<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="string">'f0' </span><span class="keyword">=&gt; </span><span class="string">'durr'</span><span class="keyword">,<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="string">'f1' </span><span class="keyword">=&gt; </span><span class="string">'hurr'</span><span class="keyword">,<br />
&nbsp;&nbsp;&nbsp; ),<br />
);<br />
<br />
...
<br />
foreach(</span><span class="default">array_keys</span><span class="keyword">(</span><span class="default">$arr1</span><span class="keyword">) as </span><span class="default">$k</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$arr2</span><span class="keyword">[</span><span class="default">$k</span><span class="keyword">] = &amp;</span><span class="default">$arr1</span><span class="keyword">[</span><span class="default">$k</span><span class="keyword">][</span><span class="string">'f1'</span><span class="keyword">];<br />
}<br />
<br />
...
*/<br />
<br />
</span><span class="keyword">foreach(</span><span class="default">$arr1 </span><span class="keyword">as </span><span class="default">$v</span><span class="keyword">) {</span><span class="comment">#notice: $v is a copy, not a reference!<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$v</span><span class="keyword">[</span><span class="string">'f1'</span><span class="keyword">] = </span><span class="string">'potato'</span><span class="keyword">;<br />
}<br />
<br />
</span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$arr1</span><span class="keyword">);<br />
<br />
...
PHP 5.3.13<br />
<br />
I am not quite sure whether this is a bug or just an annoying side effect…</span>
</code></div>
  </div>
 </div>
 <a name="108689"></a>
 <div class="note">
  <strong class='user'>peter at olds dot co</strong>
  <a href="#108689" class="date">17-May-2012 08:12</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
This is probably common sense to a lot of people but I spent close to two hours trying to figure this out.<br />
<br />
I had an array output that looked like this:<br />
<span class="default">&lt;?php<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; (<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; [event_id] =&gt; 1<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; [form_name] =&gt; Long Beach 2012<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; [form_id] =&gt; longbeach2012<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; [registrations] =&gt; 1<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; )<br />
<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; (<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; [event_id] =&gt; 2<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; [form_name] =&gt; Las Vegas 2013<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; [form_id] =&gt; lasvegas2013<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; [registrations] =&gt; 0<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; )<br />
<br />
)<br />
...
Inside of the array are objects so you could call a single value by doing something like:<br />
<span class="default">&lt;?php<br />
$arr</span><span class="keyword">[</span><span class="default">0</span><span class="keyword">]-&gt;</span><span class="default">event_id</span><span class="keyword">; </span><span class="comment">// returns 1<br />
</span><span class="default">?&gt;<br />
</span><br />
So to be able to do a foreach through it do the following:<br />
<span class="default">&lt;?php<br />
<br />
$results </span><span class="keyword">= array(); </span><span class="comment">// The array we're working with<br />
</span><span class="keyword">foreach( </span><span class="default">$results </span><span class="keyword">as </span><span class="default">$obj </span><span class="keyword">)<br />
{<br />
...
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; echo </span><span class="default">$key</span><span class="keyword">; </span><span class="comment">// returns event_id, form_name, etc.<br />
&nbsp;&nbsp; &nbsp; &nbsp; </span><span class="keyword">echo </span><span class="default">$value</span><span class="keyword">; </span><span class="comment">// returns 1, Long Beach 2012<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">}<br />
 ...
 <div class="note">
  ...
  <a href="#108201" class="date">06-Apr-2012 08:40</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
<span class="default">&lt;?php<br />
</span><span class="comment">// LIMITATION: YOU CANNOT PASS THE $key BY REFERENCE USING PHP'S NATIVE foreach ($array as $key =&gt; &amp;$value) CONTROL STRUCTURE<br />
// SOLUTION: USE ArrayUtil::ForEachFn(Array &amp;$array, $fn)<br />
// ADDITIONAL BENEFIT:<br />
//&nbsp; &nbsp; 1 - YOU DON'T HAVE TO WORRY ABOUT THE FOLLOWING WARNING:<br />
...
unset(</span><span class="default">$value</span><span class="keyword">) </span><span class="comment">// break the reference with the last element<br />
// THE ABOVE EXAMPLE WILL OUTPUT:<br />
// Fatal error: Key element cannot be a reference in...<br />
<br />
// SOLUTION (FOR YOU TO COPY)<br />
</span><span class="keyword">class </span><span class="default">ArrayUtil<br />
</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; public static function </span><span class="default">ForEachFn</span><span class="keyword">(Array &amp;</span><span class="default">$array</span><span class="keyword">, </span><span class="default">$fn</span><span class="keyword">)<br />
&nbsp;&nbsp;&nbsp; {<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$fn</span><span class="keyword">(</span><span class="default">$key</span><span class="keyword">, </span><span class="default">$value</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$newArray</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">] = </span><span class="default">$value</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$array </span><span class="keyword">= </span><span class="default">$newArray</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="comment">// EXAMPLE CALLBACK<br />
</span><span class="default">$fn </span><span class="keyword">= function (&amp;</span><span class="default">$key</span><span class="keyword">, &amp;</span><span class="default">$value</span><span class="keyword">) { </span><span class="comment">// NOTE THE FUNCTION'S SIGNATURE (USING &amp; FOR BOTH $key AND $value)<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">if (</span><span class="default">$key </span><span class="keyword">=== </span><span class="string">'key2'</span><span class="keyword">)<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$key </span><span class="keyword">= </span><span class="string">'BY REF KEY EXAMPLE'</span><span class="keyword">; </span><span class="comment">// THIS IS THE WHOLE POINT OF THIS POST<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">}<br />
&nbsp;&nbsp;&nbsp; if (</span><span class="default">$value </span><span class="keyword">=== </span><span class="string">'value2'</span><span class="keyword">)<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$value </span><span class="keyword">= </span><span class="string">'BY REF VALUE EXAMPLE'</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
};<br />
<br />
...
&nbsp;&nbsp;&nbsp; </span><span class="string">'key2' </span><span class="keyword">=&gt; </span><span class="string">'value2'</span><span class="keyword">,<br />
&nbsp;&nbsp;&nbsp; </span><span class="string">'key3' </span><span class="keyword">=&gt; </span><span class="string">'value3'</span><span class="keyword">,<br />
);<br />
</span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">);<br />
</span><span class="default">ArrayUtil</span><span class="keyword">::</span><span class="default">ForEachFn</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">, </span><span class="default">$fn</span><span class="keyword">);<br />
</span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">);<br />
</span><span class="comment">/* THE ABOVE "EXAMPLE USAGE" OUTPUTS:<br />
Array<br />
(<br />
&nbsp;&nbsp;&nbsp; [key1] =&gt; value1<br />
&nbsp;&nbsp;&nbsp; [key2] =&gt; value2<br />
...
(<br />
&nbsp;&nbsp;&nbsp; [key1] =&gt; value1<br />
&nbsp;&nbsp;&nbsp; [BY REF KEY EXAMPLE] =&gt; BY REF VALUE EXAMPLE<br />
&nbsp;&nbsp;&nbsp; [key3] =&gt; value3<br />
)<br />
*/<br />
<br />
// ALSO NOTE THAT SYNTACTICALLY THIS CAN LOOK VERY SIMILAR TO PHP'S NATIVE FOREACH:<br />
</span><span class="default">ArrayUtil</span><span class="keyword">::</span><span class="default">ForEachFn</span><span class="keyword">(</span><span class="default">$array</span><span class="keyword">, function (&amp;</span><span class="default">$key</span><span class="keyword">, &amp;</span><span class="default">$value</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// YOUR CODE HERE<br />
 ...
 <div class="note">
  ...
  <a href="#107607" class="date">21-Feb-2012 06:46</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
FYI, as with 'if', braces are not necessary for single statement loops.<br />
<br />
For example, the following are equivalent:<br />
<br />
<span class="default">&lt;?php<br />
$s</span><span class="keyword">=Array(</span><span class="string">"4"</span><span class="keyword">,</span><span class="string">"8"</span><span class="keyword">,</span><span class="string">"15"</span><span class="keyword">,</span><span class="string">"16"</span><span class="keyword">,</span><span class="string">"23"</span><span class="keyword">,</span><span class="string">"42"</span><span class="keyword">);<br />
foreach(</span><span class="default">$s </span><span class="keyword">as </span><span class="default">$q</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; print </span><span class="default">$q</span><span class="keyword">;<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
<span class="default">&lt;?php<br />
$s</span><span class="keyword">=Array(</span><span class="string">"4"</span><span class="keyword">,</span><span class="string">"8"</span><span class="keyword">,</span><span class="string">"15"</span><span class="keyword">,</span><span class="string">"16"</span><span class="keyword">,</span><span class="string">"23"</span><span class="keyword">,</span><span class="string">"42"</span><span class="keyword">);<br />
foreach(</span><span class="default">$s </span><span class="keyword">as </span><span class="default">$q</span><span class="keyword">) print </span><span class="default">$q</span><span class="keyword">;<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
  </div>
 ...
 <div class="note">
  ...
  <a href="#107533" class="date">15-Feb-2012 08:55</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$formatedarray</span><span class="keyword">.= </span><span class="string">"&lt;option value=\"$a[$k]\"&gt;$v&lt;/option&gt;<br />
&nbsp;&nbsp;&nbsp; "</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
...
&nbsp;&nbsp;&nbsp; echo </span><span class="string">"$key: $value\n"</span><span class="keyword">;<br />
...
&nbsp;&nbsp;&nbsp; print </span><span class="string">" inside foreach $mot &lt;br&gt;"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
...
print </span><span class="string">"title=$t "</span><span class="keyword">;<br />
}<br />
...
&nbsp;&nbsp;&nbsp; print </span><span class="string">"Key $key, Value $val\n"</span><span class="keyword">;<br />
<br />
}<br />
<br />
...
echo </span><span class="string">"val={$val}&lt;br&gt;"</span><span class="keyword">;<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
...
{<br />
&nbsp;&nbsp;&nbsp; echo </span><span class="string">"$field_name"</span><span class="keyword">;<br />
}<br />
</span><span class="default">?&gt;<br />
...
&nbsp;&nbsp;&nbsp; </span><span class="comment">// ...<br />
 ...
 <div class="foot"><a href="/manual/add-note.php?sect=control-structures.foreach&amp;redirect=@w{6RBD682K}"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=control-structures.foreach&amp;redirect=@w{6RBD682K}">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/control-structures.foreach.php">show source</a> |

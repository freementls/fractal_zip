...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="function.return.php" />
 <link rel="next" href="function.include.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/require" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/function.require.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="http://www.php.net/manual/en/function.require.php" />
...
<ul class="toc">
 ...
 <li class="active"><a href="function.require.php">require</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="function.include.php">include<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="function.return.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />return</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/function.require.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=function.require&amp;redirect=http://www.php.net/manual/en/function.require.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=function.require&amp;redirect=http://www.php.net/manual/en/function.require.php">add a note</a></small></span>
  <small>User Contributed Notes</small>
  <strong>require</strong>
 </div><div id="allnotes">
 <a name="102714"></a>
 <div class="note">
  <strong class='user'>bsntech</strong>
  <a href="#102714" class="date">01-Mar-2011 01:41</a>
  <div class="text">
...
Brian S.</span>
 ...
 <div class="note">
  ...
  <a href="#98624" class="date">26-Jun-2010 04:04</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
If you want to get a parsed PHP file, e.g file.php contains echo 'ciao'; the function below will return you the output of file.php that is ciao<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="comment">// file and get, if you need to include a file.php?query_string.<br />
<br />
</span><span class="keyword">function </span><span class="default">pinclude</span><span class="keyword">(</span><span class="default">$file</span><span class="keyword">, </span><span class="default">$type</span><span class="keyword">, </span><span class="default">$get </span><span class="keyword">= </span><span class="default">null</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$p </span><span class="keyword">= </span><span class="default">explode</span><span class="keyword">(</span><span class="string">'/'</span><span class="keyword">, </span><span class="default">$file</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$file </span><span class="keyword">= </span><span class="default">end</span><span class="keyword">(</span><span class="default">$p</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$dir </span><span class="keyword">= </span><span class="string">''</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$n </span><span class="keyword">= </span><span class="default">count</span><span class="keyword">(</span><span class="default">$p</span><span class="keyword">) - </span><span class="default">1</span><span class="keyword">;<br />
<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$dir </span><span class="keyword">.= </span><span class="default">$p</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">] . </span><span class="string">'/'</span><span class="keyword">;<br />
<br />
&nbsp;&nbsp;&nbsp; if(</span><span class="default">$get </span><span class="keyword">!== </span><span class="default">null</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$tmp </span><span class="keyword">= </span><span class="default">$_GET</span><span class="keyword">; </span><span class="comment">// back up<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$_GET </span><span class="keyword">= array();<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$get </span><span class="keyword">= </span><span class="default">explode</span><span class="keyword">(</span><span class="string">'&amp;'</span><span class="keyword">, </span><span class="default">$get</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$n </span><span class="keyword">= </span><span class="default">count</span><span class="keyword">(</span><span class="default">$get</span><span class="keyword">);<br />
<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; for(</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">$n</span><span class="keyword">; </span><span class="default">$i</span><span class="keyword">++) {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; if(</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$get</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">], </span><span class="string">'='</span><span class="keyword">) === </span><span class="default">false</span><span class="keyword">)<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$_GET</span><span class="keyword">[</span><span class="default">$get</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]] = </span><span class="default">1</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; else {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; list(</span><span class="default">$name</span><span class="keyword">, </span><span class="default">$val</span><span class="keyword">) = </span><span class="default">explode</span><span class="keyword">(</span><span class="string">'='</span><span class="keyword">, </span><span class="default">$get</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">], </span><span class="default">2</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$_GET</span><span class="keyword">[</span><span class="default">$name</span><span class="keyword">] = </span><span class="default">$val</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; }<br />
<br />
...
<br />
&nbsp;&nbsp;&nbsp; if(</span><span class="default">$tmp</span><span class="keyword">)<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$_GET </span><span class="keyword">= </span><span class="default">$tmp</span><span class="keyword">;<br />
<br />
&nbsp;&nbsp;&nbsp; return </span><span class="default">$out</span><span class="keyword">;<br />
}<br />
<br />
</span><span class="default">$out </span><span class="keyword">= </span><span class="default">pinclude</span><span class="keyword">(</span><span class="string">'./dir/yourfile.php'</span><span class="keyword">, </span><span class="string">'a=b&amp;c=d&amp;e'</span><span class="keyword">);<br />
echo </span><span class="default">$out</span><span class="keyword">;<br />
</span><span class="comment">// i'm sorry but i forgot post requests...<br />
...
I'm wondering if there is a method for declaring class public/private/protected functions from inside a require/include...</span>
 ...
 <div class="note">
  ...
  <a href="#83187" class="date">14-May-2008 11:15</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Does it really need to be any harder than that?</span>
 ...
 <a name="77656"></a>
 <div class="note">
  <strong class='user'>daniel at nohair dot com</strong>
  <a href="#77656" class="date">06-Sep-2007 07:24</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I love php.&nbsp; But when file can't be included, 'require' or 'require_once' throw fatal error and halt the script, which is almost never desirable on a mission-critical production server.&nbsp; I think it may be better to use something like the following.&nbsp; <br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">if (@include </span><span class="string">'plan_A.php'</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// Plan A;<br />
</span><span class="keyword">} elseif (@include </span><span class="string">'plan_B.php'</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// Plan B;<br />
</span><span class="keyword">} else {<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// Hope never happens.&nbsp; If does, then Email the webmaster;<br />
&nbsp;&nbsp;&nbsp; // Call 911, Medic, Fire, Police, the president;<br />
&nbsp;&nbsp;&nbsp; // Change hard drive, server, hosting service;<br />
</span><span class="keyword">}<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
Or handle trouble first is you wish<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">if (!@include </span><span class="string">'plan_A.php'</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// Someone has kidnapped/corrupted Plan_A.php;<br />
&nbsp;&nbsp;&nbsp; // Email the webmaster;<br />
&nbsp;&nbsp;&nbsp; // Change hard drive, server, hosting service;<br />
</span><span class="keyword">} else {<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// Plan A;<br />
</span><span class="keyword">}<br />
<br />
 ...
 <div class="note">
  ...
  <a href="#76480" class="date">17-Jul-2007 08:51</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
require and include read the included files even if they are not executed in the code. You can use eval() to avoid this. <br />
<br />
eval('require filename;');<br />
<br />
I don't know if it's faster to have the files included the regular way or the eval way though (in other words, I haven't tested their efficiency). It will be great if someone can test which is better.</span>
</code></div>
  </div>
 </div>
 <a name="76348"></a>
...
<br />
If your running your output through javascript string evaluations which would be sensitive to newlines/white spaces be carfull that the first chars in the file are the php tages eg &lt;?php</span>
</code></div>
  </div>
 </div>
 <a name="70463"></a>
...
This mainly jumps back to the servers document root and then begins to enter the directories defined until it finds the file. In this case it would go back to the root of the server, or whatever your document root is, and then enter includes. there it would search for the top.php file. Simple to use, yet effective...espcially for people like me who re-use code or move files to different directories. I don't have to fix the includes, because they all work the same way.</span>
 ...
 <a name="62314"></a>
 <div class="note">
  <strong class='user'>steve at walkerfx dot com</strong>
  <a href="#62314" class="date">24-Feb-2006 03:24</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
WARNING: Be absolutely sure that your include paths are relative or directory based and not http!!!<br />
<br />
&nbsp;&nbsp; require("<a href="http://www.mydomain.com/somefile.php" rel="nofollow" target="_blank">http://www.mydomain.com/somefile.php</a>"); //WRONG!!<br />
&nbsp;&nbsp; require("usr/mydomain/somefile.php"); //CORRECT!!<br />
<br />
If you are intending to access local files and you accidentally use an http address, the request will probably work. However, this creates a wierd situation that can cause all sorts of bugs in your scripts and slow your code down.<br />
<br />
The problem is that the include spawns off another php request, and is essentially requesting the file in the same a way a remote viewer would. So rather than including the intended php code, instead you get the processed output from that single file executed in its own private scope.<br />
<br />
It's a simple mistake, but it can be an awful problem to debug.<br />
<br />
Walker</span>
</code></div>
  </div>
...
...but even that gets tripped up by symlinks to different mount points, etc. You could substitute realpath($_SERVER['PATH_TRANSLATED']), but that function has been reported not to work on some (Windows) servers. One could use the PATH_TRANSLATED for both servers, but I figure if Apache is going to tell me exactly what I want to know, I should listen.</span>
 ...
 <div class="note">
  ...
  <a href="#54511" class="date">06-Jul-2005 11:54</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Something which may not be immediately obvious is that if you use double quotes on the filename, you can use variables to specify the filename, allowing you to do something like this:<br />
<br />
<span class="default">&lt;?php<br />
$query </span><span class="keyword">= </span><span class="string">"SELECT filename FROM updates WHERE version&gt;$current ORDER BY version"</span><span class="keyword">;<br />
</span><span class="default">$updateresult </span><span class="keyword">= </span><span class="default">mysql_query</span><span class="keyword">(</span><span class="default">$query</span><span class="keyword">) or exit(</span><span class="default">$query</span><span class="keyword">.</span><span class="string">'&lt;br /&gt;'</span><span class="keyword">.</span><span class="default">mysql_error</span><span class="keyword">());<br />
while (</span><span class="default">$updaterow </span><span class="keyword">= </span><span class="default">mysql_fetch_row</span><span class="keyword">(</span><span class="default">$updateresult</span><span class="keyword">)) {<br />
&nbsp;&nbsp;&nbsp; require </span><span class="string">"$updaterow[0]"</span><span class="keyword">;<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
Drop this in a script on a server and you can push updates to your clients. Obviously, make sure you only run scripts you want to.</span>
</code></div>
  </div>
 </div>
 <a name="52596"></a>
 <div class="note">
  ...
  <a href="#52596" class="date">06-May-2005 10:42</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
This will sound elementary, but for C++ native programmers, be sure NOT to put a '#' in front of your include statements! The parser will not give you an error, but also will not include the file, making for a tedious debugging process.<br />
<br />
In short, USE:<br />
<span class="default">&lt;?php<br />
&nbsp;&nbsp; &nbsp; </span><span class="keyword">include </span><span class="string">"yourfile.php"</span><span class="keyword">;<br />
</span><span class="default">?&gt;<br />
</span><br />
and DON'T use:<br />
<span class="default">&lt;?php<br />
&nbsp;&nbsp; &nbsp; </span><span class="comment">#include "yourfile.php";<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
  </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/function.require.php">show source</a> |

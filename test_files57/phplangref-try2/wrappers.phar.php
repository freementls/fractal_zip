...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="wrappers.glob.php" />
 <link rel="next" href="wrappers.ssh2.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/wrappers.phar" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/wrappers.phar.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="http://www.php.net/manual/en/wrappers.phar.php" />
...
<ul class="toc">
 ...
 <li class="active"><a href="wrappers.phar.php">phar://</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="wrappers.ssh2.php">ssh2://<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="wrappers.glob.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />glob://</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/wrappers.phar.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
 <div class="langchooser">
  <form action="/manual/change.php" method="get">
   <p>view this page in </p><fieldset><select name="page">
    ...
    <option value="pl/wrappers.phar.php">Polish</option>
    <option value="ro/wrappers.phar.php">Romanian</option>
    <option value="ru/wrappers.phar.php">Russian</option>
    <option value="fa/wrappers.phar.php">Persian</option>
...
<div id="wrappers.phar" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-wrappers.phar-description">
  ...
  <p class="simpara">
   ...
   PHP 5.3.0. See <a href="phar.using.stream.php" class="link">Phar stream wrapper</a>
 ...
 <div class="refsect1 seealso" id="refsect1-wrappers.phar-seealso">
  ...
  <ul class="simplelist">
   <li class="member"><a href="context.phar.php" class="xref">Phar context options</a></li>
  </ul>
 </div>
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=wrappers.phar&amp;redirect=http://www.php.net/manual/en/wrappers.phar.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=wrappers.phar&amp;redirect=http://www.php.net/manual/en/wrappers.phar.php">add a note</a></small></span>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/wrappers.phar.php">show source</a> |

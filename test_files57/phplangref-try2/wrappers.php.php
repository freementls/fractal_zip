...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="wrappers.ftp.php" />
 <link rel="next" href="wrappers.compression.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/wrappers.php" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/wrappers.php.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="http://www.php.net/manual/en/wrappers.php.php" />
...
<ul class="toc">
 ...
 <li class="active"><a href="wrappers.php.php">php://</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="wrappers.compression.php">zlib://<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="wrappers.ftp.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />ftp://</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/wrappers.php.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
 <div class="langchooser">
  <form action="/manual/change.php" method="get">
   <p>view this page in </p><fieldset><select name="page">
    ...
    <option value="pl/wrappers.php.php">Polish</option>
    <option value="ro/wrappers.php.php">Romanian</option>
    <option value="ru/wrappers.php.php">Russian</option>
    <option value="fa/wrappers.php.php">Persian</option>
 ...
 <div class="refsect1 description" id="refsect1-wrappers.php-description">
  ...
  <div class="refsect2 unknown-unknown-descriptiop" id="refsect2-wrappers.php-unknown-unknown-descriptiop">
   ...
   <p class="simpara">
    ...
    preferable to use <var class="filename">php://input</var> instead of <var class="varname"><var class="varname"><a href="reserved.variables.httprawpostdata.php" class="classname">$HTTP_RAW_POST_DATA</a></var></var> as it does not depend
    on special <var class="filename">php.ini</var> directives. Moreover, for those cases where
    <var class="varname"><var class="varname"><a href="reserved.variables.httprawpostdata.php" class="classname">$HTTP_RAW_POST_DATA</a></var></var> is not populated by default, it is a
    potentially less memory intensive alternative to activating <a href="ini.core.php#ini.always-populate-raw-post-data" class="link">always_populate_raw_post_data</a>.
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=wrappers.php&amp;redirect=http://www.php.net/manual/en/wrappers.php.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=wrappers.php&amp;redirect=http://www.php.net/manual/en/wrappers.php.php">add a note</a></small></span>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/wrappers.php.php">show source</a> |

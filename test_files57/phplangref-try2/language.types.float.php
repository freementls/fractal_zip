...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="language.types.integer.php" />
 <link rel="next" href="language.types.string.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/types.float" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/language.types.float.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="http://www.php.net/manual/en/language.types.float.php" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.types.float.php">Floating point numbers</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.types.string.php">Strings<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.types.integer.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Integers</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.types.float.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.types.float&amp;redirect=http://www.php.net/manual/en/language.types.float.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.types.float&amp;redirect=http://www.php.net/manual/en/language.types.float.php">add a note</a></small></span>
  <small>User Contributed Notes</small>
  <strong>Floating point numbers</strong>
 </div><div id="allnotes">
 <a name="109221"></a>
 <div class="note">
  <strong class='user'>grycsys at gmail dot com</strong>
  <a href="#109221" class="date">27-Jun-2012 10:21</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Comparing floats:<br />
<span class="default">&lt;?php<br />
&nbsp;&nbsp;&nbsp; $f </span><span class="keyword">= </span><span class="default">0.03</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$b </span><span class="keyword">= (</span><span class="default">1 </span><span class="keyword">- </span><span class="default">0.97</span><span class="keyword">);<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$f </span><span class="keyword">== </span><span class="default">$b</span><span class="keyword">); </span><span class="comment">//result FALSE<br />
</span><span class="default">?&gt;<br />
</span><br />
<span class="default">&lt;?php<br />
&nbsp;&nbsp;&nbsp; $f </span><span class="keyword">= (float)(string)</span><span class="default">0.03</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$b </span><span class="keyword">= (float)(string)(</span><span class="default">1 </span><span class="keyword">- </span><span class="default">0.97</span><span class="keyword">);<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">var_dump</span><span class="keyword">(</span><span class="default">$f </span><span class="keyword">== </span><span class="default">$b</span><span class="keyword">); </span><span class="comment">//result TRUE<br />
 ...
 <a name="108405"></a>
 <div class="note">
  <strong class='user'>davidszilardd at gmail dot com</strong>
  <a href="#108405" class="date">24-Apr-2012 10:58</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
The function returns 5 for 5,000 because if there is no decimal point, then the first strpos will be FALSE, and FALSE &lt; 1 is TRUE so the condition will be still true.<br />
<br />
It should be checked whether strpos returns a valid position:<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">str2num</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">)<br />
{ <br />
&nbsp;&nbsp; &nbsp;&nbsp; if (</span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">, </span><span class="string">'.'</span><span class="keyword">) !== </span><span class="default">FALSE </span><span class="keyword">&amp;&amp; </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">,&nbsp; &nbsp; </span><span class="string">','</span><span class="keyword">) !== </span><span class="default">FALSE </span><span class="keyword">&amp;&amp; </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">, </span><span class="string">'.'</span><span class="keyword">) &lt; </span><span class="default">strpos</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">,</span><span class="string">','</span><span class="keyword">))<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; { <br />
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$str </span><span class="keyword">= </span><span class="default">strtr</span><span class="keyword">(</span><span class="default">$str</span><span class="keyword">,</span><span class="string">','</span><span class="keyword">,</span><span class="string">'.'</span><span class="keyword">);&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; } <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; else<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; { <br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$str </span><span class="keyword">= </span><span class="default">str_replace</span><span class="keyword">(</span><span class="string">','</span><span class="keyword">,</span><span class="string">''</span><span class="keyword">,</span><span class="default">$str</span><span class="keyword">);&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; } <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return (float)</span><span class="default">$str</span><span class="keyword">; <br />
}<br />
</span><span class="default">?&gt;</span>
</span>
</code></div>
...
&nbsp;*&nbsp; &nbsp; <br />
&nbsp;*&nbsp; @author NSTIAC (Jorge D. Baigorri Salas) <a href="http://www.nstiac.com" rel="nofollow" target="_blank">http://www.nstiac.com</a> <a href="http://www.n2works.com" rel="nofollow" target="_blank">http://www.n2works.com</a><br />
...
echo </span><span class="string">"a = $a\n"</span><span class="keyword">;<br />
echo </span><span class="string">"b = $b\n"</span><span class="keyword">;<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; else </span><span class="default">trigger_error</span><span class="keyword">(</span><span class="string">"Could not convert exponential notation to decimal notation: invalid float string '$float_str'"</span><span class="keyword">, </span><span class="default">E_USER_ERROR</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
...
&nbsp;&nbsp;&nbsp; </span><span class="default">$min </span><span class="keyword">= (float)</span><span class="string">"-$max"</span><span class="keyword">;<br />
<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; round(1092,-2) =&gt; 1100</span>
 ...
 <div class="foot"><a href="/manual/add-note.php?sect=language.types.float&amp;redirect=http://www.php.net/manual/en/language.types.float.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.types.float&amp;redirect=http://www.php.net/manual/en/language.types.float.php">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.types.float.php">show source</a> |

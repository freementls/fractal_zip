...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="language.exceptions.extending.php" />
 <link rel="next" href="language.references.whatare.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/references" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="alternate" href="/manual/en/feeds/language.references.atom" type="application/atom+xml" />
 <link rel="canonical" href="http://php.net/manual/en/language.references.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="http://www.php.net/manual/en/language.references.php" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.references.php">References Explained</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.references.whatare.php">What References Are<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.exceptions.extending.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Extending Exceptions</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.references.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
...
<div id="language.references" class="chapter">
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.references&amp;redirect=http://www.php.net/manual/en/language.references.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.references&amp;redirect=http://www.php.net/manual/en/language.references.php">add a note</a></small></span>
  <small>User Contributed Notes</small>
  <strong>References Explained</strong>
 </div><div id="allnotes">
 <a name="107946"></a>
 <div class="note">
...
&nbsp;&nbsp;&nbsp; return </span><span class="default">$r</span><span class="keyword">;<br />
 ...
 <a name="107182"></a>
 <div class="note">
  <strong class='user'>krauth dot spam1 at gmail dot com</strong>
  <a href="#107182" class="date">12-Jan-2012 01:19</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
</span><span class="keyword">class </span><span class="default">Gotcha </span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; var </span><span class="default">$x</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; public function </span><span class="default">Gotcha</span><span class="keyword">(</span><span class="default">$init_value</span><span class="keyword">) {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">x </span><span class="keyword">= </span><span class="default">$init_value</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
echo </span><span class="string">"&lt;PRE&gt;\n\n"</span><span class="keyword">;<br />
<br />
echo </span><span class="string">"old PHP 4 style, generates 'deprecated' warnings:\n"</span><span class="keyword">;<br />
</span><span class="default">$objs </span><span class="keyword">= array();<br />
foreach (array(</span><span class="default">37</span><span class="keyword">, </span><span class="string">"Wisconsin"</span><span class="keyword">, </span><span class="default">3.14159</span><span class="keyword">) as </span><span class="default">$i</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$a </span><span class="keyword">=&amp; new </span><span class="default">Gotcha</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$objs</span><span class="keyword">[] =&amp; </span><span class="default">$a</span><span class="keyword">;<br />
}<br />
</span><span class="default">var_export</span><span class="keyword">(</span><span class="default">$objs</span><span class="keyword">);<br />
echo </span><span class="string">"\n\n"</span><span class="keyword">;<br />
<br />
echo </span><span class="string">"new PHP 5 style, ** only change is removal of &amp; in 'new' assignment **:\n"</span><span class="keyword">;<br />
</span><span class="default">$objs </span><span class="keyword">= array();<br />
foreach (array(</span><span class="default">37</span><span class="keyword">, </span><span class="string">"Wisconsin"</span><span class="keyword">, </span><span class="default">3.14159</span><span class="keyword">) as </span><span class="default">$i</span><span class="keyword">) {<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$a </span><span class="keyword">= new </span><span class="default">Gotcha</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$objs</span><span class="keyword">[] =&amp; </span><span class="default">$a</span><span class="keyword">;<br />
...
echo </span><span class="string">"php version = " </span><span class="keyword">. </span><span class="default">phpversion</span><span class="keyword">() . </span><span class="string">"\n"</span><span class="keyword">;<br />
...
php version = 5.3.3-7+squeeze3</span>
</code></div>
  </div>
 </div>
 <a name="102932"></a>
 <div class="note">
  <strong class='user'>bjb6371 at rit dot edu</strong>
  <a href="#102932" class="date">15-Mar-2011 06:48</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I've personally found the clone operation to be less than desirable in creating duplicate objects. I've therefore resided to the solution of using a Copyable interface which requires a single method, copy, to be implemented. Copy would then perform the assignment to a new instance of the object from the $this reference. This prevents referencing issues between cloned copies of the same object.<br />
<br />
If anyone has a more robust solution to a string reference acting "static" across cloned objects please let me know. I've given up at this point.</span>
</code></div>
  </div>
 </div>
 <a name="101376"></a>
 <div class="note">
  <strong class='user'>caslav dot sabani at gmail dot com</strong>
  <a href="#101376" class="date">13-Dec-2010 07:48</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Consider this when using references:<br />
<br />
<span class="default">&lt;?php<br />
<br />
</span><span class="keyword">class </span><span class="default">Test<br />
</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; public </span><span class="default">$var</span><span class="keyword">;<br />
}<br />
<br />
</span><span class="default">$a </span><span class="keyword">= new </span><span class="default">Test</span><span class="keyword">();<br />
</span><span class="default">$a</span><span class="keyword">-&gt;</span><span class="default">var </span><span class="keyword">= </span><span class="default">10</span><span class="keyword">;<br />
<br />
...
<br />
echo </span><span class="string">'&lt;b&gt;$a&lt;/b&gt;:'</span><span class="keyword">;<br />
...
<br />
echo </span><span class="string">'after &lt;b&gt;unsetting&lt;/b&gt; $b&nbsp; &lt;b&gt;$a&lt;/b&gt; is:'</span><span class="keyword">;<br />
echo </span><span class="string">'&lt;pre&gt;'</span><span class="keyword">;<br />
</span><span class="default">print_r</span><span class="keyword">( </span><span class="default">$a </span><span class="keyword">);<br />
echo </span><span class="string">'&lt;/pre&gt;'</span><span class="keyword">;<br />
<br />
unset( </span><span class="default">$c </span><span class="keyword">);<br />
<br />
echo </span><span class="string">'after &lt;b&gt;unsetting&lt;/b&gt; $c &lt;b&gt;$a&lt;/b&gt; is:'</span><span class="keyword">;<br />
echo </span><span class="string">'&lt;pre&gt;'</span><span class="keyword">;<br />
</span><span class="default">print_r</span><span class="keyword">( </span><span class="default">$a </span><span class="keyword">);<br />
echo </span><span class="string">'&lt;/pre&gt;'</span><span class="keyword">;<br />
<br />
...
<br />
echo </span><span class="string">'after &lt;b&gt;nulling&lt;/b&gt; $b&nbsp; &lt;b&gt;$a&lt;/b&gt; is:'</span><span class="keyword">;<br />
echo </span><span class="string">'&lt;pre&gt;'</span><span class="keyword">;<br />
</span><span class="default">print_r</span><span class="keyword">( </span><span class="default">$a </span><span class="keyword">);<br />
echo </span><span class="string">'&lt;/pre&gt;'</span><span class="keyword">;<br />
<br />
...
<br />
echo </span><span class="string">'after &lt;b&gt;nulling&lt;/b&gt; $c &lt;b&gt;$a&lt;/b&gt; is:'</span><span class="keyword">;<br />
echo </span><span class="string">'&lt;pre&gt;'</span><span class="keyword">;<br />
</span><span class="default">print_r</span><span class="keyword">( </span><span class="default">$a </span><span class="keyword">);<br />
echo </span><span class="string">'&lt;/pre&gt;'</span><span class="keyword">;<br />
<br />
...
&nbsp;&nbsp;&nbsp; [odma] =&gt; jugo\'slavija<br />
 ...
 <a name="99668"></a>
 <div class="note">
  <strong class='user'>dev dot php at linke-t dot net</strong>
  <a href="#99668" class="date">30-Aug-2010 02:01</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I thought Yeah pointer likly behavior... but i watched serilized objects and what i did see? referenced Objects are outputed like the object self.<br />
<br />
Here is a simple code, it shows that the references are sweet but in some case (storing objects to $_SESSION or Database) unuseable:<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">class </span><span class="default">foo</span><span class="keyword">{<br />
&nbsp;&nbsp;&nbsp; private static </span><span class="default">$id_c </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; public </span><span class="default">$ref</span><span class="keyword">;<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">id</span><span class="keyword">=</span><span class="default">self</span><span class="keyword">::</span><span class="default">$id_c</span><span class="keyword">++;<br />
&nbsp;&nbsp;&nbsp; }&nbsp; &nbsp; <br />
}<br />
...
</span><span class="default">$a</span><span class="keyword">-&gt;</span><span class="default">ref </span><span class="keyword">= &amp;</span><span class="default">$b</span><span class="keyword">;<br />
<br />
</span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">);<br />
...
<br />
</span><span class="default">$a</span><span class="keyword">-&gt;</span><span class="default">ref</span><span class="keyword">-&gt;</span><span class="default">id</span><span class="keyword">++;<br />
echo </span><span class="string">"increment \$a-&gt;ref-&gt;id++;&lt;br/&gt;&lt;br/&gt;"</span><span class="keyword">;<br />
<br />
</span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">);<br />
echo </span><span class="string">"&lt;br/&gt;"</span><span class="keyword">;<br />
</span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$b</span><span class="keyword">);<br />
echo </span><span class="string">"&lt;br/&gt;&lt;br/&gt;"</span><span class="keyword">;<br />
echo </span><span class="string">"\$a2=unserialize(serialize(\$a));&lt;br/&gt;&lt;br/&gt;"</span><span class="keyword">;<br />
</span><span class="default">$a2</span><span class="keyword">=</span><span class="default">unserialize</span><span class="keyword">(</span><span class="default">serialize</span><span class="keyword">(</span><span class="default">$a</span><span class="keyword">));<br />
<br />
</span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$a2</span><span class="keyword">);<br />
echo </span><span class="string">"&lt;br/&gt;"</span><span class="keyword">;<br />
</span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$b</span><span class="keyword">);<br />
echo </span><span class="string">"&lt;br/&gt;&lt;br/&gt;"</span><span class="keyword">;<br />
<br />
</span><span class="default">$a2</span><span class="keyword">-&gt;</span><span class="default">ref</span><span class="keyword">-&gt;</span><span class="default">id</span><span class="keyword">++;<br />
echo </span><span class="string">"increment \$a2-&gt;ref-&gt;id++;&lt;br/&gt;&lt;br/&gt;"</span><span class="keyword">;<br />
<br />
</span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$a2</span><span class="keyword">);<br />
echo </span><span class="string">"&lt;br/&gt;"</span><span class="keyword">;<br />
</span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$b</span><span class="keyword">);<br />
...
Output on PHP 5.3.3:<br />
foo Object ( [ref] =&gt; foo Object ( [ref] =&gt; [id] =&gt; 1 ) [id] =&gt; 0 ) <br />
foo Object ( [ref] =&gt; [id] =&gt; 1 ) <br />
<br />
increment $a-&gt;ref-&gt;id++;<br />
<br />
foo Object ( [ref] =&gt; foo Object ( [ref] =&gt; [id] =&gt; 2 ) [id] =&gt; 0 ) <br />
foo Object ( [ref] =&gt; [id] =&gt; 2 ) <br />
<br />
$a2=unserialize(serialize($a));<br />
<br />
foo Object ( [ref] =&gt; foo Object ( [ref] =&gt; [id] =&gt; 2 ) [id] =&gt; 0 ) <br />
foo Object ( [ref] =&gt; [id] =&gt; 2 ) <br />
<br />
increment $a2-&gt;ref-&gt;id++;<br />
<br />
foo Object ( [ref] =&gt; foo Object ( [ref] =&gt; [id] =&gt; 3 ) [id] =&gt; 0 ) <br />
foo Object ( [ref] =&gt; [id] =&gt; 2 )<br />
<br />
after unserialize $a2-&gt;ref isn't any more a reference.<br />
<br />
To save items for the next request, you must avoid references and save all objects of a class in an array. To get a PHP-reference you could write a function like:<br />
<span class="default">&lt;?php <br />
</span><span class="keyword">function </span><span class="default">get_obj_by_ref</span><span class="keyword">(</span><span class="default">$ref</span><span class="keyword">){<br />
&nbsp;&nbsp;&nbsp; global </span><span class="default">$_array_where_objects_of_class_foo_are_stored</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$r </span><span class="keyword">= &amp;</span><span class="default">$_array_where_objects_of_class_foo_are_stored</span><span class="keyword">[</span><span class="default">$ref</span><span class="keyword">];<br />
&nbsp;&nbsp;&nbsp; return </span><span class="default">$r</span><span class="keyword">;<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
I am unhappy about this behavior of PHP. I does not watch like a feature ... ;)</span>
</code></div>
  </div>
 </div>
 <a name="99644"></a>
...
A_obj info: xxxxx</span>
 ...
 <div class="note">
  ...
  <a href="#93812" class="date">30-Sep-2009 11:59</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Hope that delicate piece of information will save someone else a few hours.</span>
 ...
 <div class="note">
  ...
  <a href="#92215" class="date">14-Jul-2009 11:56</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
It was written for PHP 4 but it still applies. The only difference is in how PHP 5 handles objects: passing object variables by value only copies an internal pointer to the object. Objects in PHP 5 are only ever duplicated if you explicitly use the clone keyword.</span>
 ...
 <div class="note">
  ...
  <a href="#88821" class="date">09-Feb-2009 02:00</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; [c] =&gt; third<br />
 ...
 <div class="note">
  ...
  <a href="#85118" class="date">15-Aug-2008 07:22</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
As stated, there's rarely (if ever) a need to use references for optimization purposes. When in doubt, remember that in most cases, the Zend Engine &gt; you.</span>
 ...
 <div class="note">
  ...
  <a href="#84712" class="date">26-Jul-2008 07:06</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Just a side note to make developpers more careful about references.<br />
References are pretty much useful when you try to optimize your code.<br />
<br />
By the way, the time gained by referenced variables will depend of the variable type.<br />
<br />
Integer and Float variables will work quite as fast referenced or not.<br />
Whereas String and Array should be always passed by reference (you mostly divide by 10 the execution time).<br />
Objects are automatically referenced by PHP.<br />
<br />
Enjoy the references !</span>
</code></div>
  </div>
 </div>
 <a name="84502"></a>
...
&nbsp;&nbsp;&nbsp; )</span>
 ...
 <a name="82791"></a>
 <div class="note">
  <strong class='user'>Radek at cz</strong>
  <a href="#82791" class="date">25-Apr-2008 11:35</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
It took me a long while until I fully understood the sentence mentioned above:<br />
<br />
"They (references) are not like C pointers; instead, they are symbol table aliases."<br />
<br />
Here is a little example to that.<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">class </span><span class="default">AnyClass </span><span class="keyword">{<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">member </span><span class="keyword">= </span><span class="default">$val</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
}<br />
<br />
</span><span class="default">$manyObjects </span><span class="keyword">= array();<br />
</span><span class="default">$obj </span><span class="keyword">= </span><span class="default">null</span><span class="keyword">;<br />
<br />
...
&nbsp;&nbsp;&nbsp; </span><span class="default">$obj </span><span class="keyword">= new </span><span class="default">AnyClass</span><span class="keyword">(</span><span class="default">$i</span><span class="keyword">); </span><span class="comment">// create new instance<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$manyObjects</span><span class="keyword">[] = &amp;</span><span class="default">$obj</span><span class="keyword">; </span><span class="comment">// i did not wanted to copy, just store the reference in the array, which turned out to be WRONG (it is not reference to the CLASS INSTANCE what is stored in the array, but rather reference to what variable with NAME $obj CURRENTLY holds). <br />
// so we end up as shown below<br />
</span><span class="keyword">}<br />
<br />
for(</span><span class="default">$i </span><span class="keyword">= </span><span class="default">0</span><span class="keyword">; </span><span class="default">$i </span><span class="keyword">&lt; </span><span class="default">5</span><span class="keyword">;</span><span class="default">$i</span><span class="keyword">++) {<br />
&nbsp;&nbsp;&nbsp; echo </span><span class="string">"Value:"</span><span class="keyword">.</span><span class="default">$manyObjects</span><span class="keyword">[</span><span class="default">$i</span><span class="keyword">]-&gt;</span><span class="default">member</span><span class="keyword">.</span><span class="string">"\r\n"</span><span class="keyword">;<br />
}&nbsp; &nbsp; <br />
<br />
</span><span class="comment">/**<br />
&nbsp;* Output is :<br />
...
&nbsp;*/<br />
<br />
// If we change the value of $obj later in the script, all members would be changed in that moment<br />
<br />
</span><span class="default">$obj </span><span class="keyword">= </span><span class="default">1</span><span class="keyword">;<br />
</span><span class="default">print_r</span><span class="keyword">(</span><span class="default">$manyObjects</span><span class="keyword">);<br />
</span><span class="comment">/*<br />
Array<br />
(<br />
&nbsp;&nbsp;&nbsp; [0] =&gt; 1<br />
...
Hope this spares someone few hours of time ;-)</span>
</code></div>
  </div>
 </div>
 <a name="82703"></a>
 <div class="note">
  <strong class='user'>Anonymous</strong>
  <a href="#82703" class="date">22-Apr-2008 11:42</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
$this-&gt;$var['key'] tries to look up 'key' in the array $var and then use that for the property name. $this-&gt;{$var}['key'], on the other hand...</span>
 ...
 <a name="79398"></a>
 <div class="note">
  <strong class='user'>alexey at gmail dot com</strong>
  <a href="#79398" class="date">25-Nov-2007 12:47</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I will describe how references interact with global variables.<br />
<br />
Consider the following example. You create a DOM tree and then you use two functions. The first chooses an arbitrary tree element, while the second uses that element. Let us use a global variable as the means of communication between the two functions:<br />
<br />
// global variable<br />
var $dom_el;<br />
<br />
test1(); // call first function<br />
test2(); // call second function<br />
<br />
function test1() {<br />
global $dom_el, $Doc;<br />
<br />
$dom_el = &amp;$Doc-&gt;childNodes-&gt;item(0);<br />
}<br />
<br />
function test2() {<br />
global $dom_el;<br />
<br />
// $dom_el does not contain the reference! You cannot use it here.<br />
// I am using PHP 4.4.6<br />
}<br />
<br />
If we assign a reference to the desired tree node in the first function then surprisingly the reference will disappear after the first function returns. That is, that reference is not saved in the global variable. Most likely, it is a feature of PHP 4 language. Specifically, I am using PHP 4.4.6. Thus, using a global variable to pass a reference from one function to another does not work.<br />
<br />
However, if we save the reference as a field of an object, then the reference is preserved. Therefore, we need to wrap the global variable<br />
in a class:<br />
<br />
class Pointer {<br />
var $i;<br />
...
<br />
$dom_el=new Pointer();<br />
<br />
function test1() {<br />
global $dom_el, $Doc;<br />
$tmp = &amp;$Doc-&gt;childNodes-&gt;item(0);<br />
$dom_cur-&gt;set($tmp);<br />
}<br />
<br />
function test2() {<br />
...
<br />
$tmp = &amp;$dom_cur-&gt;get();<br />
//$tmp has the desired reference<br />
}</span>
</code></div>
  </div>
 </div>
...
foo(&amp;bar);</span>
 ...
 <div class="note">
  ...
  <a href="#78789" class="date">27-Oct-2007 03:21</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; [96] =&gt; 43<br />
 ...
 <a name="78100"></a>
 <div class="note">
  <strong class='user'>rmaj</strong>
  <a href="#78100" class="date">27-Sep-2007 10:52</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
&lt;?<br />
<br />
$a = array("a"=&gt;"111", "b"=&gt;"222", "c"=&gt;"333");<br />
foreach ($a as $ix =&gt; $val) {<br />
&nbsp; $ref = &amp;$a[$ix];<br />
&nbsp; $ref = $val . '_changed';<br />
}<br />
<br />
foreach ($a as $ix =&gt; $val) echo "$val ";<br />
// 111_changed 222_changed 333_changed<br />
<br />
?&gt;<br />
<br />
is a simply way to change elements of array witohut retyping $array_name[$index] all the time</span>
</code></div>
  </div>
 </div>
 <a name="76128"></a>
 <div class="note">
  <strong class='user'>riseofthethorax at gmail dot com</strong>
  <a href="#76128" class="date">01-Jul-2007 03:27</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
I don't see what the big fuss is, I've used pass <br />
by reference to modify dangling variables in tree structures serializing and deserializing structures to databases.. It seems the reason for this limitation is due to the 99% PHP Newbie syndrome and their lack of pointer experience.. Note the only difference between C and PHP references is there is no pointer arithmetic.. Whether it's an alias or a memory location with the address of another, it's basically the same thing.. If you wanted I could implement tree structures in a linear resizeable array.<br />
<br />
What am I supposed to do with <br />
array_walk(&amp;$datastructure,'function'); <br />
????<br />
<br />
What am I not getting here.. What is the logic behind disabling it.. When did the PHP coders get all theoretical on us.. C is a great language because it keeps the idiots at bay, and allows you to shoot yourself in the foot if you really want to.. If I wanted to protect myself from bad code techniques I'd go write in python or lisp. <br />
<br />
Better yet why don't we send the 99% to school to get computer science degrees.</span>
</code></div>
  </div>
 </div>
 <a name="75635"></a>
...
<br />
<a href="http://www.obdev.at/developers/articles/00002.html" rel="nofollow" target="_blank">http://www.obdev.at/developers/articles/00002.html</a> says there's no such thing as an "object reference" in PHP, but with detaching it becomes possible.<br />
<br />
...
This produces an n dimensional array that will be available in the $eval_array variable. Hope it helps somebody!</span>
 ...
 <a name="62531"></a>
 <div class="note">
  <strong class='user'>Xor</strong>
  <a href="#62531" class="date">02-Mar-2006 07:43</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
if given little - passing an array by reference slower than by value, <br />
but not if it is necessary to process much data.<br />
<br />
...
<br />
// fill array<br />
for($n=0; $n&lt;500000; $n++) {<br />
&nbsp;&nbsp; $ar[] = "test".$n;<br />
}<br />
$Bs = array_sum(explode(' ', microtime()));<br />
test_ref($ar);<br />
echo "&lt;br /&gt;The function using a reference took ".(array_sum(explode(' ', microtime()))-$Bs);<br />
$Bs = array_sum(explode(' ', microtime()));<br />
test_val($ar);<br />
echo "&lt;br /&gt;The funktion using a value took: ".(array_sum(explode(' ', microtime()))-$Bs);<br />
<br />
The function using a reference took 10.035583019257<br />
The funktion using a value took: 10.531390190125</span>
</code></div>
  </div>
 </div>
 <a name="60986"></a>
...
Responding to Slava Kudinov.&nbsp; The only reason why your script takes longer when you pass by reference is that you do not at all modify the array that your passing to your functions.&nbsp; If you do that the diffrences in execution time will be a lot smaller.&nbsp; In fact&nbsp; passing by reference will be faster if just by a little bit.</span>
 ...
 <div class="note">
  ...
  <a href="#60979" class="date">22-Jan-2006 02:01</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
If you want to *copy* object in PHP 5, use object clone.</span>
 ...
 <div class="note">
  ...
  <a href="#57365" class="date">01-Oct-2005 06:08</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
doNotCorrupt2: $original-&gt;i-&gt;property = 'Original Value'</span>
 ...
 <div class="note">
  ...
  <a href="#52926" class="date">17-May-2005 02:51</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
And, further...<br />
<br />
...
&nbsp;&nbsp;&nbsp; print </span><span class="string">"$index\n"</span><span class="keyword">;<br />
}<br />
<br />
</span><span class="default">?&gt;<br />
</span><br />
...
when you refernce $temp to $object all it does is make $temp an alias to the same memory as $object, so doing $temp-&gt;getNext(); and $object-&gt;getNext(); are calling the same function on the same object.&nbsp; Try it out if you don't believe me.</span>
 ...
 <div class="note">
  ...
  <a href="#42192" class="date">07-May-2004 12:33</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<br />
<a href="@w{KMMWKF3E}" rel="nofollow" target="_blank">@w{KMMWKF3E}</a><br />
<br />
...
<a href="http://www.zend.com/zend/art/ref-count.php" rel="nofollow" target="_blank">http://www.zend.com/zend/art/ref-count.php</a></span>
 ...
 <div class="note">
  ...
  <a href="#39588" class="date">03-Feb-2004 10:30</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
$object =&amp; $temp-&gt;getNext();</span>
 ...
 <div class="foot"><a href="/manual/add-note.php?sect=language.references&amp;redirect=http://www.php.net/manual/en/language.references.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.references&amp;redirect=http://www.php.net/manual/en/language.references.php">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.references.php">show source</a> |

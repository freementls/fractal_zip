...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="wrappers.ssh2.php" />
 <link rel="next" href="wrappers.audio.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/wrappers.rar" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/wrappers.rar.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="http://www.php.net/manual/en/wrappers.rar.php" />
...
<ul class="toc">
 ...
 <li class="active"><a href="wrappers.rar.php">rar://</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="wrappers.audio.php">ogg://<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="wrappers.ssh2.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />ssh2://</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/wrappers.rar.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
 <div class="langchooser">
  <form action="/manual/change.php" method="get">
   <p>view this page in </p><fieldset><select name="page">
    ...
    <option value="pl/wrappers.rar.php">Polish</option>
    <option value="ro/wrappers.rar.php">Romanian</option>
    <option value="ru/wrappers.rar.php">Russian</option>
    <option value="fa/wrappers.rar.php">Persian</option>
...
<div id="wrappers.rar" class="refentry">
 ...
 <div class="refsect1 description" id="refsect1-wrappers.rar-description">
  ...
  <p class="simpara">
   ...
   <a href="class.recursivedirectoryiterator.php" class="classname">RecursiveDirectoryIterator</a> in the presence of file names that seem like
   url encoded data.
  </p>
  ...
  <p class="simpara">
   ...
   The usage of the wrapper with <a href="class.recursivedirectoryiterator.php" class="classname">RecursiveDirectoryIterator</a> requires
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=wrappers.rar&amp;redirect=http://www.php.net/manual/en/wrappers.rar.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=wrappers.rar&amp;redirect=http://www.php.net/manual/en/wrappers.rar.php">add a note</a></small></span>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/wrappers.rar.php">show source</a> |

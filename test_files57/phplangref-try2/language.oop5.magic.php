...
<head profile="@w{B8XXCD23}">
 ...
 <link rel="prev" href="language.oop5.iterations.php" />
 <link rel="next" href="language.oop5.final.php" />
 <link rel="schema.dc" href="@w{RNCDA8N4}" />
 <link rel="schema.rdfs" href="@w{XGTVB7JY}" />
 <link rev="canonical" rel="self alternate shorter shorturl shortlink" href="http://php.net/oop5.magic" />
 <link rel="license" href="@w{G88D3FDX}" about="#content" />
 <link rel="canonical" href="http://php.net/manual/en/language.oop5.magic.php" />
 <script type="text/javascript" src="@w{4SAB2YT3}"></script>
 <base href="http://www.php.net/manual/en/language.oop5.magic.php" />
...
<ul class="toc">
 ...
 <li class="active"><a href="language.oop5.magic.php">Magic Methods</a></li>
...
<div class="manualnavbar manualnavbar_top">
 <span class="next">
  <a href="language.oop5.final.php">Final Keyword<img src="@w{GVN7ETSY}" alt="&gt;" width="11" height="7" /></a>
 </span>
 <span class="prev">
  <a href="language.oop5.iterations.php"><img src="@w{KX8YRRP2}" alt="&lt;" width="11" height="7" />Object Iteration</a>
 </span>
 <hr />
 <span class="lastupdated">[<a href="https://edit.php.net/?project=PHP&amp;perm=en/language.oop5.magic.php">edit</a>] Last updated: Fri, 27 Jul 2012</span>
...
<div id="language.oop5.magic" class="sect1">
  ...
  <p class="para">
   ...
   <a href="language.oop5.magic.php#object.set-state" class="link">__set_state()</a> and
...
<div id="usernotes">
 <div class="head">
  <span class="action"><a href="/manual/add-note.php?sect=language.oop5.magic&amp;redirect=http://www.php.net/manual/en/language.oop5.magic.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.oop5.magic&amp;redirect=http://www.php.net/manual/en/language.oop5.magic.php">add a note</a></small></span>
  <small>User Contributed Notes</small>
  <strong>Magic Methods</strong>
 </div><div id="allnotes">
 <a name="109040"></a>
 <div class="note">
  <strong class='user'>miguel dot perez at afina dot es</strong>
  <a href="#109040" class="date">15-Jun-2012 08:17</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Both __call and __invoke exist and do completely different things. Nice.</span>
</code></div>
  </div>
 </div>
 <a name="107535"></a>
 <div class="note">
  ...
  <a href="#107535" class="date">15-Feb-2012 09:48</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
PHP Fatal error:&nbsp; Call to undefined method B::a()</span>
 ...
 <div class="note">
  ...
  <a href="#105936" class="date">26-Sep-2011 06:07</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
</span><span class="default">            print </span><span class="string">"The value of \$param{$i} is: " </span><span class="keyword">. </span><span class="default">$arg </span><span class="keyword">. </span><span class="default">PHP_EOL</span><span class="keyword">;<br />
...
&nbsp; return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">sToString</span><span class="keyword">;<br />
 ...
 <div class="note">
  ...
  <a href="#99453" class="date">18-Aug-2010 08:13</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<span class="default">&lt;?php<br />
</span><span class="keyword">class </span><span class="default">user_bo</span><span class="keyword">{<br />
<br />
&nbsp;&nbsp;&nbsp; protected </span><span class="default">$attributes </span><span class="keyword">= Array();<br />
&nbsp;&nbsp;&nbsp; <br />
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">array_key_exists</span><span class="keyword">(</span><span class="default">$key</span><span class="keyword">, </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">attributes</span><span class="keyword">) ? </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">attributes</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">] : </span><span class="default">null</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp;&nbsp; <br />
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">attributes</span><span class="keyword">[</span><span class="default">$key</span><span class="keyword">] = </span><span class="default">$value</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp;&nbsp; <br />
...
<span class="default">&lt;?php<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">public function </span><span class="default">update</span><span class="keyword">(){<br />
<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; global </span><span class="default">$database</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$fields </span><span class="keyword">= </span><span class="default">$database</span><span class="keyword">-&gt;</span><span class="default">connection</span><span class="keyword">-&gt;</span><span class="default">getTable</span><span class="keyword">(</span><span class="string">"users"</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$set </span><span class="keyword">= </span><span class="string">""</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; foreach(</span><span class="default">$fields </span><span class="keyword">as </span><span class="default">$field </span><span class="keyword">=&gt; </span><span class="default">$info</span><span class="keyword">){<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; if(isset(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">$field</span><span class="keyword">)){<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; if(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">$field </span><span class="keyword">== </span><span class="string">"now()"</span><span class="keyword">){<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$set </span><span class="keyword">.= </span><span class="default">$field</span><span class="keyword">.</span><span class="string">"="</span><span class="keyword">.</span><span class="default">mysql_real_escape_string</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">$field</span><span class="keyword">).</span><span class="string">", "</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }elseif(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">$field </span><span class="keyword">== </span><span class="default">null</span><span class="keyword">){<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$set </span><span class="keyword">.= </span><span class="default">$field</span><span class="keyword">.</span><span class="string">"=null, "</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }else{<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$set </span><span class="keyword">.= </span><span class="default">$field</span><span class="keyword">.</span><span class="string">"='"</span><span class="keyword">.</span><span class="default">mysql_real_escape_string</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">$field</span><span class="keyword">).</span><span class="string">"', "</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$output_set </span><span class="keyword">= </span><span class="default">substr</span><span class="keyword">(</span><span class="default">$set</span><span class="keyword">, </span><span class="default">0</span><span class="keyword">, -</span><span class="default">2</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$query </span><span class="keyword">= </span><span class="string">"UPDATE users SET $output_set WHERE sequal_user_id = '$this-&gt;sequal_user_id'"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">mysql_query</span><span class="keyword">(</span><span class="default">$query</span><span class="keyword">) or </span><span class="default">sqlerrorhandler</span><span class="keyword">(</span><span class="string">"("</span><span class="keyword">.</span><span class="default">mysql_errno</span><span class="keyword">().</span><span class="string">") "</span><span class="keyword">.</span><span class="default">mysql_error</span><span class="keyword">(), </span><span class="default">$query</span><span class="keyword">, </span><span class="default">$_SERVER</span><span class="keyword">[</span><span class="string">'PHP_SELF'</span><span class="keyword">], </span><span class="default">__LINE__</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
...
I return null if my variable don't exist.</span>
</code></div>
  </div>
 </div>
 <a name="99058"></a>
...
Functionally, __invoke() can also be used to mimic the use of variable functions.&nbsp; Sadly, attempting any calling of __invoke() on a static level will produce a fatal error.</span>
 ...
 <div class="note">
  ...
  <a href="#98442" class="date">15-Jun-2010 03:26</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Properties can be used for getter and setter as C# methods get_PropertyName and set_PropertyName&nbsp; for full event-based programming.<br />
<br />
<span class="default">&lt;?php<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">/**<br />
&nbsp;&nbsp;&nbsp; * @author Tufan Baris YILDIRIM<br />
&nbsp;&nbsp;&nbsp; * @name getter and setter magics.<br />
&nbsp;&nbsp;&nbsp; */<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">Class </span><span class="default">GetSet<br />
&nbsp;&nbsp;&nbsp; </span><span class="keyword">{<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; public </span><span class="default">$Name</span><span class="keyword">,</span><span class="default">$Surname</span><span class="keyword">;&nbsp; &nbsp;&nbsp; </span><span class="comment">// they will be deleted those only for autocompletion.<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">private </span><span class="default">$_Name</span><span class="keyword">,</span><span class="default">$_Surname</span><span class="keyword">;<br />
<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; public function </span><span class="default">__construct</span><span class="keyword">()<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; foreach(</span><span class="default">get_class_vars</span><span class="keyword">(</span><span class="string">'GetSet'</span><span class="keyword">) as </span><span class="default">$varName</span><span class="keyword">=&gt;</span><span class="default">$varValue</span><span class="keyword">)<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; if(</span><span class="default">substr</span><span class="keyword">(</span><span class="default">$varName</span><span class="keyword">,</span><span class="default">0</span><span class="keyword">,</span><span class="default">1</span><span class="keyword">)!=</span><span class="string">"_"</span><span class="keyword">)<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; unset(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">$varName</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; public function </span><span class="default">__get</span><span class="keyword">(</span><span class="default">$varName</span><span class="keyword">)<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; if(</span><span class="default">method_exists</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">,</span><span class="default">$MethodName</span><span class="keyword">=</span><span class="string">'get_'</span><span class="keyword">.</span><span class="default">$varName</span><span class="keyword">))<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">$MethodName</span><span class="keyword">();<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; else<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">trigger_error</span><span class="keyword">(</span><span class="default">$varName</span><span class="keyword">.</span><span class="string">' is not avaliable .'</span><span class="keyword">,</span><span class="default">E_USER_ERROR</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; public function </span><span class="default">__set</span><span class="keyword">(</span><span class="default">$varName</span><span class="keyword">,</span><span class="default">$value</span><span class="keyword">)<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; if(</span><span class="default">method_exists</span><span class="keyword">(</span><span class="default">$this</span><span class="keyword">,</span><span class="default">$MethodName</span><span class="keyword">=</span><span class="string">'set_'</span><span class="keyword">.</span><span class="default">$varName</span><span class="keyword">))<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">$MethodName</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; else<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">trigger_error</span><span class="keyword">(</span><span class="default">$varName</span><span class="keyword">.</span><span class="string">' is not avaliable .'</span><span class="keyword">,</span><span class="default">E_USER_ERROR</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; private function </span><span class="default">set_Surname</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">)<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment">// On surname changed Events.<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">echo </span><span class="string">"Surname Changed as "</span><span class="keyword">.</span><span class="default">$value</span><span class="keyword">.</span><span class="string">"\r\n"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">_Surname</span><span class="keyword">=</span><span class="default">$value</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; private function </span><span class="default">get_Surname</span><span class="keyword">()<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment">// On Get Events.<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">echo </span><span class="string">"Surname Getted\r\n"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">_Surname</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; private function </span><span class="default">set_Name</span><span class="keyword">(</span><span class="default">$value</span><span class="keyword">)<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment">// On Name changed Events.<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">echo </span><span class="string">"Name Changed as "</span><span class="keyword">.</span><span class="default">$value</span><span class="keyword">.</span><span class="string">"\r\n"</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">_Name</span><span class="keyword">=</span><span class="default">$value</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; private function </span><span class="default">get_Name</span><span class="keyword">()<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment">// On Get Name Events.<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="keyword">echo </span><span class="string">"Name getted\r\n"</span><span class="keyword">;<br />
...
<span class="default">&lt;?php<br />
&nbsp;&nbsp; $get</span><span class="keyword">=new </span><span class="default">GetSet</span><span class="keyword">();<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$get</span><span class="keyword">-&gt;</span><span class="default">Name</span><span class="keyword">=</span><span class="string">"Tufan Baris"</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$get</span><span class="keyword">-&gt;</span><span class="default">Surname</span><span class="keyword">=</span><span class="string">"YILDIRIM"</span><span class="keyword">;<br />
<br />
&nbsp;&nbsp;&nbsp; echo </span><span class="default">$get</span><span class="keyword">-&gt;</span><span class="default">Name</span><span class="keyword">.</span><span class="string">' '</span><span class="keyword">.</span><span class="default">$get</span><span class="keyword">-&gt;</span><span class="default">Surname</span><span class="keyword">;<br />
<br />
</span><span class="default">?&gt;<br />
</span>Output <br />
<br />
Name Changed as Tufan Baris<br />
Surname Changed asYILDIRIM<br />
Name getted<br />
Surname Getted<br />
Tufan Baris YILDIRIM</span>
</code></div>
  </div>
 </div>
 <a name="94972"></a>
 <div class="note">
  ...
  <a href="#94972" class="date">05-Dec-2009 08:01</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">AnyFunction</span><span class="keyword">( </span><span class="default">$a</span><span class="keyword">, </span><span class="default">$b</span><span class="keyword">, </span><span class="default">$c </span><span class="keyword">)<br />
{<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">LogEnter</span><span class="keyword">();<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// DoSomeStuffHere.<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">LogExit</span><span class="keyword">();<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
...
<span class="default">&lt;?php<br />
</span><span class="keyword">public function </span><span class="default">LogEnter</span><span class="keyword">()<br />
{<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$Debug </span><span class="keyword">= </span><span class="default">debug_backtrace</span><span class="keyword">();<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$DebugLine </span><span class="keyword">= </span><span class="default">$Debug</span><span class="keyword">[ </span><span class="default">1 </span><span class="keyword">];<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="comment">// [0] would be this very same function.<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; // [1] is the caller of this function.<br />
<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$Args </span><span class="keyword">= isset( </span><span class="default">$DebugLine</span><span class="keyword">[ </span><span class="string">'args' </span><span class="keyword">] ) ? </span><span class="default">$DebugLine</span><span class="keyword">[ </span><span class="string">'args' </span><span class="keyword">] : </span><span class="string">'[x]'</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$Msg </span><span class="keyword">= </span><span class="string">'Entering with ' </span><span class="keyword">. </span><span class="default">BuildArgs</span><span class="keyword">( </span><span class="default">$Args </span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">LogWrite</span><span class="keyword">( </span><span class="default">$Msg </span><span class="keyword">);<br />
}<br />
<br />
</span><span class="comment">// CAUTION, THIS NEXT ONE FAILS<br />
</span><span class="keyword">private function </span><span class="default">BuildArgs</span><span class="keyword">( </span><span class="default">$Args </span><span class="keyword">)<br />
{<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$Result </span><span class="keyword">= </span><span class="string">'( ' </span><span class="keyword">. </span><span class="default">implode</span><span class="keyword">( </span><span class="string">', '</span><span class="keyword">, </span><span class="default">$Args </span><span class="keyword">) . </span><span class="string">' )'</span><span class="keyword">;<br />
...
{<br />
&nbsp;&nbsp;&nbsp; </span><span class="comment">// This function gets an 'args' array from debug_backtrace() and formats it in the printable format (a, b, c) including the parenthesis.<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$FormattedParams </span><span class="keyword">= </span><span class="string">''</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$Glue </span><span class="keyword">= </span><span class="string">''</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; foreach( </span><span class="default">$Args </span><span class="keyword">as </span><span class="default">$Value </span><span class="keyword">)<br />
&nbsp;&nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; if( </span><span class="default">is_object</span><span class="keyword">( </span><span class="default">$Value </span><span class="keyword">) )<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; if( </span><span class="default">method_exists</span><span class="keyword">( </span><span class="default">$Value</span><span class="keyword">, </span><span class="string">"__toString" </span><span class="keyword">) )<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$PrintableValue </span><span class="keyword">= </span><span class="default">$Value</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; else<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; {<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$PrintableValue </span><span class="keyword">= </span><span class="string">'[' </span><span class="keyword">. </span><span class="default">get_class</span><span class="keyword">( </span><span class="default">$Value </span><span class="keyword">) . </span><span class="string">']'</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; else<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; {<br />
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$FormattedParams </span><span class="keyword">.= </span><span class="default">$Glue </span><span class="keyword">. </span><span class="default">$PrintableValue</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$Glue </span><span class="keyword">= </span><span class="string">', '</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; </span><span class="default">$Result </span><span class="keyword">= </span><span class="default">sprintf</span><span class="keyword">( </span><span class="string">'( %s )'</span><span class="keyword">, </span><span class="default">$FormattedParams </span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; <br />
&nbsp;&nbsp;&nbsp; return </span><span class="default">$Result</span><span class="keyword">;<br />
}<br />
</span><span class="default">?&gt;</span>
 ...
 <a name="94077"></a>
 <div class="note">
  <strong class='user'>vad dot viktor at gmail dot com</strong>
  <a href="#94077" class="date">15-Oct-2009 03:06</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
If you are using __autoload to dynamically load your classes, then __invoke won't work. Calling a class like SomeClass() will give and error in this case as it is evaluated first as a function, not as a class and so __autoload won't be triggered.</span>
</code></div>
  </div>
 </div>
 <a name="92466"></a>
 <div class="note">
  ...
  <a href="#92466" class="date">25-Jul-2009 02:47</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; }<br />
 ...
 <div class="note">
  ...
  <a href="#91104" class="date">25-May-2009 12:45</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
Try this one on. <br />
<br />
...
Logically that will work regardless of the _toString(), but I had hoped to post this to help others see that there are a multitude of ways to check the validity of a class once it is loaded. In __construct you can add any number of checks and set your state appropriately.</span>
 ...
 <a name="90666"></a>
 <div class="note">
  <strong class='user'>jahanaddison6 at hotmail dot com</strong>
  <a href="#90666" class="date">03-May-2009 03:16</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
If you're expecting this code to work think again:<br />
<br />
<span class="default">&lt;?php<br />
...
The above code will not work as expected, The Test method will still return true.</span>
</code></div>
  </div>
 </div>
 <a name="90194"></a>
...
Note also that the constructor is executed also, and before __set_state(), making this magic function less magic, imho, (except for the ability to assign private members).</span>
 ...
 <div class="note">
  ...
  <a href="#88045" class="date">07-Jan-2009 07:54</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; </span><span class="default">$s </span><span class="keyword">= </span><span class="string">''</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; if(</span><span class="default">$this</span><span class="keyword">-&gt;</span><span class="default">$attrib </span><span class="keyword">!= </span><span class="string">''</span><span class="keyword">) </span><span class="default">$s </span><span class="keyword">= </span><span class="string">"$attrib = \"$this-&gt;$attrib\""</span><span class="keyword">;<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; return </span><span class="default">$s</span><span class="keyword">;<br />
&nbsp;&nbsp;&nbsp; }<br />
&nbsp;&nbsp;&nbsp; <br />
...
*/<br />
 ...
 <div class="note">
  ...
  <a href="#86622" class="date">26-Oct-2008 03:57</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Being able to represent data-holding objects in standardised string forms makes it much easier for your internal representations of data to be shared in an interoperable way with other applications.</span>
 ...
 <div class="note">
  ...
  <a href="#86096" class="date">02-Oct-2008 04:12</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; </span><span class="keyword">return </span><span class="string">"Point[x=$this-&gt;x, y=$this-&gt;y]"</span><span class="keyword">;<br />
&nbsp; }<br />
}<br />
<br />
...
Line[start=Point[x=10, y=10], end=Point[x=50, y=50]]</span>
 ...
 <div class="note">
  ...
  <a href="#84960" class="date">07-Aug-2008 07:03</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
I hope this solves the mystery for everybody.&nbsp; __sleep() does work, if you use it correctly :-)</span>
 ...
 <div class="note">
  ...
  <a href="#79062" class="date">08-Nov-2007 07:55</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
 ...
 <div class="note">
  ...
  <a href="#76643" class="date">24-Jul-2007 04:58</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
It is particularly important to note this little quirk when designing base classes that their derivables may be serialized, or when subclassing an external library class.</span>
 ...
 <div class="note">
  ...
  <a href="#75037" class="date">09-May-2007 07:47</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp; throw new </span><span class="default">Exception</span><span class="keyword">(</span><span class="string">"unknown method [$method]"</span><span class="keyword">);<br />
&nbsp;&nbsp; &nbsp; &nbsp;&nbsp; }<br />
<br />
...
You could just as easily add an addMixin() method that would allow you to add multiple objects to an array, and then iterate over that array until you found the right method.&nbsp; As noted, these are referred to as a Mixins in other languages.</span>
 ...
 <div class="note">
  ...
  <a href="#74937" class="date">04-May-2007 06:09</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Test@6006ba04f5569544c10a588b04849cf7</span>
 ...
 <div class="note">
  ...
  <a href="#69361" class="date">02-Sep-2006 12:32</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
&nbsp;&nbsp;&nbsp; return $this-&gt;values[$name];<br />
 ...
 <div class="note">
  ...
  <a href="#66140" class="date">15-May-2006 01:54</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
Guestbook</span>
 ...
 <div class="note">
  ...
  <a href="#61745" class="date">10-Feb-2006 09:29</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
oB::oBVar 6</span>
 ...
 <div class="note">
  ...
  <a href="#61130" class="date">26-Jan-2006 03:18</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
...
__sleep() handles protected/private properties very well. You should never rely on get_class_vars() to retrieve property names since this function only returns the public properties. Use the Reflection API instead for that purpose. Better yet, if you know which ones you want to save it is always faster to specify the return array manually.</span>
 ...
 <div class="note">
  ...
  <a href="#54097" class="date">23-Jun-2005 08:52</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
This small sentence tripped me up for a half an hour:<br />
<br />
"It is worth noting that the __toString method will only be called when it is directly combined with echo() or print()."<br />
<br />
So code like this will _not_ work, even though you might think it would:<br />
<br />
&lt;?<br />
<br />
//$x is some variable with a __toString method defined.<br />
$y = "x's value is: " . $x;<br />
$y = "x's value is: " . (string)$x;<br />
<br />
?&gt;<br />
<br />
In _em_ both situations, $y will contain "x's value is: Object id #42" (or whatever object ID). So, the only recourse I guess is this:<br />
<br />
&lt;?<br />
<br />
$y = "x's value is: " . $x-&gt;__toString();<br />
<br />
?&gt;</span>
</code></div>
  </div>
 ...
 <a name="51797"></a>
 <div class="note">
  <strong class='user'>elias</strong>
  <a href="#51797" class="date">11-Apr-2005 09:48</a>
  <div class="text">
<div class="phpcode"><code><span class="html">
The default toString output is very useful for visual debuggin<br />
because it shows the object id.<br />
There is no function to resolve the id directly(?), but you<br />
can do this:<br />
<br />
<span class="default">&lt;?php<br />
</span><span class="keyword">function </span><span class="default">__toString</span><span class="keyword">()<br />
{<br />
&nbsp;&nbsp;&nbsp; </span><span class="default">sscanf</span><span class="keyword">((string)</span><span class="default">$this</span><span class="keyword">, </span><span class="string">"Object id #%d"</span><span class="keyword">, </span><span class="default">$id</span><span class="keyword">);<br />
&nbsp;&nbsp;&nbsp; return </span><span class="string">"Object(Template) id #$id"</span><span class="keyword">;<br />
}<br />
</span><span class="default">?&gt;<br />
</span><br />
HTH,<br />
...
Even though array_keys includes more information about the variable names than just the variable names -- it still seems to work appropriately.</span>
 ...
 <div class="foot"><a href="/manual/add-note.php?sect=language.oop5.magic&amp;redirect=http://www.php.net/manual/en/language.oop5.magic.php"><img src="@w{WPBKWWJ7}" alt="add a note" width="13" height="13" class="middle" /></a> <small><a href="/manual/add-note.php?sect=language.oop5.magic&amp;redirect=http://www.php.net/manual/en/language.oop5.magic.php">add a note</a></small></div>
</div><br />
 </div>
...
<div id="footnav">
   <a href="/source.php?url=/manual/en/language.oop5.magic.php">show source</a> |

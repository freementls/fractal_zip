...
//$fractal_zip->create_fractal_file('test_files28' . DS . 'scale_operation.txt', '<0"12s0.25><0"12s0.5><0"12s2><0"12s8>', 'aaabbccbbaaa'); // scale
...
//$fractal_zip->open_container('open_container_test6' . DIRECTORY_SEPARATOR . 'test_files2.fz');
